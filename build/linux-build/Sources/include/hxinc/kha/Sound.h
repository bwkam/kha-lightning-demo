...
class HXCPP_CLASS_ATTRIBUTES Sound_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::haxe::io::Bytes _hx_set_compressedData(::hx::StackContext *_hx_ctx, ::haxe::io::Bytes _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return compressedData=_hx_v; }
		 ::kha::arrays::ByteArrayPrivate uncompressedData;
		inline  ::kha::arrays::ByteArrayPrivate _hx_set_uncompressedData(::hx::StackContext *_hx_ctx, ::kha::arrays::ByteArrayPrivate _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return uncompressedData=_hx_v; }
		Float length;
		int channels;
		int sampleRate;
