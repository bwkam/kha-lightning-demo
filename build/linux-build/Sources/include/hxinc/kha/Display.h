...
class HXCPP_CLASS_ATTRIBUTES Display_obj : public ::hx::Object
{
	...
	public:
		...
		static void initKoreDisplay();
		static ::Dynamic initKoreDisplay_dyn();
		...
		int getModeWidth(int modeIndex);
		::Dynamic getModeWidth_dyn();

		int getModeHeight(int modeIndex);
		::Dynamic getModeHeight_dyn();

		int getModeFrequency(int modeIndex);
		::Dynamic getModeFrequency_dyn();

		int getModeBitsPerPixel(int modeIndex);
