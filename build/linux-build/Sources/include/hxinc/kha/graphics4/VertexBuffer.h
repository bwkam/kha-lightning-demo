...
class HXCPP_CLASS_ATTRIBUTES VertexBuffer_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::kha::arrays::ByteArrayPrivate _hx_set_data(::hx::StackContext *_hx_ctx, ::kha::arrays::ByteArrayPrivate _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return data=_hx_v; }
		 ::kha::arrays::ByteArrayPrivate dataInt16;
		inline  ::kha::arrays::ByteArrayPrivate _hx_set_dataInt16(::hx::StackContext *_hx_ctx, ::kha::arrays::ByteArrayPrivate _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return dataInt16=_hx_v; }
		void _hx_delete();
		...
		::Dynamic lock_dyn();
		 ...
		 ::kha::arrays::ByteArrayPrivate lockInt16Private(int start,int count);
		::Dynamic lockInt16Private_dyn();

		 ::kha::arrays::ByteArrayPrivate lockInt16( ::Dynamic start, ::Dynamic count);
