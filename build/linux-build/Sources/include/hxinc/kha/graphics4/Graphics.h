...
class HXCPP_CLASS_ATTRIBUTES Graphics_obj {
	public:
		...
		void (::hx::Object :: *_hx_setInts)(::Dynamic location, ::kha::arrays::ByteArrayPrivate ints); 
		static inline void setInts( ::Dynamic _hx_,::Dynamic location, ::kha::arrays::ByteArrayPrivate ints) {
		...
		void (::hx::Object :: *_hx_setFloats)(::Dynamic location, ::kha::arrays::ByteArrayPrivate floats); 
		static inline void setFloats( ::Dynamic _hx_,::Dynamic location, ::kha::arrays::ByteArrayPrivate floats) {
