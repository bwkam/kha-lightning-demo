...
HX_DECLARE_STACK_FRAME(_hx_pos_c9f4343854789049_180_new)
...
HXDLIN( 180)		::kha::input::Pen_obj::instance = ( ( ::kha::input::Pen)(__this) );
            	}
		...
		void notifyEraser( ::Dynamic eraserDownListener, ::Dynamic eraserUpListener, ::Dynamic eraserMoveListener);
		::Dynamic notifyEraser_dyn();

		void remove( ::Dynamic downListener, ::Dynamic upListener, ::Dynamic moveListener);
		::Dynamic remove_dyn();

		void removeEraser( ::Dynamic eraserDownListener, ::Dynamic eraserUpListener, ::Dynamic eraserMoveListener);
		::Dynamic removeEraser_dyn();

		void notifyWindowed(int windowId, ::Dynamic downListener, ::Dynamic upListener, ::Dynamic moveListener);
		::Dynamic notifyWindowed_dyn();

		void notifyEraserWindowed(int windowId, ::Dynamic eraserDownListener, ::Dynamic eraserUpListener, ::Dynamic eraserMoveListener);
		::Dynamic notifyEraserWindowed_dyn();

		void removeWindowed(int windowId, ::Dynamic downListener, ::Dynamic upListener, ::Dynamic moveListener);
		::Dynamic removeWindowed_dyn();

		void removeEraserWindowed(int windowId, ::Dynamic eraserDownListener, ::Dynamic eraserUpListener, ::Dynamic eraserMoveListener);
		::Dynamic removeEraserWindowed_dyn();
		...
		::Array< ::Dynamic> windowEraserDownListeners;
		inline ::Array< ::Dynamic> _hx_set_windowEraserDownListeners(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return windowEraserDownListeners=_hx_v; }
		::Array< ::Dynamic> windowEraserUpListeners;
		inline ::Array< ::Dynamic> _hx_set_windowEraserUpListeners(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return windowEraserUpListeners=_hx_v; }
		::Array< ::Dynamic> windowEraserMoveListeners;
		inline ::Array< ::Dynamic> _hx_set_windowEraserMoveListeners(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return windowEraserMoveListeners=_hx_v; }
		...
		void sendEraserDownEvent(int windowId,int x,int y,Float pressure);
		::Dynamic sendEraserDownEvent_dyn();

		void sendEraserUpEvent(int windowId,int x,int y,Float pressure);
		::Dynamic sendEraserUpEvent_dyn();

		void sendEraserMoveEvent(int windowId,int x,int y,Float pressure);
		::Dynamic sendEraserMoveEvent_dyn();
