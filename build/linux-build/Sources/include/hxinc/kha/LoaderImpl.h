...
class HXCPP_CLASS_ATTRIBUTES LoaderImpl_obj : public ::hx::Object
{
	...
	public:
		...
		static void __boot();
		static  ::cpp::Int64Map blobCallbacks;
		static  ::cpp::Int64Map imageCallbacks;
		static  ::cpp::Int64Map soundCallbacks;
		static void loadSoundFromDescription( ::Dynamic desc, ::Dynamic done, ::Dynamic failed);
		static ::Dynamic loadSoundFromDescription_dyn();

		static ::cpp::Int64 loadSound(::String filename);
		...
		static ::cpp::Int64 loadImage(::String filename,bool readable);
		...
		static ::cpp::Int64 loadBlob(::String filename);
		...
		static void blobLoaded(::cpp::Int64 index,::Array< unsigned char > bytes);
		static ::Dynamic blobLoaded_dyn();

		static void blobErrored(::cpp::Int64 index,::String filename);
		static ::Dynamic blobErrored_dyn();

		static void soundLoadedCompressed(::cpp::Int64 index,::Array< unsigned char > bytes);
		static ::Dynamic soundLoadedCompressed_dyn();

		static void soundLoadedUncompressed(::cpp::Int64 index, ::kha::arrays::ByteArrayPrivate samples,int channels,int sampleRate,Float length);
		static ::Dynamic soundLoadedUncompressed_dyn();

		static void soundErrored(::cpp::Int64 index,::String filename);
		static ::Dynamic soundErrored_dyn();

		static  ::kha::arrays::ByteArrayPrivate createFloat32Array();
		...
		static void imageLoaded(::cpp::Int64 index, ::kha::Image image);
		static ::Dynamic imageLoaded_dyn();

		static void imageErrored(::cpp::Int64 index,::String filename);
