...
class HXCPP_CLASS_ATTRIBUTES SystemImpl_obj : public ::hx::Object
{
	...
	public:
		...
		static bool checkGamepadConnected(int i);
		...
		static void penEraserDown(int windowId,int x,int y,Float pressure);
		static ::Dynamic penEraserDown_dyn();

		static void penEraserUp(int windowId,int x,int y,Float pressure);
		static ::Dynamic penEraserUp_dyn();

		static void penEraserMove(int windowId,int x,int y,Float pressure);
		static ::Dynamic penEraserMove_dyn();

		static void gamepadAxis(int gamepad,int axis,Float value);
		static ::Dynamic gamepadAxis_dyn();

		static void gamepadButton(int gamepad,int button,Float value);
		...
		static void initKinc(::String name,int width,int height, ::kha::WindowOptions win, ::kha::FramebufferOptions frame);
		static ::Dynamic initKinc_dyn();
		...
		static void setGamepadRumble(int index,Float leftAmount,Float rightAmount);
		static ::Dynamic setGamepadRumble_dyn();
