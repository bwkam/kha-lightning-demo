...
HXLINE(  14)		( ( ::kha::FramebufferOptions)(__this) )->frequency = ( (int)(frequency) );
HXLINE(  15)		( ( ::kha::FramebufferOptions)(__this) )->verticalSync = ( (bool)(verticalSync) );
HXLINE(  16)		( ( ::kha::FramebufferOptions)(__this) )->colorBufferBits = ( (int)(colorBufferBits) );
HXLINE(  17)		( ( ::kha::FramebufferOptions)(__this) )->depthBufferBits = ( (int)(depthBufferBits) );
HXLINE(  18)		( ( ::kha::FramebufferOptions)(__this) )->stencilBufferBits = ( (int)(stencilBufferBits) );
HXLINE(  19)		( ( ::kha::FramebufferOptions)(__this) )->samplesPerPixel = ( (int)(samplesPerPixel) );
            	}
