...
HX_DECLARE_STACK_FRAME(_hx_pos_953552e0cd74b8c7_19_new)
			...
			*(void **)__this = WindowOptions_obj::_hx_vtable;
{
            	...
            	HX_GC_STACKFRAME(&_hx_pos_953552e0cd74b8c7_19_new)
HXLINE(  28)		( ( ::kha::WindowOptions)(__this) )->mode = 0;
HXLINE(  27)		( ( ::kha::WindowOptions)(__this) )->windowFeatures = ((1 | 4) | 2);
HXLINE(  26)		( ( ::kha::WindowOptions)(__this) )->visible = true;
HXLINE(  25)		( ( ::kha::WindowOptions)(__this) )->display = -1;
HXLINE(  24)		( ( ::kha::WindowOptions)(__this) )->height = 600;
HXLINE(  23)		( ( ::kha::WindowOptions)(__this) )->width = 800;
HXLINE(  22)		( ( ::kha::WindowOptions)(__this) )->y = -1;
HXLINE(  21)		( ( ::kha::WindowOptions)(__this) )->x = -1;
HXLINE(  20)		( ( ::kha::WindowOptions)(__this) )->_hx_set_title(HX_CTX, null());
HXLINE(  32)		( ( ::kha::WindowOptions)(__this) )->_hx_set_title(HX_CTX, title);
HXLINE(  33)		( ( ::kha::WindowOptions)(__this) )->x = ( (int)(x) );
HXLINE(  34)		( ( ::kha::WindowOptions)(__this) )->y = ( (int)(y) );
HXLINE(  35)		( ( ::kha::WindowOptions)(__this) )->width = ( (int)(width) );
HXLINE(  36)		( ( ::kha::WindowOptions)(__this) )->height = ( (int)(height) );
HXLINE(  37)		( ( ::kha::WindowOptions)(__this) )->display = ( (int)(display) );
HXLINE(  38)		( ( ::kha::WindowOptions)(__this) )->visible = ( (bool)(visible) );
HXLINE(  39)		int _hx_tmp;
HXDLIN(  39)		if (::hx::IsNull( windowFeatures )) {
HXLINE(  39)			_hx_tmp = ((1 | 4) | 2);
            		}
            		else {
HXLINE(  39)			_hx_tmp = ( (int)(windowFeatures) );
            		}
HXDLIN(  39)		( ( ::kha::WindowOptions)(__this) )->windowFeatures = _hx_tmp;
HXLINE(  40)		( ( ::kha::WindowOptions)(__this) )->mode = ( (int)(mode) );
            	}
