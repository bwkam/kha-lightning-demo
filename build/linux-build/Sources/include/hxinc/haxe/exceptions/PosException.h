...
#endif
HX_DECLARE_STACK_FRAME(_hx_pos_857aa63fd86be7fa_12_new)
...
HXLINE(  15)			( ( ::haxe::exceptions::PosException)(__this) )->_hx_set_posInfos(HX_CTX, ::hx::SourceInfo(HX_("(unknown)",87,5d,fc,5f),0,HX_("(unknown)",87,5d,fc,5f),HX_("(unknown)",87,5d,fc,5f)));
            		}
            		else {
HXLINE(  17)			( ( ::haxe::exceptions::PosException)(__this) )->_hx_set_posInfos(HX_CTX, pos);
            		}
            	}
