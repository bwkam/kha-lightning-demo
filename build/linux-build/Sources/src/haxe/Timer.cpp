...
HX_LOCAL_STACK_FRAME(_hx_pos_102f69689d37b2bb_115_delay,"haxe.Timer","delay",0x3ed5f1b2,"haxe.Timer.delay","haxe/Timer.hx",115,0x1a690682)
...
HX_LOCAL_STACK_FRAME(_hx_pos_102f69689d37b2bb_152_stamp,"haxe.Timer","stamp",0xebba8a32,"haxe.Timer.stamp","haxe/Timer.hx",152,0x1a690682)
namespace haxe{
...
HXLINE( 119)			f();
            	...
            	HX_GC_STACKFRAME(&_hx_pos_102f69689d37b2bb_115_delay)
HXLINE( 116)		 ::haxe::Timer t =  ::haxe::Timer_obj::__alloc( HX_CTX ,time_ms);
HXLINE( 117)		t->_hx_set_run(HX_CTX,  ::Dynamic(new _hx_Closure_0(f,t)));
HXLINE( 121)		return t;
            	}
...
HXLINE( 136)		Float t0 = ::kha::Scheduler_obj::realTime();
HXLINE( 137)		 ::Dynamic r = f();
HXLINE( 138)		 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN( 138)		_hx_tmp(((::kha::Scheduler_obj::realTime() - t0) + HX_("s",73,00,00,00)),pos);
HXLINE( 139)		return r;
            	}
...
Float Timer_obj::stamp(){
            	HX_STACKFRAME(&_hx_pos_102f69689d37b2bb_152_stamp)
HXDLIN( 152)		return ::kha::Scheduler_obj::realTime();
            	}
