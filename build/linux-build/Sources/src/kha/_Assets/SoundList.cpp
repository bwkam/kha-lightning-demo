...
HX_DEFINE_STACK_FRAME(_hx_pos_ff815e824a3dc308_210_new,"kha._Assets.SoundList","new",0x5b156129,"kha._Assets.SoundList.new","kha/internal/AssetsBuilder.hx",210,0x6901246d)
HX_LOCAL_STACK_FRAME(_hx_pos_a874b79c8633d97c_22_get,"kha._Assets.SoundList","get",0x5b10115f,"kha._Assets.SoundList.get","kha/Assets.hx",22,0x66f27110)
namespace kha{
namespace _Assets{

void SoundList_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_ff815e824a3dc308_210_new)
...
bool SoundList_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::kha::Sound SoundList_obj::get(::String name){
            	HX_STACKFRAME(&_hx_pos_a874b79c8633d97c_22_get)
HXDLIN(  22)		return ( ( ::kha::Sound)(::Reflect_obj::field(::hx::ObjectPtr<OBJ_>(this),name)) );
            	}
