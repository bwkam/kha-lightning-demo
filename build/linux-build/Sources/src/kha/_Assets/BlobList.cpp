...
HX_DEFINE_STACK_FRAME(_hx_pos_89b6f8aff09b9782_210_new,"kha._Assets.BlobList","new",0xb2850123,"kha._Assets.BlobList.new","kha/internal/AssetsBuilder.hx",210,0x6901246d)
HX_LOCAL_STACK_FRAME(_hx_pos_37d7e3a43e386237_31_get,"kha._Assets.BlobList","get",0xb27fb159,"kha._Assets.BlobList.get","kha/Assets.hx",31,0x66f27110)
namespace kha{
namespace _Assets{

void BlobList_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_89b6f8aff09b9782_210_new)
HXDLIN( 210)		this->_hx_set_names(HX_CTX, ::Array_obj< ::String >::__new(0));
            	}
...
bool BlobList_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::kha::internal::BytesBlob BlobList_obj::get(::String name){
            	HX_STACKFRAME(&_hx_pos_37d7e3a43e386237_31_get)
HXDLIN(  31)		return ( ( ::kha::internal::BytesBlob)(::Reflect_obj::field(::hx::ObjectPtr<OBJ_>(this),name)) );
            	}
