...
HX_DEFINE_STACK_FRAME(_hx_pos_17e473de805b4eb1_18_new,"kha.Framebuffer","new",0x353baff5,"kha.Framebuffer.new","kha/Framebuffer.hx",18,0x5860e4dc)
HX_LOCAL_STACK_FRAME(_hx_pos_17e473de805b4eb1_28_init,"kha.Framebuffer","init",0x5bb6fddb,"kha.Framebuffer.init","kha/Framebuffer.hx",28,0x5860e4dc)
HX_LOCAL_STACK_FRAME(_hx_pos_17e473de805b4eb1_41_get_g1,"kha.Framebuffer","get_g1",0x01ba3cbe,"kha.Framebuffer.get_g1","kha/Framebuffer.hx",41,0x5860e4dc)
HX_LOCAL_STACK_FRAME(_hx_pos_17e473de805b4eb1_50_get_g2,"kha.Framebuffer","get_g2",0x01ba3cbf,"kha.Framebuffer.get_g2","kha/Framebuffer.hx",50,0x5860e4dc)
HX_LOCAL_STACK_FRAME(_hx_pos_17e473de805b4eb1_59_get_g4,"kha.Framebuffer","get_g4",0x01ba3cc1,"kha.Framebuffer.get_g4","kha/Framebuffer.hx",59,0x5860e4dc)
...
void Framebuffer_obj::__construct(int window,::Dynamic g1, ::kha::graphics2::Graphics g2,::Dynamic g4){
            	HX_GC_STACKFRAME(&_hx_pos_17e473de805b4eb1_18_new)
HXLINE(  19)		this->window = window;
HXLINE(  20)		this->_hx_set_graphics1(HX_CTX, g1);
HXLINE(  21)		this->_hx_set_graphics2(HX_CTX, g2);
HXLINE(  22)		this->_hx_set_graphics4(HX_CTX, g4);
            	}
...
void Framebuffer_obj::init(::Dynamic g1, ::kha::graphics2::Graphics g2,::Dynamic g4){
            	HX_GC_STACKFRAME(&_hx_pos_17e473de805b4eb1_28_init)
HXLINE(  29)		this->_hx_set_graphics1(HX_CTX, g1);
HXLINE(  30)		this->_hx_set_graphics2(HX_CTX, g2);
HXLINE(  31)		this->_hx_set_graphics4(HX_CTX, g4);
            	}
...
::Dynamic Framebuffer_obj::get_g1(){
            	HX_STACKFRAME(&_hx_pos_17e473de805b4eb1_41_get_g1)
HXDLIN(  41)		return this->graphics1;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Framebuffer_obj,get_g1,return )
 ...
 ::kha::graphics2::Graphics Framebuffer_obj::get_g2(){
            	HX_STACKFRAME(&_hx_pos_17e473de805b4eb1_50_get_g2)
HXDLIN(  50)		return this->graphics2;
            	}
...
::Dynamic Framebuffer_obj::get_g4(){
            	HX_STACKFRAME(&_hx_pos_17e473de805b4eb1_59_get_g4)
HXDLIN(  59)		return this->graphics4;
            	}
