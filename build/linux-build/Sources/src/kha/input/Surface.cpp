...
HX_DEFINE_STACK_FRAME(_hx_pos_12c7feb5c140131f_71_new,"kha.input.Surface","new",0x73f96851,"kha.input.Surface.new","kha/input/Surface.hx",71,0xe9f00981)
HX_LOCAL_STACK_FRAME(_hx_pos_12c7feb5c140131f_43_notify,"kha.input.Surface","notify",0x41b80f78,"kha.input.Surface.notify","kha/input/Surface.hx",43,0xe9f00981)
HX_LOCAL_STACK_FRAME(_hx_pos_12c7feb5c140131f_56_remove,"kha.input.Surface","remove",0x1487d0f3,"kha.input.Surface.remove","kha/input/Surface.hx",56,0xe9f00981)
HX_LOCAL_STACK_FRAME(_hx_pos_12c7feb5c140131f_79_sendTouchStartEvent,"kha.input.Surface","sendTouchStartEvent",0xfc8e7680,"kha.input.Surface.sendTouchStartEvent","kha/input/Surface.hx",79,0xe9f00981)
HX_LOCAL_STACK_FRAME(_hx_pos_12c7feb5c140131f_85_sendTouchEndEvent,"kha.input.Surface","sendTouchEndEvent",0x76ffd667,"kha.input.Surface.sendTouchEndEvent","kha/input/Surface.hx",85,0xe9f00981)
HX_LOCAL_STACK_FRAME(_hx_pos_12c7feb5c140131f_91_sendMoveEvent,"kha.input.Surface","sendMoveEvent",0x6e915012,"kha.input.Surface.sendMoveEvent","kha/input/Surface.hx",91,0xe9f00981)
...
HX_LOCAL_STACK_FRAME(_hx_pos_12c7feb5c140131f_33_setTouchDownEventBlockBehavior,"kha.input.Surface","setTouchDownEventBlockBehavior",0x83bc27d3,"kha.input.Surface.setTouchDownEventBlockBehavior","kha/input/Surface.hx",33,0xe9f00981)
...
void Surface_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_12c7feb5c140131f_71_new)
HXLINE(  72)		this->_hx_set_touchStartListeners(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE(  73)		this->_hx_set_touchEndListeners(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE(  74)		this->_hx_set_moveListeners(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE(  75)		::kha::input::Surface_obj::instance = ::hx::ObjectPtr<OBJ_>(this);
            	}
...
void Surface_obj::notify( ::Dynamic touchStartListener, ::Dynamic touchEndListener, ::Dynamic moveListener){
            	HX_STACKFRAME(&_hx_pos_12c7feb5c140131f_43_notify)
HXLINE(  44)		if (::hx::IsNotNull( touchStartListener )) {
HXLINE(  45)			this->touchStartListeners->push(touchStartListener);
            		}
HXLINE(  46)		if (::hx::IsNotNull( touchEndListener )) {
HXLINE(  47)			this->touchEndListeners->push(touchEndListener);
            		}
HXLINE(  48)		if (::hx::IsNotNull( moveListener )) {
HXLINE(  49)			this->moveListeners->push(moveListener);
            		}
            	}
...
void Surface_obj::remove( ::Dynamic touchStartListener, ::Dynamic touchEndListener, ::Dynamic moveListener){
            	HX_STACKFRAME(&_hx_pos_12c7feb5c140131f_56_remove)
HXLINE(  57)		if (::hx::IsNotNull( touchStartListener )) {
HXLINE(  58)			this->touchStartListeners->remove(touchStartListener);
            		}
HXLINE(  59)		if (::hx::IsNotNull( touchEndListener )) {
HXLINE(  60)			this->touchEndListeners->remove(touchEndListener);
            		}
HXLINE(  61)		if (::hx::IsNotNull( moveListener )) {
HXLINE(  62)			this->moveListeners->remove(moveListener);
            		}
            	}
...
void Surface_obj::sendTouchStartEvent(int index,int x,int y){
            	HX_STACKFRAME(&_hx_pos_12c7feb5c140131f_79_sendTouchStartEvent)
HXDLIN(  79)		int _g = 0;
HXDLIN(  79)		::Array< ::Dynamic> _g1 = this->touchStartListeners;
HXDLIN(  79)		while((_g < _g1->length)){
HXDLIN(  79)			 ::Dynamic listener = _g1->__get(_g);
HXDLIN(  79)			_g = (_g + 1);
HXLINE(  80)			listener(index,x,y);
            		}
            	}
...
void Surface_obj::sendTouchEndEvent(int index,int x,int y){
            	HX_STACKFRAME(&_hx_pos_12c7feb5c140131f_85_sendTouchEndEvent)
HXDLIN(  85)		int _g = 0;
HXDLIN(  85)		::Array< ::Dynamic> _g1 = this->touchEndListeners;
HXDLIN(  85)		while((_g < _g1->length)){
HXDLIN(  85)			 ::Dynamic listener = _g1->__get(_g);
HXDLIN(  85)			_g = (_g + 1);
HXLINE(  86)			listener(index,x,y);
            		}
            	}
...
void Surface_obj::sendMoveEvent(int index,int x,int y){
            	HX_STACKFRAME(&_hx_pos_12c7feb5c140131f_91_sendMoveEvent)
HXDLIN(  91)		int _g = 0;
HXDLIN(  91)		::Array< ::Dynamic> _g1 = this->moveListeners;
HXDLIN(  91)		while((_g < _g1->length)){
HXDLIN(  91)			 ::Dynamic listener = _g1->__get(_g);
HXDLIN(  91)			_g = (_g + 1);
HXLINE(  92)			listener(index,x,y);
            		}
            	}
...
HXLINE(  22)		return ::kha::input::Surface_obj::instance;
            	}
...
void Surface_obj::setTouchDownEventBlockBehavior( ::kha::input::TouchDownEventBlockBehavior behavior){
            	HX_STACKFRAME(&_hx_pos_12c7feb5c140131f_33_setTouchDownEventBlockBehavior)
HXDLIN(  33)		::kha::input::Surface_obj::touchDownEventBlockBehavior = behavior;
            	}
