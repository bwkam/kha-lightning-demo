...
HX_DEFINE_STACK_FRAME(_hx_pos_4658952827b01861_8_new,"kha.input.Sensor","new",0x06ac0dba,"kha.input.Sensor.new","kha/input/Sensor.hx",8,0xcd8927f4)
HX_LOCAL_STACK_FRAME(_hx_pos_4658952827b01861_20_notify,"kha.input.Sensor","notify",0x3fe1f1af,"kha.input.Sensor.notify","kha/input/Sensor.hx",20,0xcd8927f4)
HX_LOCAL_STACK_FRAME(_hx_pos_4658952827b01861_11_get,"kha.input.Sensor","get",0x06a6bdf0,"kha.input.Sensor.get","kha/input/Sensor.hx",11,0xcd8927f4)
HX_LOCAL_STACK_FRAME(_hx_pos_4658952827b01861_25__changed,"kha.input.Sensor","_changed",0xc24e26db,"kha.input.Sensor._changed","kha/input/Sensor.hx",25,0xcd8927f4)
...
void Sensor_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_4658952827b01861_8_new)
HXDLIN(   8)		this->_hx_set_listeners(HX_CTX, ::Array_obj< ::Dynamic>::__new());
            	}
...
void Sensor_obj::notify( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_4658952827b01861_20_notify)
HXDLIN(  20)		this->listeners->push(listener);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Sensor_obj,notify,(void))
 ...
 ::kha::input::Sensor Sensor_obj::get(int type){
            	HX_STACKFRAME(&_hx_pos_4658952827b01861_11_get)
HXDLIN(  11)		switch((int)(type)){
            			case (int)0: {
HXLINE(  13)				return ::kha::input::Sensor_obj::accelerometer;
            			}
            			break;
            			case (int)1: {
HXLINE(  15)				return ::kha::input::Sensor_obj::gyroscope;
            			}
            			break;
            		}
...
void Sensor_obj::_changed(int type,Float x,Float y,Float z){
            	HX_STACKFRAME(&_hx_pos_4658952827b01861_25__changed)
HXLINE(  26)		int sensor;
HXDLIN(  26)		if ((type == 0)) {
HXLINE(  26)			sensor = 0;
            		}
            		else {
...
HXDLIN(  26)		 ::kha::input::Sensor sensor1 = ::kha::input::Sensor_obj::get(sensor);
HXLINE(  27)		{
HXLINE(  27)			int _g = 0;
HXDLIN(  27)			::Array< ::Dynamic> _g1 = sensor1->listeners;
HXDLIN(  27)			while((_g < _g1->length)){
HXLINE(  27)				 ::Dynamic listener = _g1->__get(_g);
HXDLIN(  27)				_g = (_g + 1);
HXLINE(  28)				listener(x,y,z);
            			}
            		}
            	}
