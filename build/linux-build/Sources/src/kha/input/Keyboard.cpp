...
HX_DEFINE_STACK_FRAME(_hx_pos_4c695fbe9d02de60_81_new,"kha.input.Keyboard","new",0xce3ad227,"kha.input.Keyboard.new","kha/input/Keyboard.hx",81,0xb57e4ba7)
...
HX_LOCAL_STACK_FRAME(_hx_pos_4c695fbe9d02de60_56_remove,"kha.input.Keyboard","remove",0xcdc1b0dd,"kha.input.Keyboard.remove","kha/input/Keyboard.hx",56,0xb57e4ba7)
HX_LOCAL_STACK_FRAME(_hx_pos_4c695fbe9d02de60_68_show,"kha.input.Keyboard","show",0xa88d6156,"kha.input.Keyboard.show","kha/input/Keyboard.hx",68,0xb57e4ba7)
HX_LOCAL_STACK_FRAME(_hx_pos_4c695fbe9d02de60_73_hide,"kha.input.Keyboard","hide",0xa148c11b,"kha.input.Keyboard.hide","kha/input/Keyboard.hx",73,0xb57e4ba7)
...
HX_LOCAL_STACK_FRAME(_hx_pos_fee907a19ed0ea89_187__receive,"kha.input.Keyboard","_receive",0xbd2ae83d,"kha.input.Keyboard._receive","kha/netsync/ControllerBuilder.hx",187,0xeaffa5e1)
...
void Keyboard_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_4c695fbe9d02de60_81_new)
HXLINE(  82)		super::__construct();
HXLINE(  83)		this->_hx_set_downListeners(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  84)		this->_hx_set_upListeners(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  85)		this->_hx_set_pressListeners(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  86)		::kha::input::Keyboard_obj::instance = ::hx::ObjectPtr<OBJ_>(this);
            	}
...
HXLINE(  46)			this->downListeners->push(downListener);
            		}
HXLINE(  47)		if (::hx::IsNotNull( upListener )) {
HXLINE(  48)			this->upListeners->push(upListener);
            		}
HXLINE(  49)		if (::hx::IsNotNull( pressListener )) {
HXLINE(  50)			this->pressListeners->push(pressListener);
            		}
            	}
...
void Keyboard_obj::remove( ::Dynamic downListener, ::Dynamic upListener, ::Dynamic pressListener){
            	HX_STACKFRAME(&_hx_pos_4c695fbe9d02de60_56_remove)
HXLINE(  57)		if (::hx::IsNotNull( downListener )) {
HXLINE(  58)			this->downListeners->remove(downListener);
            		}
HXLINE(  59)		if (::hx::IsNotNull( upListener )) {
HXLINE(  60)			this->upListeners->remove(upListener);
            		}
HXLINE(  61)		if (::hx::IsNotNull( pressListener )) {
HXLINE(  62)			this->pressListeners->remove(pressListener);
            		}
            	}
...
void Keyboard_obj::show(){
            	HX_STACKFRAME(&_hx_pos_4c695fbe9d02de60_68_show)
            	}
...
void Keyboard_obj::hide(){
            	HX_STACKFRAME(&_hx_pos_4c695fbe9d02de60_73_hide)
            	}
...
HXLINE(  94)		{
HXLINE(  94)			int _g = 0;
HXDLIN(  94)			::Array< ::Dynamic> _g1 = this->downListeners;
HXDLIN(  94)			while((_g < _g1->length)){
HXLINE(  94)				 ::Dynamic listener = _g1->__get(_g);
HXDLIN(  94)				_g = (_g + 1);
HXLINE(  95)				listener(code);
            			}
            		}
            	}
...
HXLINE( 104)		{
HXLINE( 104)			int _g = 0;
HXDLIN( 104)			::Array< ::Dynamic> _g1 = this->upListeners;
HXDLIN( 104)			while((_g < _g1->length)){
HXLINE( 104)				 ::Dynamic listener = _g1->__get(_g);
HXDLIN( 104)				_g = (_g + 1);
HXLINE( 105)				listener(code);
            			}
            		}
            	}
...
HXLINE( 111)		{
HXLINE( 111)			int _g = 0;
HXDLIN( 111)			::Array< ::Dynamic> _g1 = this->pressListeners;
HXDLIN( 111)			while((_g < _g1->length)){
HXLINE( 111)				 ::Dynamic listener = _g1->__get(_g);
HXDLIN( 111)				_g = (_g + 1);
HXLINE( 112)				listener(_hx_char);
            			}
            		}
            	}
...
void Keyboard_obj::_receive( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_fee907a19ed0ea89_187__receive)
...
HXLINE( 176)			int input0 = ( (int)(bytes->b->__get(4)) );
HXLINE( 191)			this->sendDownEvent(input0);
HXLINE( 192)			return;
            		}
HXLINE( 189)		if ((funcindex == 1)) {
HXLINE( 176)			int input01 = ( (int)(bytes->b->__get(4)) );
HXLINE( 191)			this->sendUpEvent(input01);
HXLINE( 192)			return;
            		}
HXLINE( 189)		if ((funcindex == 2)) {
HXLINE( 152)			::String input02 = ::String::fromCharCode(( (int)(bytes->b->__get(4)) ));
HXLINE( 191)			this->sendPressEvent(input02);
HXLINE( 192)			return;
            		}
            	}
