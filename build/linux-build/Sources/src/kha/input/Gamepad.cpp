...
HX_DEFINE_STACK_FRAME(_hx_pos_2ba37e3659cf55a5_50_new,"kha.input.Gamepad","new",0x1b762cc5,"kha.input.Gamepad.new","kha/input/Gamepad.hx",50,0xfbe88f8d)
HX_LOCAL_STACK_FRAME(_hx_pos_2ba37e3659cf55a5_28_notify,"kha.input.Gamepad","notify",0x4a3a8b84,"kha.input.Gamepad.notify","kha/input/Gamepad.hx",28,0xfbe88f8d)
HX_LOCAL_STACK_FRAME(_hx_pos_2ba37e3659cf55a5_35_remove,"kha.input.Gamepad","remove",0x1d0a4cff,"kha.input.Gamepad.remove","kha/input/Gamepad.hx",35,0xfbe88f8d)
HX_LOCAL_STACK_FRAME(_hx_pos_2ba37e3659cf55a5_63_rumble,"kha.input.Gamepad","rumble",0x5369af0c,"kha.input.Gamepad.rumble","kha/input/Gamepad.hx",63,0xfbe88f8d)
HX_LOCAL_STACK_FRAME(_hx_pos_2ba37e3659cf55a5_67_get_id,"kha.input.Gamepad","get_id",0xbbb1a3df,"kha.input.Gamepad.get_id","kha/input/Gamepad.hx",67,0xfbe88f8d)
HX_LOCAL_STACK_FRAME(_hx_pos_2ba37e3659cf55a5_71_get_vendor,"kha.input.Gamepad","get_vendor",0xae267f8c,"kha.input.Gamepad.get_vendor","kha/input/Gamepad.hx",71,0xfbe88f8d)
HX_LOCAL_STACK_FRAME(_hx_pos_2ba37e3659cf55a5_76_sendAxisEvent,"kha.input.Gamepad","sendAxisEvent",0x13d0c9f6,"kha.input.Gamepad.sendAxisEvent","kha/input/Gamepad.hx",76,0xfbe88f8d)
HX_LOCAL_STACK_FRAME(_hx_pos_2ba37e3659cf55a5_83_sendButtonEvent,"kha.input.Gamepad","sendButtonEvent",0x02b76845,"kha.input.Gamepad.sendButtonEvent","kha/input/Gamepad.hx",83,0xfbe88f8d)
...
HX_LOCAL_STACK_FRAME(_hx_pos_2ba37e3659cf55a5_14_notifyOnConnect,"kha.input.Gamepad","notifyOnConnect",0xc2ffb867,"kha.input.Gamepad.notifyOnConnect","kha/input/Gamepad.hx",14,0xfbe88f8d)
HX_LOCAL_STACK_FRAME(_hx_pos_2ba37e3659cf55a5_21_removeConnect,"kha.input.Gamepad","removeConnect",0xce2844ab,"kha.input.Gamepad.removeConnect","kha/input/Gamepad.hx",21,0xfbe88f8d)
HX_LOCAL_STACK_FRAME(_hx_pos_2ba37e3659cf55a5_89_sendConnectEvent,"kha.input.Gamepad","sendConnectEvent",0xc0da39b3,"kha.input.Gamepad.sendConnectEvent","kha/input/Gamepad.hx",89,0xfbe88f8d)
HX_LOCAL_STACK_FRAME(_hx_pos_2ba37e3659cf55a5_97_sendDisconnectEvent,"kha.input.Gamepad","sendDisconnectEvent",0x4552681b,"kha.input.Gamepad.sendDisconnectEvent","kha/input/Gamepad.hx",97,0xfbe88f8d)
...
HX_LOCAL_STACK_FRAME(_hx_pos_2ba37e3659cf55a5_42_boot,"kha.input.Gamepad","boot",0xe40a002d,"kha.input.Gamepad.boot","kha/input/Gamepad.hx",42,0xfbe88f8d)
HX_LOCAL_STACK_FRAME(_hx_pos_2ba37e3659cf55a5_47_boot,"kha.input.Gamepad","boot",0xe40a002d,"kha.input.Gamepad.boot","kha/input/Gamepad.hx",47,0xfbe88f8d)
HX_LOCAL_STACK_FRAME(_hx_pos_2ba37e3659cf55a5_48_boot,"kha.input.Gamepad","boot",0xe40a002d,"kha.input.Gamepad.boot","kha/input/Gamepad.hx",48,0xfbe88f8d)
namespace kha{
namespace input{
...
void Gamepad_obj::__construct(::hx::Null< int >  __o_index,::String __o_id){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_2ba37e3659cf55a5_50_new)
HXLINE(  51)		this->connected = false;
HXLINE(  52)		this->index = index;
HXLINE(  53)		this->_hx_set_axisListeners(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE(  54)		this->_hx_set_buttonListeners(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE(  55)		::kha::input::Gamepad_obj::instances->setCtx( HX_CTX, index,::hx::ObjectPtr<OBJ_>(this));
            	}
...
void Gamepad_obj::notify( ::Dynamic axisListener, ::Dynamic buttonListener){
            	HX_STACKFRAME(&_hx_pos_2ba37e3659cf55a5_28_notify)
HXLINE(  29)		if (::hx::IsNotNull( axisListener )) {
HXLINE(  30)			this->axisListeners->push(axisListener);
            		}
HXLINE(  31)		if (::hx::IsNotNull( buttonListener )) {
HXLINE(  32)			this->buttonListeners->push(buttonListener);
            		}
            	}
...
void Gamepad_obj::remove( ::Dynamic axisListener, ::Dynamic buttonListener){
            	HX_STACKFRAME(&_hx_pos_2ba37e3659cf55a5_35_remove)
HXLINE(  36)		if (::hx::IsNotNull( axisListener )) {
HXLINE(  37)			this->axisListeners->remove(axisListener);
            		}
HXLINE(  38)		if (::hx::IsNotNull( buttonListener )) {
HXLINE(  39)			this->buttonListeners->remove(buttonListener);
            		}
            	}
...
void Gamepad_obj::rumble(Float leftAmount,Float rightAmount){
            	HX_STACKFRAME(&_hx_pos_2ba37e3659cf55a5_63_rumble)
HXDLIN(  63)		::kha::SystemImpl_obj::setGamepadRumble(this->index,leftAmount,rightAmount);
            	}


HX_DEFINE_DYNAMIC_FUNC2(Gamepad_obj,rumble,(void))

::String Gamepad_obj::get_id(){
            	HX_STACKFRAME(&_hx_pos_2ba37e3659cf55a5_67_get_id)
HXDLIN(  67)		return ::kha::SystemImpl_obj::getGamepadId(this->index);
            	}
...
::String Gamepad_obj::get_vendor(){
            	HX_STACKFRAME(&_hx_pos_2ba37e3659cf55a5_71_get_vendor)
HXDLIN(  71)		return ::kha::SystemImpl_obj::getGamepadVendor(this->index);
            	}
...
void Gamepad_obj::sendAxisEvent(int axis,Float value){
            	HX_STACKFRAME(&_hx_pos_2ba37e3659cf55a5_76_sendAxisEvent)
HXDLIN(  76)		int _g = 0;
HXDLIN(  76)		::Array< ::Dynamic> _g1 = this->axisListeners;
HXDLIN(  76)		while((_g < _g1->length)){
HXDLIN(  76)			 ::Dynamic listener = _g1->__get(_g);
HXDLIN(  76)			_g = (_g + 1);
HXLINE(  77)			listener(axis,value);
            		}
            	}
...
void Gamepad_obj::sendButtonEvent(int button,Float value){
            	HX_STACKFRAME(&_hx_pos_2ba37e3659cf55a5_83_sendButtonEvent)
HXDLIN(  83)		int _g = 0;
HXDLIN(  83)		::Array< ::Dynamic> _g1 = this->buttonListeners;
HXDLIN(  83)		while((_g < _g1->length)){
HXDLIN(  83)			 ::Dynamic listener = _g1->__get(_g);
HXDLIN(  83)			_g = (_g + 1);
HXLINE(  84)			listener(button,value);
            		}
            	}
...
HXLINE(  11)		return ::kha::input::Gamepad_obj::instances->__get(index).StaticCast<  ::kha::input::Gamepad >();
            	}
...
void Gamepad_obj::notifyOnConnect( ::Dynamic connectListener, ::Dynamic disconnectListener){
            	HX_STACKFRAME(&_hx_pos_2ba37e3659cf55a5_14_notifyOnConnect)
HXLINE(  15)		if (::hx::IsNotNull( connectListener )) {
HXLINE(  16)			::kha::input::Gamepad_obj::connectListeners->push(connectListener);
            		}
HXLINE(  17)		if (::hx::IsNotNull( disconnectListener )) {
HXLINE(  18)			::kha::input::Gamepad_obj::disconnectListeners->push(disconnectListener);
            		}
            	}
...
void Gamepad_obj::removeConnect( ::Dynamic connectListener, ::Dynamic disconnectListener){
            	HX_STACKFRAME(&_hx_pos_2ba37e3659cf55a5_21_removeConnect)
HXLINE(  22)		if (::hx::IsNotNull( connectListener )) {
HXLINE(  23)			::kha::input::Gamepad_obj::connectListeners->remove(connectListener);
            		}
HXLINE(  24)		if (::hx::IsNotNull( disconnectListener )) {
HXLINE(  25)			::kha::input::Gamepad_obj::disconnectListeners->remove(disconnectListener);
            		}
            	}
...
void Gamepad_obj::sendConnectEvent(int index){
            	HX_STACKFRAME(&_hx_pos_2ba37e3659cf55a5_89_sendConnectEvent)
HXLINE(  90)		::kha::input::Gamepad_obj::instances->__get(index).StaticCast<  ::kha::input::Gamepad >()->connected = true;
HXLINE(  91)		{
HXLINE(  91)			int _g = 0;
HXDLIN(  91)			::Array< ::Dynamic> _g1 = ::kha::input::Gamepad_obj::connectListeners;
HXDLIN(  91)			while((_g < _g1->length)){
HXLINE(  91)				 ::Dynamic listener = _g1->__get(_g);
HXDLIN(  91)				_g = (_g + 1);
HXLINE(  92)				listener(index);
            			}
            		}
            	}
...
void Gamepad_obj::sendDisconnectEvent(int index){
            	HX_STACKFRAME(&_hx_pos_2ba37e3659cf55a5_97_sendDisconnectEvent)
HXLINE(  98)		::kha::input::Gamepad_obj::instances->__get(index).StaticCast<  ::kha::input::Gamepad >()->connected = false;
HXLINE(  99)		{
HXLINE(  99)			int _g = 0;
HXDLIN(  99)			::Array< ::Dynamic> _g1 = ::kha::input::Gamepad_obj::disconnectListeners;
HXDLIN(  99)			while((_g < _g1->length)){
HXLINE(  99)				 ::Dynamic listener = _g1->__get(_g);
HXDLIN(  99)				_g = (_g + 1);
HXLINE( 100)				listener(index);
            			}
            		}
            	}
...
{
            	HX_STACKFRAME(&_hx_pos_2ba37e3659cf55a5_42_boot)
HXDLIN(  42)		instances = ::Array_obj< ::Dynamic>::__new();
            	}
{
            	HX_STACKFRAME(&_hx_pos_2ba37e3659cf55a5_47_boot)
HXDLIN(  47)		connectListeners = ::Array_obj< ::Dynamic>::__new();
            	}
{
            	HX_STACKFRAME(&_hx_pos_2ba37e3659cf55a5_48_boot)
HXDLIN(  48)		disconnectListeners = ::Array_obj< ::Dynamic>::__new();
            	}
}
