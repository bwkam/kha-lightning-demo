...
::kha::input::MouseCursor MouseCursor_obj::Custom( ::kha::Image image)
{
	return ::hx::CreateEnum< MouseCursor_obj >(HX_("Custom",d1,fb,26,74),14,1)->_hx_init(0,image);
}
...
bool MouseCursor_obj::__GetStatic(const ::String &inName, ::Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("Custom",d1,fb,26,74)) { outValue = MouseCursor_obj::Custom_dyn(); return true; }
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(MouseCursor_obj,Custom,return)
