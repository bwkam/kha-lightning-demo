...
HX_LOCAL_STACK_FRAME(_hx_pos_48d12ae2842be395_115__receive,"kha.input.MouseImpl","_receive",0x226998db,"kha.input.MouseImpl._receive","kha/netsync/ControllerBuilder.hx",115,0xeaffa5e1)
namespace kha{
namespace input{
...
void MouseImpl_obj::_receive( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_48d12ae2842be395_115__receive)
