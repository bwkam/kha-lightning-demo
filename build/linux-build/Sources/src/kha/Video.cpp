...
HX_LOCAL_STACK_FRAME(_hx_pos_165cc5e44c902c16_31_play,"kha.Video","play",0xcc3f52f1,"kha.Video.play","kha/Video.hx",31,0x1dd2bfce)
HX_LOCAL_STACK_FRAME(_hx_pos_165cc5e44c902c16_37_update,"kha.Video","update",0x283ba446,"kha.Video.update","kha/Video.hx",37,0x1dd2bfce)
HX_LOCAL_STACK_FRAME(_hx_pos_165cc5e44c902c16_42_pause,"kha.Video","pause",0xe3f30f59,"kha.Video.pause","kha/Video.hx",42,0x1dd2bfce)
...
HX_LOCAL_STACK_FRAME(_hx_pos_165cc5e44c902c16_53_getLength,"kha.Video","getLength",0x9ca0c3ff,"kha.Video.getLength","kha/Video.hx",53,0x1dd2bfce)
HX_LOCAL_STACK_FRAME(_hx_pos_165cc5e44c902c16_61_getCurrentPos,"kha.Video","getCurrentPos",0x3f915274,"kha.Video.getCurrentPos","kha/Video.hx",61,0x1dd2bfce)
HX_LOCAL_STACK_FRAME(_hx_pos_165cc5e44c902c16_67_get_position,"kha.Video","get_position",0x5a523eaf,"kha.Video.get_position","kha/Video.hx",67,0x1dd2bfce)
HX_LOCAL_STACK_FRAME(_hx_pos_165cc5e44c902c16_71_set_position,"kha.Video","set_position",0x6f4b6223,"kha.Video.set_position","kha/Video.hx",71,0x1dd2bfce)
HX_LOCAL_STACK_FRAME(_hx_pos_165cc5e44c902c16_78_getVolume,"kha.Video","getVolume",0x5cec58f3,"kha.Video.getVolume","kha/Video.hx",78,0x1dd2bfce)
HX_LOCAL_STACK_FRAME(_hx_pos_165cc5e44c902c16_86_setVolume,"kha.Video","setVolume",0x403d44ff,"kha.Video.setVolume","kha/Video.hx",86,0x1dd2bfce)
HX_LOCAL_STACK_FRAME(_hx_pos_165cc5e44c902c16_93_isFinished,"kha.Video","isFinished",0xa8cc2639,"kha.Video.isFinished","kha/Video.hx",93,0x1dd2bfce)
HX_LOCAL_STACK_FRAME(_hx_pos_165cc5e44c902c16_99_unload,"kha.Video","unload",0x06c2bf3c,"kha.Video.unload","kha/Video.hx",99,0x1dd2bfce)
namespace kha{
...
void Video_obj::play(::hx::Null< bool >  __o_loop){
            	...
            	HX_STACKFRAME(&_hx_pos_165cc5e44c902c16_31_play)
            	}


HX_DEFINE_DYNAMIC_FUNC1(Video_obj,play,(void))

void Video_obj::update(Float dt){
            	HX_STACKFRAME(&_hx_pos_165cc5e44c902c16_37_update)
            	}
...
void Video_obj::pause(){
            	HX_STACKFRAME(&_hx_pos_165cc5e44c902c16_42_pause)
            	}
...
int Video_obj::getLength(){
            	HX_STACKFRAME(&_hx_pos_165cc5e44c902c16_53_getLength)
HXDLIN(  53)		return 0;
            	}
...
int Video_obj::getCurrentPos(){
            	HX_STACKFRAME(&_hx_pos_165cc5e44c902c16_61_getCurrentPos)
HXDLIN(  61)		return 0;
            	}
...
int Video_obj::get_position(){
            	HX_STACKFRAME(&_hx_pos_165cc5e44c902c16_67_get_position)
HXDLIN(  67)		return 0;
            	}
...
int Video_obj::set_position(int value){
            	HX_STACKFRAME(&_hx_pos_165cc5e44c902c16_71_set_position)
HXDLIN(  71)		return 0;
            	}
...
Float Video_obj::getVolume(){
            	HX_STACKFRAME(&_hx_pos_165cc5e44c902c16_78_getVolume)
HXDLIN(  78)		return ( (Float)(1) );
            	}
...
void Video_obj::setVolume(Float volume){
            	HX_STACKFRAME(&_hx_pos_165cc5e44c902c16_86_setVolume)
            	}
...
bool Video_obj::isFinished(){
            	HX_STACKFRAME(&_hx_pos_165cc5e44c902c16_93_isFinished)
HXDLIN(  93)		int _hx_tmp = this->getCurrentPos();
HXDLIN(  93)		return (_hx_tmp >= this->getLength());
            	}
...
void Video_obj::unload(){
            	HX_STACKFRAME(&_hx_pos_165cc5e44c902c16_99_unload)
            	}
