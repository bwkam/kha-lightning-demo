...
HX_DEFINE_STACK_FRAME(_hx_pos_d93e16d4ecb08834_9_new,"kha.kore.Keyboard","new",0xf0b10ae6,"kha.kore.Keyboard.new","kha/kore/Keyboard.hx",9,0xeccf92ea)
HX_LOCAL_STACK_FRAME(_hx_pos_d93e16d4ecb08834_13_show,"kha.kore.Keyboard","show",0xad88cfb7,"kha.kore.Keyboard.show","kha/kore/Keyboard.hx",13,0xeccf92ea)
HX_LOCAL_STACK_FRAME(_hx_pos_d93e16d4ecb08834_16_hide,"kha.kore.Keyboard","hide",0xa6442f7c,"kha.kore.Keyboard.hide","kha/kore/Keyboard.hx",16,0xeccf92ea)
HX_LOCAL_STACK_FRAME(_hx_pos_5233b5d470c7b040_115__receive,"kha.kore.Keyboard","_receive",0x49539b1e,"kha.kore.Keyboard._receive","kha/netsync/ControllerBuilder.hx",115,0xeaffa5e1)
namespace kha{
namespace kore{

void Keyboard_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_d93e16d4ecb08834_9_new)
...
void Keyboard_obj::show(){
            	HX_STACKFRAME(&_hx_pos_d93e16d4ecb08834_13_show)
            	kinc_keyboard_show();
...
void Keyboard_obj::hide(){
            	HX_STACKFRAME(&_hx_pos_d93e16d4ecb08834_16_hide)
            	kinc_keyboard_hide();
...
void Keyboard_obj::_receive( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_5233b5d470c7b040_115__receive)
HXDLIN( 115)		int funcindex = (((( (int)(bytes->b->__get(0)) ) | (( (int)(bytes->b->__get(1)) ) << 8)) | (( (int)(bytes->b->__get(2)) ) << 16)) | (( (int)(bytes->b->__get(3)) ) << 24));
            	}
