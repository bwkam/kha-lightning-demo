...
HX_DEFINE_STACK_FRAME(_hx_pos_a91516e8653714ce_12_new,"kha.graphics4.FragmentShader","new",0x0ee18576,"kha.graphics4.FragmentShader.new","kha/graphics4/FragmentShader.hx",12,0xa52f2538)
HX_LOCAL_STACK_FRAME(_hx_pos_a91516e8653714ce_18_init,"kha.graphics4.FragmentShader","init",0xf32bf93a,"kha.graphics4.FragmentShader.init","kha/graphics4/FragmentShader.hx",18,0xa52f2538)
HX_LOCAL_STACK_FRAME(_hx_pos_a91516e8653714ce_28_delete,"kha.graphics4.FragmentShader","delete",0xe494dcd5,"kha.graphics4.FragmentShader.delete","kha/graphics4/FragmentShader.hx",28,0xa52f2538)
HX_LOCAL_STACK_FRAME(_hx_pos_a91516e8653714ce_33__forceInclude,"kha.graphics4.FragmentShader","_forceInclude",0xcf9816f2,"kha.graphics4.FragmentShader._forceInclude","kha/graphics4/FragmentShader.hx",33,0xa52f2538)
HX_LOCAL_STACK_FRAME(_hx_pos_a91516e8653714ce_21_fromSource,"kha.graphics4.FragmentShader","fromSource",0x978e6f8f,"kha.graphics4.FragmentShader.fromSource","kha/graphics4/FragmentShader.hx",21,0xa52f2538)
namespace kha{
namespace graphics4{

void FragmentShader_obj::__construct(::Array< ::Dynamic> sources,::Array< ::String > files){
            	HX_STACKFRAME(&_hx_pos_a91516e8653714ce_12_new)
HXDLIN(  12)		if (::hx::IsNotNull( sources )) {
HXLINE(  13)			this->init(sources->__get(0).StaticCast<  ::kha::internal::BytesBlob >(),files->__get(0));
            		}
            	}
...
void FragmentShader_obj::init( ::kha::internal::BytesBlob source,::String file){
            	HX_STACKFRAME(&_hx_pos_a91516e8653714ce_18_init)
HXDLIN(  18)		kinc_g4_shader_init(&shader, source->bytes->b->Pointer(), source->get_length(), KINC_G4_SHADER_TYPE_FRAGMENT);;
            	}
...
void FragmentShader_obj::_hx_delete(){
            	HX_STACKFRAME(&_hx_pos_a91516e8653714ce_28_delete)
HXDLIN(  28)		kinc_g4_shader_destroy(&shader);;
            	}
...
void FragmentShader_obj::_forceInclude(){
            	HX_STACKFRAME(&_hx_pos_a91516e8653714ce_33__forceInclude)
HXDLIN(  33)		::haxe::io::Bytes_obj::alloc(0);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FragmentShader_obj,_forceInclude,(void))
 ...
 ::kha::graphics4::FragmentShader FragmentShader_obj::fromSource(::String source){
            	HX_GC_STACKFRAME(&_hx_pos_a91516e8653714ce_21_fromSource)
HXLINE(  22)		 ::kha::graphics4::FragmentShader fragmentShader =  ::kha::graphics4::FragmentShader_obj::__alloc( HX_CTX ,null(),null());
HXLINE(  23)		kinc_g4_shader_init_from_source(&fragmentShader->shader, source, KINC_G4_SHADER_TYPE_FRAGMENT);;
HXLINE(  24)		return fragmentShader;
            	}
