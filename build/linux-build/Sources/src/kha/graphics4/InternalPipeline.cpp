...
HX_DEFINE_STACK_FRAME(_hx_pos_66da5d90c9e9a906_38_new,"kha.graphics4.InternalPipeline","new",0x65c470a0,"kha.graphics4.InternalPipeline.new","kha/graphics4/Graphics2.hx",38,0x0c1de808)
namespace kha{
namespace graphics4{
...
void InternalPipeline_obj::__construct( ::kha::graphics4::PipelineState pipeline,::Dynamic projectionLocation,::Dynamic textureLocation){
            	HX_GC_STACKFRAME(&_hx_pos_66da5d90c9e9a906_38_new)
HXLINE(  39)		this->_hx_set_pipeline(HX_CTX, pipeline);
HXLINE(  40)		this->_hx_set_projectionLocation(HX_CTX, projectionLocation);
HXLINE(  41)		this->_hx_set_textureLocation(HX_CTX, textureLocation);
            	}
