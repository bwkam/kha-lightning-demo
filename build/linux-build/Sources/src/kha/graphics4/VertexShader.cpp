...
HX_DEFINE_STACK_FRAME(_hx_pos_d67788c1245542db_12_new,"kha.graphics4.VertexShader","new",0xb744d84a,"kha.graphics4.VertexShader.new","kha/graphics4/VertexShader.hx",12,0x1cb2cd64)
HX_LOCAL_STACK_FRAME(_hx_pos_d67788c1245542db_18_init,"kha.graphics4.VertexShader","init",0xa1b11fe6,"kha.graphics4.VertexShader.init","kha/graphics4/VertexShader.hx",18,0x1cb2cd64)
HX_LOCAL_STACK_FRAME(_hx_pos_d67788c1245542db_28_delete,"kha.graphics4.VertexShader","delete",0x1bb20681,"kha.graphics4.VertexShader.delete","kha/graphics4/VertexShader.hx",28,0x1cb2cd64)
HX_LOCAL_STACK_FRAME(_hx_pos_d67788c1245542db_33__forceInclude,"kha.graphics4.VertexShader","_forceInclude",0xe846bac6,"kha.graphics4.VertexShader._forceInclude","kha/graphics4/VertexShader.hx",33,0x1cb2cd64)
HX_LOCAL_STACK_FRAME(_hx_pos_d67788c1245542db_21_fromSource,"kha.graphics4.VertexShader","fromSource",0x97dfdf3b,"kha.graphics4.VertexShader.fromSource","kha/graphics4/VertexShader.hx",21,0x1cb2cd64)
namespace kha{
namespace graphics4{

void VertexShader_obj::__construct(::Array< ::Dynamic> sources,::Array< ::String > files){
            	HX_STACKFRAME(&_hx_pos_d67788c1245542db_12_new)
...
void VertexShader_obj::init( ::kha::internal::BytesBlob source,::String file){
            	HX_STACKFRAME(&_hx_pos_d67788c1245542db_18_init)
HXDLIN(  18)		kinc_g4_shader_init(&shader, source->bytes->b->Pointer(), source->get_length(), KINC_G4_SHADER_TYPE_VERTEX);;
            	}
...
void VertexShader_obj::_hx_delete(){
            	HX_STACKFRAME(&_hx_pos_d67788c1245542db_28_delete)
...
void VertexShader_obj::_forceInclude(){
            	HX_STACKFRAME(&_hx_pos_d67788c1245542db_33__forceInclude)
...
HX_DEFINE_DYNAMIC_FUNC0(VertexShader_obj,_forceInclude,(void))
 ...
 ::kha::graphics4::VertexShader VertexShader_obj::fromSource(::String source){
            	HX_GC_STACKFRAME(&_hx_pos_d67788c1245542db_21_fromSource)
HXLINE(  22)		 ::kha::graphics4::VertexShader vertexShader =  ::kha::graphics4::VertexShader_obj::__alloc( HX_CTX ,null(),null());
HXLINE(  23)		kinc_g4_shader_init_from_source(&vertexShader->shader, source, KINC_G4_SHADER_TYPE_VERTEX);;
HXLINE(  24)		return vertexShader;
            	}
