...
HX_DEFINE_STACK_FRAME(_hx_pos_82b1c26a021a807a_12_new,"kha.graphics4.GeometryShader","new",0x699e56d8,"kha.graphics4.GeometryShader.new","kha/graphics4/GeometryShader.hx",12,0x31a51616)
HX_LOCAL_STACK_FRAME(_hx_pos_82b1c26a021a807a_16_init,"kha.graphics4.GeometryShader","init",0xfda65d98,"kha.graphics4.GeometryShader.init","kha/graphics4/GeometryShader.hx",16,0x31a51616)
HX_LOCAL_STACK_FRAME(_hx_pos_82b1c26a021a807a_20_delete,"kha.graphics4.GeometryShader","delete",0x4db794b3,"kha.graphics4.GeometryShader.delete","kha/graphics4/GeometryShader.hx",20,0x31a51616)
HX_LOCAL_STACK_FRAME(_hx_pos_82b1c26a021a807a_25__forceInclude,"kha.graphics4.GeometryShader","_forceInclude",0x580936d4,"kha.graphics4.GeometryShader._forceInclude","kha/graphics4/GeometryShader.hx",25,0x31a51616)
namespace kha{
namespace graphics4{

void GeometryShader_obj::__construct(::Array< ::Dynamic> sources,::Array< ::String > files){
            	HX_STACKFRAME(&_hx_pos_82b1c26a021a807a_12_new)
...
void GeometryShader_obj::init( ::kha::internal::BytesBlob source,::String file){
            	HX_STACKFRAME(&_hx_pos_82b1c26a021a807a_16_init)
HXDLIN(  16)		kinc_g4_shader_init(&shader, source->bytes->b->Pointer(), source->get_length(), KINC_G4_SHADER_TYPE_GEOMETRY);;
            	}
...
void GeometryShader_obj::_hx_delete(){
            	HX_STACKFRAME(&_hx_pos_82b1c26a021a807a_20_delete)
...
void GeometryShader_obj::_forceInclude(){
            	HX_STACKFRAME(&_hx_pos_82b1c26a021a807a_25__forceInclude)
