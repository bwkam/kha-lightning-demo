...
HX_LOCAL_STACK_FRAME(_hx_pos_2fb7b29675aad1d3_68_get,"kha.graphics4.VertexStructure","get",0x495d8b08,"kha.graphics4.VertexStructure.get","kha/graphics4/VertexStructure.hx",68,0xec7e48a0)
...
HXLINE(  25)				byteSize = (byteSize + ::kha::graphics4::VertexStructure_obj::dataByteSize(this->elements->__get(i).StaticCast<  ::kha::graphics4::VertexElement >()->data));
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(VertexStructure_obj,byteSize,return )
 ...
 ::kha::graphics4::VertexElement VertexStructure_obj::get(int index){
            	HX_STACKFRAME(&_hx_pos_2fb7b29675aad1d3_68_get)
HXDLIN(  68)		return this->elements->__get(index).StaticCast<  ::kha::graphics4::VertexElement >();
            	}
...
HXLINE(  44)				return 1;
            			...
            			break;
            			case (int)9: case (int)10: case (int)11: case (int)12: {
HXLINE(  46)				return 2;
            			}
            			break;
            			case (int)13: case (int)14: case (int)15: case (int)16: {
HXLINE(  48)				return 4;
            			}
            			break;
            			case (int)17: case (int)18: case (int)19: case (int)20: {
HXLINE(  50)				return 2;
            			}
            			break;
            			case (int)21: case (int)22: case (int)23: case (int)24: {
HXLINE(  52)				return 4;
            			}
            			break;
            			case (int)25: case (int)26: case (int)27: case (int)28: {
HXLINE(  54)				return 8;
            			}
            			break;
            			case (int)29: case (int)30: {
HXLINE(  56)				return 4;
            			}
            			break;
            			case (int)31: case (int)32: {
HXLINE(  58)				return 8;
            			}
            			break;
            			case (int)33: case (int)34: {
HXLINE(  60)				return 12;
            			}
            			break;
            			case (int)35: case (int)36: {
HXLINE(  62)				return 16;
            			}
            			break;
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(VertexStructure_obj,dataByteSize,return )
...
bool VertexStructure_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 12:
		if (HX_FIELD_EQ(inName,"dataByteSize") ) { outValue = dataByteSize_dyn(); return true; }
	}
	return false;
}
...
static ::String VertexStructure_obj_sStaticFields[] = {
...
void VertexStructure_obj::__register()
{
	...
	__mClass->mGetStaticField = &VertexStructure_obj::__GetStatic;
	__mClass->mSetStaticField = &::hx::Class_obj::SetNoStaticField;
	__mClass->mStatics = ::hx::Class_obj::dupFunctions(VertexStructure_obj_sStaticFields);
