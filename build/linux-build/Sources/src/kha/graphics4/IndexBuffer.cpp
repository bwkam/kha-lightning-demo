...
HX_DEFINE_STACK_FRAME(_hx_pos_d3cb332205fc9ba7_13_new,"kha.graphics4.IndexBuffer","new",0x2cfac555,"kha.graphics4.IndexBuffer.new","kha/graphics4/IndexBuffer.hx",13,0xae48d67d)
HX_LOCAL_STACK_FRAME(_hx_pos_d3cb332205fc9ba7_20_delete,"kha.graphics4.IndexBuffer","delete",0x13f39256,"kha.graphics4.IndexBuffer.delete","kha/graphics4/IndexBuffer.hx",20,0xae48d67d)
HX_LOCAL_STACK_FRAME(_hx_pos_d3cb332205fc9ba7_30_lockPrivate,"kha.graphics4.IndexBuffer","lockPrivate",0xcc154e4d,"kha.graphics4.IndexBuffer.lockPrivate","kha/graphics4/IndexBuffer.hx",30,0xae48d67d)
HX_LOCAL_STACK_FRAME(_hx_pos_d3cb332205fc9ba7_33_lock,"kha.graphics4.IndexBuffer","lock",0x2d26fd56,"kha.graphics4.IndexBuffer.lock","kha/graphics4/IndexBuffer.hx",33,0xae48d67d)
HX_LOCAL_STACK_FRAME(_hx_pos_d3cb332205fc9ba7_42_unlockPrivate,"kha.graphics4.IndexBuffer","unlockPrivate",0xbcc7ebd4,"kha.graphics4.IndexBuffer.unlockPrivate","kha/graphics4/IndexBuffer.hx",42,0xae48d67d)
HX_LOCAL_STACK_FRAME(_hx_pos_d3cb332205fc9ba7_44_unlock,"kha.graphics4.IndexBuffer","unlock",0x0ea774ef,"kha.graphics4.IndexBuffer.unlock","kha/graphics4/IndexBuffer.hx",44,0xae48d67d)
HX_LOCAL_STACK_FRAME(_hx_pos_d3cb332205fc9ba7_51_count,"kha.graphics4.IndexBuffer","count",0x26692104,"kha.graphics4.IndexBuffer.count","kha/graphics4/IndexBuffer.hx",51,0xae48d67d)
namespace kha{
namespace graphics4{

void IndexBuffer_obj::__construct(int indexCount,int usage,::hx::Null< bool >  __o_canRead){
            		bool canRead = __o_canRead.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_d3cb332205fc9ba7_13_new)
HXLINE(  14)		this->myCount = indexCount;
HXLINE(  15)		this->_hx_set_data(HX_CTX, ::kha::arrays::_Uint32Array::Uint32Array_Impl__obj::_new(0));
HXLINE(  16)		kinc_g4_index_buffer_init(&buffer, indexCount, KINC_G4_INDEX_BUFFER_FORMAT_32BIT, (kinc_g4_usage_t)usage);;
            	}
...
void IndexBuffer_obj::_hx_delete(){
            	HX_STACKFRAME(&_hx_pos_d3cb332205fc9ba7_20_delete)
HXDLIN(  20)		kinc_g4_index_buffer_destroy(&buffer);;
            	}


HX_DEFINE_DYNAMIC_FUNC0(IndexBuffer_obj,_hx_delete,(void))

 ::kha::arrays::ByteArrayPrivate IndexBuffer_obj::lockPrivate(int start,int count){
            	HX_STACKFRAME(&_hx_pos_d3cb332205fc9ba7_30_lockPrivate)
...
HXDLIN(  30)		return this->data;
            	}


HX_DEFINE_DYNAMIC_FUNC2(IndexBuffer_obj,lockPrivate,return )

 ::kha::arrays::ByteArrayPrivate IndexBuffer_obj::lock( ::Dynamic start, ::Dynamic count){
            	HX_STACKFRAME(&_hx_pos_d3cb332205fc9ba7_33_lock)
HXLINE(  34)		if (::hx::IsNull( start )) {
HXLINE(  35)			start = 0;
            		}
HXLINE(  36)		if (::hx::IsNull( count )) {
HXLINE(  37)			count = this->count();
            		}
HXLINE(  38)		return this->lockPrivate(( (int)(start) ),( (int)(count) ));
            	}


HX_DEFINE_DYNAMIC_FUNC2(IndexBuffer_obj,lock,return )

void IndexBuffer_obj::unlockPrivate(int count){
            	HX_STACKFRAME(&_hx_pos_d3cb332205fc9ba7_42_unlockPrivate)
            	kinc_g4_index_buffer_unlock(&buffer, count); data->self.data = nullptr;

            	}


HX_DEFINE_DYNAMIC_FUNC1(IndexBuffer_obj,unlockPrivate,(void))

void IndexBuffer_obj::unlock( ::Dynamic count){
            	HX_STACKFRAME(&_hx_pos_d3cb332205fc9ba7_44_unlock)
HXLINE(  45)		if (::hx::IsNull( count )) {
HXLINE(  46)			count = this->count();
            		}
HXLINE(  47)		this->unlockPrivate(( (int)(count) ));
            	}
...
int IndexBuffer_obj::count(){
            	HX_STACKFRAME(&_hx_pos_d3cb332205fc9ba7_51_count)
HXDLIN(  51)		return this->myCount;
            	}
...
static ::hx::StorageInfo IndexBuffer_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::kha::arrays::ByteArrayPrivate */ ,(int)offsetof(IndexBuffer_obj,data),HX_("data",2a,56,63,42)},
