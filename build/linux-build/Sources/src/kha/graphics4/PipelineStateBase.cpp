...
HX_LOCAL_STACK_FRAME(_hx_pos_9aafec914c50cc04_112_set_colorWriteMask,"kha.graphics4.PipelineStateBase","set_colorWriteMask",0x6ce455e2,"kha.graphics4.PipelineStateBase.set_colorWriteMask","kha/graphics4/PipelineStateBase.hx",112,0x8daa4c6f)
HX_LOCAL_STACK_FRAME(_hx_pos_9aafec914c50cc04_116_get_colorWriteMaskRed,"kha.graphics4.PipelineStateBase","get_colorWriteMaskRed",0x2a56c683,"kha.graphics4.PipelineStateBase.get_colorWriteMaskRed","kha/graphics4/PipelineStateBase.hx",116,0x8daa4c6f)
HX_LOCAL_STACK_FRAME(_hx_pos_9aafec914c50cc04_120_set_colorWriteMaskRed,"kha.graphics4.PipelineStateBase","set_colorWriteMaskRed",0x7e5f948f,"kha.graphics4.PipelineStateBase.set_colorWriteMaskRed","kha/graphics4/PipelineStateBase.hx",120,0x8daa4c6f)
HX_LOCAL_STACK_FRAME(_hx_pos_9aafec914c50cc04_124_get_colorWriteMaskGreen,"kha.graphics4.PipelineStateBase","get_colorWriteMaskGreen",0x35a82c75,"kha.graphics4.PipelineStateBase.get_colorWriteMaskGreen","kha/graphics4/PipelineStateBase.hx",124,0x8daa4c6f)
HX_LOCAL_STACK_FRAME(_hx_pos_9aafec914c50cc04_128_set_colorWriteMaskGreen,"kha.graphics4.PipelineStateBase","set_colorWriteMaskGreen",0x38099581,"kha.graphics4.PipelineStateBase.set_colorWriteMaskGreen","kha/graphics4/PipelineStateBase.hx",128,0x8daa4c6f)
HX_LOCAL_STACK_FRAME(_hx_pos_9aafec914c50cc04_132_get_colorWriteMaskBlue,"kha.graphics4.PipelineStateBase","get_colorWriteMaskBlue",0xd708e128,"kha.graphics4.PipelineStateBase.get_colorWriteMaskBlue","kha/graphics4/PipelineStateBase.hx",132,0x8daa4c6f)
HX_LOCAL_STACK_FRAME(_hx_pos_9aafec914c50cc04_136_set_colorWriteMaskBlue,"kha.graphics4.PipelineStateBase","set_colorWriteMaskBlue",0x0ab45d9c,"kha.graphics4.PipelineStateBase.set_colorWriteMaskBlue","kha/graphics4/PipelineStateBase.hx",136,0x8daa4c6f)
HX_LOCAL_STACK_FRAME(_hx_pos_9aafec914c50cc04_140_get_colorWriteMaskAlpha,"kha.graphics4.PipelineStateBase","get_colorWriteMaskAlpha",0xbd51c510,"kha.graphics4.PipelineStateBase.get_colorWriteMaskAlpha","kha/graphics4/PipelineStateBase.hx",140,0x8daa4c6f)
HX_LOCAL_STACK_FRAME(_hx_pos_9aafec914c50cc04_144_set_colorWriteMaskAlpha,"kha.graphics4.PipelineStateBase","set_colorWriteMaskAlpha",0xbfb32e1c,"kha.graphics4.PipelineStateBase.set_colorWriteMaskAlpha","kha/graphics4/PipelineStateBase.hx",144,0x8daa4c6f)
namespace kha{
namespace graphics4{
...
HXLINE(  17)		this->stencilFrontMode = 0;
HXLINE(  18)		this->stencilFrontBothPass = 0;
HXLINE(  19)		this->stencilFrontDepthFail = 0;
HXLINE(  20)		this->stencilFrontFail = 0;
HXLINE(  22)		this->stencilBackMode = 0;
HXLINE(  23)		this->stencilBackBothPass = 0;
HXLINE(  24)		this->stencilBackDepthFail = 0;
HXLINE(  25)		this->stencilBackFail = 0;
HXLINE(  27)		this->_hx_set_stencilReferenceValue(HX_CTX, ::kha::graphics4::StencilValue_obj::Static(0));
HXLINE(  28)		this->stencilReadMask = 255;
HXLINE(  29)		this->stencilWriteMask = 255;
HXLINE(  31)		this->blendSource = 1;
HXLINE(  32)		this->blendDestination = 2;
HXLINE(  33)		this->blendOperation = 0;
HXLINE(  34)		this->alphaBlendSource = 1;
HXLINE(  35)		this->alphaBlendDestination = 2;
HXLINE(  36)		this->alphaBlendOperation = 0;
HXLINE(  38)		this->_hx_set_colorWriteMasksRed(HX_CTX, ::Array_obj< bool >::__new(0));
HXLINE(  39)		this->_hx_set_colorWriteMasksGreen(HX_CTX, ::Array_obj< bool >::__new(0));
HXLINE(  40)		this->_hx_set_colorWriteMasksBlue(HX_CTX, ::Array_obj< bool >::__new(0));
HXLINE(  41)		this->_hx_set_colorWriteMasksAlpha(HX_CTX, ::Array_obj< bool >::__new(0));
HXLINE(  42)		{
HXLINE(  43)			this->colorWriteMasksRed->push(true);
HXDLIN(  43)			this->colorWriteMasksRed->push(true);
HXDLIN(  43)			this->colorWriteMasksRed->push(true);
HXDLIN(  43)			this->colorWriteMasksRed->push(true);
HXDLIN(  43)			this->colorWriteMasksRed->push(true);
HXDLIN(  43)			this->colorWriteMasksRed->push(true);
...
HXLINE(  44)		{
HXLINE(  45)			this->colorWriteMasksGreen->push(true);
HXDLIN(  45)			this->colorWriteMasksGreen->push(true);
HXDLIN(  45)			this->colorWriteMasksGreen->push(true);
HXDLIN(  45)			this->colorWriteMasksGreen->push(true);
HXDLIN(  45)			this->colorWriteMasksGreen->push(true);
HXDLIN(  45)			this->colorWriteMasksGreen->push(true);
...
HXLINE(  46)		{
HXLINE(  47)			this->colorWriteMasksBlue->push(true);
HXDLIN(  47)			this->colorWriteMasksBlue->push(true);
HXDLIN(  47)			this->colorWriteMasksBlue->push(true);
HXDLIN(  47)			this->colorWriteMasksBlue->push(true);
HXDLIN(  47)			this->colorWriteMasksBlue->push(true);
HXDLIN(  47)			this->colorWriteMasksBlue->push(true);
...
HXLINE(  48)		{
HXLINE(  49)			this->colorWriteMasksAlpha->push(true);
HXDLIN(  49)			this->colorWriteMasksAlpha->push(true);
HXDLIN(  49)			this->colorWriteMasksAlpha->push(true);
HXDLIN(  49)			this->colorWriteMasksAlpha->push(true);
HXDLIN(  49)			this->colorWriteMasksAlpha->push(true);
HXDLIN(  49)			this->colorWriteMasksAlpha->push(true);
...
HXLINE(  51)		this->colorAttachmentCount = 1;
HXLINE(  52)		this->_hx_set_colorAttachments(HX_CTX, ::Array_obj< int >::__new(0));
HXLINE(  53)		{
HXLINE(  54)			this->colorAttachments->push(0);
HXDLIN(  54)			this->colorAttachments->push(0);
HXDLIN(  54)			this->colorAttachments->push(0);
HXDLIN(  54)			this->colorAttachments->push(0);
HXDLIN(  54)			this->colorAttachments->push(0);
HXDLIN(  54)			this->colorAttachments->push(0);
...
HXLINE(  56)		this->depthStencilAttachment = 0;
HXLINE(  58)		this->conservativeRasterization = false;
            	}
...
bool PipelineStateBase_obj::set_colorWriteMask(bool value){
            	HX_STACKFRAME(&_hx_pos_9aafec914c50cc04_112_set_colorWriteMask)
HXDLIN( 112)		bool value1 = (this->colorWriteMasksAlpha[0] = value);
HXDLIN( 112)		bool value2 = (this->colorWriteMasksGreen[0] = value1);
HXDLIN( 112)		bool value3 = (this->colorWriteMasksBlue[0] = value2);
HXDLIN( 112)		return (this->colorWriteMasksRed[0] = value3);
            	}
...
bool PipelineStateBase_obj::get_colorWriteMaskRed(){
            	HX_STACKFRAME(&_hx_pos_9aafec914c50cc04_116_get_colorWriteMaskRed)
HXDLIN( 116)		return this->colorWriteMasksRed->__get(0);
            	}
...
bool PipelineStateBase_obj::set_colorWriteMaskRed(bool value){
            	HX_STACKFRAME(&_hx_pos_9aafec914c50cc04_120_set_colorWriteMaskRed)
HXDLIN( 120)		return (this->colorWriteMasksRed[0] = value);
            	}
...
bool PipelineStateBase_obj::get_colorWriteMaskGreen(){
            	HX_STACKFRAME(&_hx_pos_9aafec914c50cc04_124_get_colorWriteMaskGreen)
HXDLIN( 124)		return this->colorWriteMasksGreen->__get(0);
            	}
...
bool PipelineStateBase_obj::set_colorWriteMaskGreen(bool value){
            	HX_STACKFRAME(&_hx_pos_9aafec914c50cc04_128_set_colorWriteMaskGreen)
HXDLIN( 128)		return (this->colorWriteMasksGreen[0] = value);
            	}
...
bool PipelineStateBase_obj::get_colorWriteMaskBlue(){
            	HX_STACKFRAME(&_hx_pos_9aafec914c50cc04_132_get_colorWriteMaskBlue)
HXDLIN( 132)		return this->colorWriteMasksBlue->__get(0);
            	}
...
bool PipelineStateBase_obj::set_colorWriteMaskBlue(bool value){
            	HX_STACKFRAME(&_hx_pos_9aafec914c50cc04_136_set_colorWriteMaskBlue)
HXDLIN( 136)		return (this->colorWriteMasksBlue[0] = value);
            	}
...
bool PipelineStateBase_obj::get_colorWriteMaskAlpha(){
            	HX_STACKFRAME(&_hx_pos_9aafec914c50cc04_140_get_colorWriteMaskAlpha)
HXDLIN( 140)		return this->colorWriteMasksAlpha->__get(0);
            	}
...
bool PipelineStateBase_obj::set_colorWriteMaskAlpha(bool value){
            	HX_STACKFRAME(&_hx_pos_9aafec914c50cc04_144_set_colorWriteMaskAlpha)
HXDLIN( 144)		return (this->colorWriteMasksAlpha[0] = value);
            	}
...
void PipelineStateBase_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(stencilFrontMode,"stencilFrontMode");
	HX_MARK_MEMBER_NAME(stencilFrontBothPass,"stencilFrontBothPass");
	HX_MARK_MEMBER_NAME(stencilFrontDepthFail,"stencilFrontDepthFail");
	HX_MARK_MEMBER_NAME(stencilFrontFail,"stencilFrontFail");
	HX_MARK_MEMBER_NAME(stencilBackMode,"stencilBackMode");
	HX_MARK_MEMBER_NAME(stencilBackBothPass,"stencilBackBothPass");
	HX_MARK_MEMBER_NAME(stencilBackDepthFail,"stencilBackDepthFail");
	HX_MARK_MEMBER_NAME(stencilBackFail,"stencilBackFail");
...
void PipelineStateBase_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(stencilFrontMode,"stencilFrontMode");
	HX_VISIT_MEMBER_NAME(stencilFrontBothPass,"stencilFrontBothPass");
	HX_VISIT_MEMBER_NAME(stencilFrontDepthFail,"stencilFrontDepthFail");
	HX_VISIT_MEMBER_NAME(stencilFrontFail,"stencilFrontFail");
	HX_VISIT_MEMBER_NAME(stencilBackMode,"stencilBackMode");
	HX_VISIT_MEMBER_NAME(stencilBackBothPass,"stencilBackBothPass");
	HX_VISIT_MEMBER_NAME(stencilBackDepthFail,"stencilBackDepthFail");
	HX_VISIT_MEMBER_NAME(stencilBackFail,"stencilBackFail");
...
::hx::Val PipelineStateBase_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 14:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"stencilBackMode") ) { return ::hx::Val( stencilBackMode ); }
		if (HX_FIELD_EQ(inName,"stencilBackFail") ) { return ::hx::Val( stencilBackFail ); }
		if (HX_FIELD_EQ(inName,"stencilReadMask") ) { return ::hx::Val( stencilReadMask ); }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"stencilFrontMode") ) { return ::hx::Val( stencilFrontMode ); }
		if (HX_FIELD_EQ(inName,"stencilFrontFail") ) { return ::hx::Val( stencilFrontFail ); }
	...
	case 18:
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"stencilBackBothPass") ) { return ::hx::Val( stencilBackBothPass ); }
		...
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"stencilFrontBothPass") ) { return ::hx::Val( stencilFrontBothPass ); }
		if (HX_FIELD_EQ(inName,"stencilBackDepthFail") ) { return ::hx::Val( stencilBackDepthFail ); }
		...
		break;
	case 21:
		if (HX_FIELD_EQ(inName,"stencilFrontDepthFail") ) { return ::hx::Val( stencilFrontDepthFail ); }
...
::hx::Val PipelineStateBase_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 14:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"stencilBackMode") ) { stencilBackMode=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"stencilBackFail") ) { stencilBackFail=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"stencilReadMask") ) { stencilReadMask=inValue.Cast< int >(); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"stencilFrontMode") ) { stencilFrontMode=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"stencilFrontFail") ) { stencilFrontFail=inValue.Cast< int >(); return inValue; }
	...
	case 18:
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"stencilBackBothPass") ) { stencilBackBothPass=inValue.Cast< int >(); return inValue; }
		...
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"stencilFrontBothPass") ) { stencilFrontBothPass=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"stencilBackDepthFail") ) { stencilBackDepthFail=inValue.Cast< int >(); return inValue; }
		...
		break;
	case 21:
		if (HX_FIELD_EQ(inName,"stencilFrontDepthFail") ) { stencilFrontDepthFail=inValue.Cast< int >(); return inValue; }
...
void PipelineStateBase_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("stencilFrontMode",10,a3,a9,52));
	outFields->push(HX_("stencilFrontBothPass",1f,18,0a,c2));
	outFields->push(HX_("stencilFrontDepthFail",b4,51,5f,56));
	outFields->push(HX_("stencilFrontFail",8b,89,fe,4d));
	outFields->push(HX_("stencilBackMode",46,4f,3e,80));
	outFields->push(HX_("stencilBackBothPass",55,17,08,4d));
	outFields->push(HX_("stencilBackDepthFail",be,a1,a0,69));
	outFields->push(HX_("stencilBackFail",c1,35,93,7b));
...
static ::hx::StorageInfo PipelineStateBase_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsInt,(int)offsetof(PipelineStateBase_obj,stencilFrontMode),HX_("stencilFrontMode",10,a3,a9,52)},
	{::hx::fsInt,(int)offsetof(PipelineStateBase_obj,stencilFrontBothPass),HX_("stencilFrontBothPass",1f,18,0a,c2)},
	{::hx::fsInt,(int)offsetof(PipelineStateBase_obj,stencilFrontDepthFail),HX_("stencilFrontDepthFail",b4,51,5f,56)},
	{::hx::fsInt,(int)offsetof(PipelineStateBase_obj,stencilFrontFail),HX_("stencilFrontFail",8b,89,fe,4d)},
	{::hx::fsInt,(int)offsetof(PipelineStateBase_obj,stencilBackMode),HX_("stencilBackMode",46,4f,3e,80)},
	{::hx::fsInt,(int)offsetof(PipelineStateBase_obj,stencilBackBothPass),HX_("stencilBackBothPass",55,17,08,4d)},
	{::hx::fsInt,(int)offsetof(PipelineStateBase_obj,stencilBackDepthFail),HX_("stencilBackDepthFail",be,a1,a0,69)},
	{::hx::fsInt,(int)offsetof(PipelineStateBase_obj,stencilBackFail),HX_("stencilBackFail",c1,35,93,7b)},
...
static ::String PipelineStateBase_obj_sMemberFields[] = {
	...
	HX_("stencilFrontMode",10,a3,a9,52),
	HX_("stencilFrontBothPass",1f,18,0a,c2),
	HX_("stencilFrontDepthFail",b4,51,5f,56),
	HX_("stencilFrontFail",8b,89,fe,4d),
	HX_("stencilBackMode",46,4f,3e,80),
	HX_("stencilBackBothPass",55,17,08,4d),
	HX_("stencilBackDepthFail",be,a1,a0,69),
	HX_("stencilBackFail",c1,35,93,7b),
