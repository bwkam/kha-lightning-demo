...
HXLINE(  20)				int _hx_tmp2 = this->texture->get_realHeight();
HXDLIN(  20)				_hx_tmp = (_hx_tmp2 != ::kha::Canvas_obj::get_height(this->canvas));
            			}
            			else {
...
HXLINE(  21)			int _hx_tmp3 = ::kha::Canvas_obj::get_width(this->canvas);
HXDLIN(  21)			this->_hx_set_texture(HX_CTX, ::kha::Image_obj::create(_hx_tmp3,::kha::Canvas_obj::get_height(this->canvas),0,2,null()));
            		}
