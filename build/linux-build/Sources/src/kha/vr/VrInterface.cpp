...
HX_DEFINE_STACK_FRAME(_hx_pos_762cff4ae71864db_62_new,"kha.vr.VrInterface","new",0x7eec7f07,"kha.vr.VrInterface.new","kha/vr/VrInterface.hx",62,0x16260ce9)
HX_LOCAL_STACK_FRAME(_hx_pos_762cff4ae71864db_10_GetSensorState,"kha.vr.VrInterface","GetSensorState",0x5524dd5a,"kha.vr.VrInterface.GetSensorState","kha/vr/VrInterface.hx",10,0x16260ce9)
HX_LOCAL_STACK_FRAME(_hx_pos_762cff4ae71864db_15_GetPredictedSensorState,"kha.vr.VrInterface","GetPredictedSensorState",0x54937c5c,"kha.vr.VrInterface.GetPredictedSensorState","kha/vr/VrInterface.hx",15,0x16260ce9)
HX_LOCAL_STACK_FRAME(_hx_pos_762cff4ae71864db_19_WarpSwapBlack,"kha.vr.VrInterface","WarpSwapBlack",0xd89b500b,"kha.vr.VrInterface.WarpSwapBlack","kha/vr/VrInterface.hx",19,0x16260ce9)
HX_LOCAL_STACK_FRAME(_hx_pos_762cff4ae71864db_22_WarpSwapLoadingIcon,"kha.vr.VrInterface","WarpSwapLoadingIcon",0xe70e0b61,"kha.vr.VrInterface.WarpSwapLoadingIcon","kha/vr/VrInterface.hx",22,0x16260ce9)
HX_LOCAL_STACK_FRAME(_hx_pos_762cff4ae71864db_25_WarpSwap,"kha.vr.VrInterface","WarpSwap",0xf3580d14,"kha.vr.VrInterface.WarpSwap","kha/vr/VrInterface.hx",25,0x16260ce9)
HX_LOCAL_STACK_FRAME(_hx_pos_762cff4ae71864db_29_IsPresenting,"kha.vr.VrInterface","IsPresenting",0xeae3d9ea,"kha.vr.VrInterface.IsPresenting","kha/vr/VrInterface.hx",29,0x16260ce9)
HX_LOCAL_STACK_FRAME(_hx_pos_762cff4ae71864db_34_IsVrEnabled,"kha.vr.VrInterface","IsVrEnabled",0x4964e0e2,"kha.vr.VrInterface.IsVrEnabled","kha/vr/VrInterface.hx",34,0x16260ce9)
HX_LOCAL_STACK_FRAME(_hx_pos_762cff4ae71864db_40_GetTimeInSeconds,"kha.vr.VrInterface","GetTimeInSeconds",0xc5741df0,"kha.vr.VrInterface.GetTimeInSeconds","kha/vr/VrInterface.hx",40,0x16260ce9)
HX_LOCAL_STACK_FRAME(_hx_pos_762cff4ae71864db_45_GetProjectionMatrix,"kha.vr.VrInterface","GetProjectionMatrix",0x3da2156d,"kha.vr.VrInterface.GetProjectionMatrix","kha/vr/VrInterface.hx",45,0x16260ce9)
HX_LOCAL_STACK_FRAME(_hx_pos_762cff4ae71864db_50_GetViewMatrix,"kha.vr.VrInterface","GetViewMatrix",0x8c0e0803,"kha.vr.VrInterface.GetViewMatrix","kha/vr/VrInterface.hx",50,0x16260ce9)
HX_LOCAL_STACK_FRAME(_hx_pos_762cff4ae71864db_54_onVRRequestPresent,"kha.vr.VrInterface","onVRRequestPresent",0x971ee020,"kha.vr.VrInterface.onVRRequestPresent","kha/vr/VrInterface.hx",54,0x16260ce9)
HX_LOCAL_STACK_FRAME(_hx_pos_762cff4ae71864db_57_onVRExitPresent,"kha.vr.VrInterface","onVRExitPresent",0x6bef2e49,"kha.vr.VrInterface.onVRExitPresent","kha/vr/VrInterface.hx",57,0x16260ce9)
HX_LOCAL_STACK_FRAME(_hx_pos_762cff4ae71864db_60_onResetPose,"kha.vr.VrInterface","onResetPose",0x39fd9e48,"kha.vr.VrInterface.onResetPose","kha/vr/VrInterface.hx",60,0x16260ce9)
namespace kha{
namespace vr{

void VrInterface_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_762cff4ae71864db_62_new)
            	}
...
bool VrInterface_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::kha::vr::SensorState VrInterface_obj::GetSensorState(){
            	HX_STACKFRAME(&_hx_pos_762cff4ae71864db_10_GetSensorState)
...
HX_DEFINE_DYNAMIC_FUNC0(VrInterface_obj,GetSensorState,return )
 ...
 ::kha::vr::SensorState VrInterface_obj::GetPredictedSensorState(Float time){
            	HX_STACKFRAME(&_hx_pos_762cff4ae71864db_15_GetPredictedSensorState)
...
void VrInterface_obj::WarpSwapBlack(){
            	HX_STACKFRAME(&_hx_pos_762cff4ae71864db_19_WarpSwapBlack)
            	}
...
void VrInterface_obj::WarpSwapLoadingIcon(){
            	HX_STACKFRAME(&_hx_pos_762cff4ae71864db_22_WarpSwapLoadingIcon)
            	}
...
void VrInterface_obj::WarpSwap( ::kha::vr::TimeWarpParms parms){
            	HX_STACKFRAME(&_hx_pos_762cff4ae71864db_25_WarpSwap)
            	}
...
bool VrInterface_obj::IsPresenting(){
            	HX_STACKFRAME(&_hx_pos_762cff4ae71864db_29_IsPresenting)
...
bool VrInterface_obj::IsVrEnabled(){
            	HX_STACKFRAME(&_hx_pos_762cff4ae71864db_34_IsVrEnabled)
...
Float VrInterface_obj::GetTimeInSeconds(){
            	HX_STACKFRAME(&_hx_pos_762cff4ae71864db_40_GetTimeInSeconds)
HXDLIN(  40)		return ((Float)0.0);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(VrInterface_obj,GetTimeInSeconds,return )
 ...
 ::kha::math::FastMatrix4 VrInterface_obj::GetProjectionMatrix(int eye){
            	HX_STACKFRAME(&_hx_pos_762cff4ae71864db_45_GetProjectionMatrix)
...
HX_DEFINE_DYNAMIC_FUNC1(VrInterface_obj,GetProjectionMatrix,return )
 ...
 ::kha::math::FastMatrix4 VrInterface_obj::GetViewMatrix(int eye){
            	HX_STACKFRAME(&_hx_pos_762cff4ae71864db_50_GetViewMatrix)
...
void VrInterface_obj::onVRRequestPresent(){
            	HX_STACKFRAME(&_hx_pos_762cff4ae71864db_54_onVRRequestPresent)
            	}
...
void VrInterface_obj::onVRExitPresent(){
            	HX_STACKFRAME(&_hx_pos_762cff4ae71864db_57_onVRExitPresent)
            	}
...
void VrInterface_obj::onResetPose(){
            	HX_STACKFRAME(&_hx_pos_762cff4ae71864db_60_onResetPose)
            	}
