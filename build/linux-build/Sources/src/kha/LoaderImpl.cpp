...
HX_LOCAL_STACK_FRAME(_hx_pos_ca15ff0e900ea23d_108_hideKeyboard,"kha.LoaderImpl","hideKeyboard",0xac7eb9da,"kha.LoaderImpl.hideKeyboard","kha/LoaderImpl.hx",108,0xe7c84980)
HX_LOCAL_STACK_FRAME(_hx_pos_ca15ff0e900ea23d_111_loadURL,"kha.LoaderImpl","loadURL",0x42883038,"kha.LoaderImpl.loadURL","kha/LoaderImpl.hx",111,0xe7c84980)
HX_LOCAL_STACK_FRAME(_hx_pos_ca15ff0e900ea23d_114_blobLoaded,"kha.LoaderImpl","blobLoaded",0xdb2a7153,"kha.LoaderImpl.blobLoaded","kha/LoaderImpl.hx",114,0xe7c84980)
HX_LOCAL_STACK_FRAME(_hx_pos_ca15ff0e900ea23d_118_blobErrored,"kha.LoaderImpl","blobErrored",0xcb13a119,"kha.LoaderImpl.blobErrored","kha/LoaderImpl.hx",118,0xe7c84980)
HX_LOCAL_STACK_FRAME(_hx_pos_ca15ff0e900ea23d_121_soundLoadedCompressed,"kha.LoaderImpl","soundLoadedCompressed",0xe6841b64,"kha.LoaderImpl.soundLoadedCompressed","kha/LoaderImpl.hx",121,0xe7c84980)
HX_LOCAL_STACK_FRAME(_hx_pos_ca15ff0e900ea23d_131_soundLoadedUncompressed,"kha.LoaderImpl","soundLoadedUncompressed",0xabcf09bd,"kha.LoaderImpl.soundLoadedUncompressed","kha/LoaderImpl.hx",131,0xe7c84980)
HX_LOCAL_STACK_FRAME(_hx_pos_ca15ff0e900ea23d_142_soundErrored,"kha.LoaderImpl","soundErrored",0x81928369,"kha.LoaderImpl.soundErrored","kha/LoaderImpl.hx",142,0xe7c84980)
HX_LOCAL_STACK_FRAME(_hx_pos_ca15ff0e900ea23d_146_createFloat32Array,"kha.LoaderImpl","createFloat32Array",0x8da4c08b,"kha.LoaderImpl.createFloat32Array","kha/LoaderImpl.hx",146,0xe7c84980)
HX_LOCAL_STACK_FRAME(_hx_pos_ca15ff0e900ea23d_150_createEmptyImage,"kha.LoaderImpl","createEmptyImage",0xcff2ea7b,"kha.LoaderImpl.createEmptyImage","kha/LoaderImpl.hx",150,0xe7c84980)
HX_LOCAL_STACK_FRAME(_hx_pos_ca15ff0e900ea23d_154_imageLoaded,"kha.LoaderImpl","imageLoaded",0xe3db4c8f,"kha.LoaderImpl.imageLoaded","kha/LoaderImpl.hx",154,0xe7c84980)
HX_LOCAL_STACK_FRAME(_hx_pos_ca15ff0e900ea23d_158_imageErrored,"kha.LoaderImpl","imageErrored",0x5d229a5d,"kha.LoaderImpl.imageErrored","kha/LoaderImpl.hx",158,0xe7c84980)
HX_LOCAL_STACK_FRAME(_hx_pos_ca15ff0e900ea23d_219_tick,"kha.LoaderImpl","tick",0xe24104ae,"kha.LoaderImpl.tick","kha/LoaderImpl.hx",219,0xe7c84980)
...
bool LoaderImpl_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::cpp::Int64Map LoaderImpl_obj::blobCallbacks;

 ::cpp::Int64Map LoaderImpl_obj::imageCallbacks;

 ::cpp::Int64Map LoaderImpl_obj::soundCallbacks;
...
HXDLIN(  49)		::cpp::Int64 k = ::kha::LoaderImpl_obj::loadSound(( (::String)( ::Dynamic(desc->__Field(HX_("files",77,de,98,00),::hx::paccDynamic))->__GetItem(0)) ));
HXDLIN(  49)		 ::kha::SoundCallback v =  ::kha::SoundCallback_obj::__alloc( HX_CTX ,done,failed);
HXDLIN(  49)		( ( ::cpp::Int64Map)(this1) )->set(k,v);
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC3(LoaderImpl_obj,loadSoundFromDescription,(void))

::cpp::Int64 LoaderImpl_obj::loadSound(::String filename){
            	HX_STACKFRAME(&_hx_pos_ca15ff0e900ea23d_54_loadSound)
            	return kha_loader_load_sound(filename);

HXDLIN(  54)		return ( (::cpp::Int64)(0) );
            	}
...
HXDLIN(  64)			::cpp::Int64 k = ::kha::LoaderImpl_obj::loadImage(( (::String)( ::Dynamic(desc->__Field(HX_("files",77,de,98,00),::hx::paccDynamic))->__GetItem(0)) ),readable);
HXDLIN(  64)			 ::kha::ImageCallback v =  ::kha::ImageCallback_obj::__alloc( HX_CTX ,done,failed);
HXDLIN(  64)			( ( ::cpp::Int64Map)(this1) )->set(k,v);
            		}
            	}
...
HXDLIN(  77)		::cpp::Int64 k = ::kha::LoaderImpl_obj::loadBlob(( (::String)( ::Dynamic(desc->__Field(HX_("files",77,de,98,00),::hx::paccDynamic))->__GetItem(0)) ));
HXDLIN(  77)		 ::kha::BlobCallback v =  ::kha::BlobCallback_obj::__alloc( HX_CTX ,done,failed);
HXDLIN(  77)		( ( ::cpp::Int64Map)(this1) )->set(k,v);
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC3(LoaderImpl_obj,loadBlobFromDescription,(void))

::cpp::Int64 LoaderImpl_obj::loadBlob(::String filename){
            	HX_STACKFRAME(&_hx_pos_ca15ff0e900ea23d_82_loadBlob)
            	return kha_loader_load_blob(filename);

HXDLIN(  82)		return ( (::cpp::Int64)(0) );
            	}
...
::String LoaderImpl_obj::videoFormat(){
            	...
            	return ::String(kinc_video_formats()[0]);
...
void LoaderImpl_obj::hideKeyboard(){
            	HX_STACKFRAME(&_hx_pos_ca15ff0e900ea23d_108_hideKeyboard)
            	kinc_keyboard_hide();
...
void LoaderImpl_obj::loadURL(::String url){
            	HX_STACKFRAME(&_hx_pos_ca15ff0e900ea23d_111_loadURL)
            	kinc_load_url(url);
...
void LoaderImpl_obj::blobLoaded(::cpp::Int64 index,::Array< unsigned char > bytes){
            	HX_GC_STACKFRAME(&_hx_pos_ca15ff0e900ea23d_114_blobLoaded)
HXDLIN( 114)		 ::Dynamic _hx_tmp = ( ( ::kha::BlobCallback)(::kha::LoaderImpl_obj::blobCallbacks->get(index)) )->success;
HXDLIN( 114)		_hx_tmp( ::kha::internal::BytesBlob_obj::__alloc( HX_CTX ,::haxe::io::Bytes_obj::ofData(bytes)));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC2(LoaderImpl_obj,blobLoaded,(void))

void LoaderImpl_obj::blobErrored(::cpp::Int64 index,::String filename){
            	HX_STACKFRAME(&_hx_pos_ca15ff0e900ea23d_118_blobErrored)
HXDLIN( 118)		 ::kha::BlobCallback _hx_tmp = ( ( ::kha::BlobCallback)(::kha::LoaderImpl_obj::blobCallbacks->get(index)) );
HXDLIN( 118)		_hx_tmp->error( ::Dynamic(::hx::Anon_obj::Create(1)
...
void LoaderImpl_obj::soundLoadedCompressed(::cpp::Int64 index,::Array< unsigned char > bytes){
            	HX_GC_STACKFRAME(&_hx_pos_ca15ff0e900ea23d_121_soundLoadedCompressed)
HXLINE( 122)		 ::kha::Sound sound =  ::kha::Sound_obj::__alloc( HX_CTX );
HXLINE( 123)		sound->_hx_set_compressedData(HX_CTX, ::haxe::io::Bytes_obj::ofData(bytes));
HXLINE( 124)		sound->_hx_set_uncompressedData(HX_CTX, null());
HXLINE( 125)		sound->channels = 0;
HXLINE( 126)		sound->sampleRate = 0;
HXLINE( 127)		sound->length = ( (Float)(0) );
HXLINE( 128)		( ( ::kha::SoundCallback)(::kha::LoaderImpl_obj::soundCallbacks->get(index)) )->success(sound);
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC2(LoaderImpl_obj,soundLoadedCompressed,(void))

void LoaderImpl_obj::soundLoadedUncompressed(::cpp::Int64 index, ::kha::arrays::ByteArrayPrivate samples,int channels,int sampleRate,Float length){
            	HX_GC_STACKFRAME(&_hx_pos_ca15ff0e900ea23d_131_soundLoadedUncompressed)
HXLINE( 132)		 ::kha::Sound sound =  ::kha::Sound_obj::__alloc( HX_CTX );
HXLINE( 133)		sound->_hx_set_compressedData(HX_CTX, null());
HXLINE( 134)		sound->_hx_set_uncompressedData(HX_CTX, samples);
HXLINE( 135)		sound->channels = channels;
HXLINE( 136)		sound->sampleRate = sampleRate;
HXLINE( 137)		sound->length = length;
HXLINE( 138)		( ( ::kha::SoundCallback)(::kha::LoaderImpl_obj::soundCallbacks->get(index)) )->success(sound);
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC5(LoaderImpl_obj,soundLoadedUncompressed,(void))

void LoaderImpl_obj::soundErrored(::cpp::Int64 index,::String filename){
            	HX_STACKFRAME(&_hx_pos_ca15ff0e900ea23d_142_soundErrored)
HXDLIN( 142)		 ::kha::SoundCallback _hx_tmp = ( ( ::kha::SoundCallback)(::kha::LoaderImpl_obj::soundCallbacks->get(index)) );
HXDLIN( 142)		_hx_tmp->error( ::Dynamic(::hx::Anon_obj::Create(1)
            			->setFixed(0,HX_("url",6f,2b,59,00),filename)));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(LoaderImpl_obj,soundErrored,(void))
 ...
 ::kha::arrays::ByteArrayPrivate LoaderImpl_obj::createFloat32Array(){
            	HX_STACKFRAME(&_hx_pos_ca15ff0e900ea23d_146_createFloat32Array)
HXDLIN( 146)		return ::kha::arrays::_Float32Array::Float32Array_Impl__obj::_new(0);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(LoaderImpl_obj,createFloat32Array,return )
 ...
 ::kha::Image LoaderImpl_obj::createEmptyImage(bool readable,bool floatFormat){
            	HX_STACKFRAME(&_hx_pos_ca15ff0e900ea23d_150_createEmptyImage)
HXDLIN( 150)		return ::kha::Image_obj::createEmpty(readable,floatFormat);
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC2(LoaderImpl_obj,createEmptyImage,return )

void LoaderImpl_obj::imageLoaded(::cpp::Int64 index, ::kha::Image image){
            	HX_STACKFRAME(&_hx_pos_ca15ff0e900ea23d_154_imageLoaded)
HXDLIN( 154)		( ( ::kha::ImageCallback)(::kha::LoaderImpl_obj::imageCallbacks->get(index)) )->success(image);
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC2(LoaderImpl_obj,imageLoaded,(void))

void LoaderImpl_obj::imageErrored(::cpp::Int64 index,::String filename){
            	HX_STACKFRAME(&_hx_pos_ca15ff0e900ea23d_158_imageErrored)
HXDLIN( 158)		 ::kha::ImageCallback _hx_tmp = ( ( ::kha::ImageCallback)(::kha::LoaderImpl_obj::imageCallbacks->get(index)) );
HXDLIN( 158)		_hx_tmp->error( ::Dynamic(::hx::Anon_obj::Create(1)
            			->setFixed(0,HX_("url",6f,2b,59,00),filename)));
            	}
...
void LoaderImpl_obj::tick(){
            	HX_STACKFRAME(&_hx_pos_ca15ff0e900ea23d_219_tick)
...
bool LoaderImpl_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 13:
		if (HX_FIELD_EQ(inName,"blobCallbacks") ) { blobCallbacks=ioValue.Cast<  ::cpp::Int64Map >(); return true; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"imageCallbacks") ) { imageCallbacks=ioValue.Cast<  ::cpp::Int64Map >(); return true; }
		if (HX_FIELD_EQ(inName,"soundCallbacks") ) { soundCallbacks=ioValue.Cast<  ::cpp::Int64Map >(); return true; }
	}
	return false;
}
...
static ::hx::StaticInfo LoaderImpl_obj_sStaticStorageInfo[] = {
	{::hx::fsObject /*  ::cpp::Int64Map */ ,(void *) &LoaderImpl_obj::blobCallbacks,HX_("blobCallbacks",f1,81,f7,35)},
	{::hx::fsObject /*  ::cpp::Int64Map */ ,(void *) &LoaderImpl_obj::imageCallbacks,HX_("imageCallbacks",33,70,06,75)},
	{::hx::fsObject /*  ::cpp::Int64Map */ ,(void *) &LoaderImpl_obj::soundCallbacks,HX_("soundCallbacks",3f,b4,0b,84)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
HXDLIN(  44)		blobCallbacks =  ::cpp::Int64Map_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_ca15ff0e900ea23d_45_boot)
HXDLIN(  45)		imageCallbacks =  ::cpp::Int64Map_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_ca15ff0e900ea23d_46_boot)
HXDLIN(  46)		soundCallbacks =  ::cpp::Int64Map_obj::__alloc( HX_CTX );
            	}
}
