...
HXLINE(  14)		this->_hx_set_data(HX_CTX, ::kha::arrays::_Float32Array::Float32Array_Impl__obj::_new(size));
...
static ::hx::StorageInfo Buffer_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::kha::arrays::ByteArrayPrivate */ ,(int)offsetof(Buffer_obj,data),HX_("data",2a,56,63,42)},
