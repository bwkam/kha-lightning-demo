...
HXDLIN(  80)		::Array< int > vec = ::Array_obj< int >::__new(segmentCount);
HXDLIN(  80)		{
HXLINE(  80)			int _g = 0;
...
HXLINE(  85)			int i1 = (segmentCount - 1);
HXLINE(  86)			while((i1 >= 0)){
HXLINE(  87)				if (::hx::IsLess( _hx_array_unsafe_get(this->segments,i1),255 )) {
...
HXDLIN( 103)				int _g3 = segmentCount;
HXDLIN( 103)				while((_g2 < _g3)){
HXLINE( 103)					_g2 = (_g2 + 1);
HXDLIN( 103)					int i3 = (_g2 - 1);
HXLINE( 104)					len = (len + _hx_array_unsafe_get(this->segments,i3));
            				}
            			}
...
HXLINE( 163)				this->page->start(::hx::ObjectPtr<OBJ_>(this));
            				...
            				if (_hx_e.IsClass<  ::kha::audio2::ogg::vorbis::data::ReaderError >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::kha::audio2::ogg::vorbis::data::ReaderError e1 = _hx_e;
HXLINE( 165)					this->lastSeg = true;
HXLINE( 166)					this->_hx_set_error(HX_CTX, e1);
HXLINE( 167)					return 0;
            				}
...
HXLINE( 162)					if (::Std_obj::isOfType(_g->value,::hx::ClassOf< ::kha::audio2::ogg::vorbis::data::ReaderError >())) {
HXLINE( 164)						 ::kha::audio2::ogg::vorbis::data::ReaderError e1 = ( ( ::kha::audio2::ogg::vorbis::data::ReaderError)(_g->value) );
HXLINE( 165)						this->lastSeg = true;
HXLINE( 166)						this->_hx_set_error(HX_CTX, e1);
HXLINE( 167)						return 0;
            					}
...
HXLINE( 171)				HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::CONTINUED_PACKET_FLAG_INVALID_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/VorbisDecodeState.hx",02,79,2e,1d),171,HX_("kha.audio2.ogg.vorbis.VorbisDecodeState",3c,6b,03,19),HX_("next",f3,84,02,49))));
            			}
            		}
...
HXLINE( 193)				HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::MISSING_CAPTURE_PATTERN_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/VorbisDecodeState.hx",02,79,2e,1d),193,HX_("kha.audio2.ogg.vorbis.VorbisDecodeState",3c,6b,03,19),HX_("startPacket",8a,b5,7e,5b))));
            			}
            		}
...
HXLINE( 206)					if (::Std_obj::isOfType(_g->value,::hx::ClassOf< ::haxe::io::Eof >())) {
HXLINE( 209)						eof = true;
HXLINE( 206)						x = 0;
            					}
            					else {
...
HXDLIN( 217)				_hx_tmp3->inputPosition = (_hx_tmp3->inputPosition + 1);
...
HXDLIN( 217)				_hx_tmp4->inputPosition = (_hx_tmp4->inputPosition + 1);
...
HXDLIN( 217)				_hx_tmp5->inputPosition = (_hx_tmp5->inputPosition + 1);
...
HXLINE( 218)				HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::MISSING_CAPTURE_PATTERN_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/VorbisDecodeState.hx",02,79,2e,1d),218,HX_("kha.audio2.ogg.vorbis.VorbisDecodeState",3c,6b,03,19),HX_("maybeStartPacket",c2,0a,ad,2a))));
            			}
...
HXLINE( 245)								_hx_tmp1 = (this->next() == 0);
            							}
            							else {
...
HXLINE( 251)							 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 251)							_hx_tmp2->validBits = (_hx_tmp2->validBits + 8);
            						}
...
HXLINE( 260)						 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp3 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 260)						_hx_tmp3->validBits = (_hx_tmp3->validBits - n);
HXLINE( 261)						return z;
            					}
            				}
            			}
            			else {
HXLINE( 265)				int z1 = (this->acc & ((1 << n) - 1));
HXLINE( 266)				this->acc = ::hx::UShr(this->acc,n);
HXLINE( 267)				 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp4 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 267)				_hx_tmp4->validBits = (_hx_tmp4->validBits - n);
HXLINE( 268)				return z1;
            			}
            		}
HXLINE( 233)		return 0;
            	}
...
HXLINE( 277)			 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 277)			_hx_tmp1->inputPosition = (_hx_tmp1->inputPosition + 1);
...
HXDLIN( 283)			 ::kha::audio2::ogg::vorbis::VorbisDecodeState x2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 283)			x2->inputPosition = (x2->inputPosition + 1);
...
HXDLIN( 298)					 ::kha::audio2::ogg::vorbis::VorbisDecodeState x2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 298)					x2->inputPosition = (x2->inputPosition + 1);
...
HXLINE( 298)					this->bytesInSeg--;
HXDLIN( 298)					 ::kha::audio2::ogg::vorbis::VorbisDecodeState x5 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 298)					x5->inputPosition = (x5->inputPosition + 1);
HXDLIN( 298)					x3 = this->input->readByte();
            				}
HXDLIN( 298)				this->validBits = 0;
HXDLIN( 298)				header->b[1] = ( (unsigned char)(x3) );
            			}
HXDLIN( 298)			{
HXLINE( 298)				int x6;
HXDLIN( 298)				bool x7;
...
HXLINE( 298)					this->bytesInSeg--;
HXDLIN( 298)					 ::kha::audio2::ogg::vorbis::VorbisDecodeState x8 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 298)					x8->inputPosition = (x8->inputPosition + 1);
HXDLIN( 298)					x6 = this->input->readByte();
            				}
HXDLIN( 298)				this->validBits = 0;
HXDLIN( 298)				header->b[2] = ( (unsigned char)(x6) );
            			}
HXDLIN( 298)			{
HXLINE( 298)				int x9;
HXDLIN( 298)				bool x10;
...
HXLINE( 298)					this->bytesInSeg--;
HXDLIN( 298)					 ::kha::audio2::ogg::vorbis::VorbisDecodeState x11 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 298)					x11->inputPosition = (x11->inputPosition + 1);
HXDLIN( 298)					x9 = this->input->readByte();
            				}
HXDLIN( 298)				this->validBits = 0;
HXDLIN( 298)				header->b[3] = ( (unsigned char)(x9) );
            			}
HXDLIN( 298)			{
HXLINE( 298)				int x12;
HXDLIN( 298)				bool x13;
...
HXLINE( 298)					this->bytesInSeg--;
HXDLIN( 298)					 ::kha::audio2::ogg::vorbis::VorbisDecodeState x14 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 298)					x14->inputPosition = (x14->inputPosition + 1);
HXDLIN( 298)					x12 = this->input->readByte();
            				}
HXDLIN( 298)				this->validBits = 0;
HXDLIN( 298)				header->b[4] = ( (unsigned char)(x12) );
            			}
HXDLIN( 298)			{
HXLINE( 298)				int x15;
HXDLIN( 298)				bool x16;
...
HXLINE( 298)					this->bytesInSeg--;
HXDLIN( 298)					 ::kha::audio2::ogg::vorbis::VorbisDecodeState x17 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 298)					x17->inputPosition = (x17->inputPosition + 1);
HXDLIN( 298)					x15 = this->input->readByte();
            				}
HXDLIN( 298)				this->validBits = 0;
HXDLIN( 298)				header->b[5] = ( (unsigned char)(x15) );
            			}
            		}
...
HXLINE( 308)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_FIRST_PAGE_dyn(),HX_("segmentCount",1c,1c,95,3d),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/VorbisDecodeState.hx",02,79,2e,1d),308,HX_("kha.audio2.ogg.vorbis.VorbisDecodeState",3c,6b,03,19),HX_("firstPageValidate",55,1a,ec,1c))));
            		}
HXLINE( 310)		if (::hx::IsNotEq( _hx_array_unsafe_get(this->segments,0),30 )) {
HXLINE( 311)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_FIRST_PAGE_dyn(),HX_("decodeState head",5d,8c,63,29),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/VorbisDecodeState.hx",02,79,2e,1d),311,HX_("kha.audio2.ogg.vorbis.VorbisDecodeState",3c,6b,03,19),HX_("firstPageValidate",55,1a,ec,1c))));
            		}
            	}
...
HXDLIN( 323)			 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp4 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 323)			_hx_tmp4->inputPosition = (_hx_tmp4->inputPosition + 1);
...
HXDLIN( 323)			 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp5 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 323)			_hx_tmp5->inputPosition = (_hx_tmp5->inputPosition + 1);
...
HXDLIN( 323)			 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp6 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 323)			_hx_tmp6->inputPosition = (_hx_tmp6->inputPosition + 1);
...
HXLINE( 324)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::MISSING_CAPTURE_PATTERN_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/VorbisDecodeState.hx",02,79,2e,1d),324,HX_("kha.audio2.ogg.vorbis.VorbisDecodeState",3c,6b,03,19),HX_("capturePattern",6a,1a,b8,20))));
            		}
            	}
...
HXDLIN( 330)		::Array< int > vec = ::Array_obj< int >::__new(len);
HXDLIN( 330)		{
HXDLIN( 330)			int _g = 0;
...
HXLINE( 345)					 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 345)					_hx_tmp1->validBits = (_hx_tmp1->validBits + 8);
            				}
...
HXLINE( 406)				 ::Dynamic fh = r->__Field(HX_("left",07,08,b0,47),::hx::paccDynamic);
HXDLIN( 406)				fh->__SetField(HX_("start",62,74,0b,84),(fh->__Field(HX_("start",62,74,0b,84),::hx::paccDynamic) + this->discardSamplesDeferred),::hx::paccDynamic);
...
HXLINE( 421)				_hx_tmp1 = ((this->page->flag & 4) != 0);
            			}
            			else {
...
HXLINE( 432)					 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 432)					_hx_tmp2->currentLoc = (_hx_tmp2->currentLoc + len);
...
HXLINE( 450)			 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp3 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 450)			_hx_tmp3->currentLoc = (_hx_tmp3->currentLoc + (( (int)( ::Dynamic(r->__Field(HX_("right",dc,0b,64,e9),::hx::paccDynamic))->__Field(HX_("start",62,74,0b,84),::hx::paccDynamic)) ) - ( (int)( ::Dynamic(r->__Field(HX_("left",07,08,b0,47),::hx::paccDynamic))->__Field(HX_("start",62,74,0b,84),::hx::paccDynamic)) )));
            		}
...
HXLINE( 477)		::Array< int > vec = ::Array_obj< int >::__new(n);
HXLINE( 478)		{
HXLINE( 478)			int _g = 0;
...
HXDLIN( 502)			bool aNeg1 = (a < 0);
HXDLIN( 502)			bool bNeg1 = (b < 0);
HXDLIN( 502)			if ((aNeg1 != bNeg1)) {
HXLINE( 502)				previousSafe1 = aNeg1;
            			}
            			else {
...
HXDLIN( 514)			switch((int)(_g->_hx_getIndex())){
            				case (int)0: {
HXLINE( 515)					int e = _g->_hx_getInt(0);
HXDLIN( 515)					bool l = _g->_hx_getBool(1);
HXDLIN( 515)					{
HXLINE( 516)						end = e;
HXLINE( 517)						last = l;
            					}
            				...
            				break;
            				case (int)1: {
HXLINE( 519)					HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::CANT_FIND_LAST_PAGE_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/VorbisDecodeState.hx",02,79,2e,1d),519,HX_("kha.audio2.ogg.vorbis.VorbisDecodeState",3c,6b,03,19),HX_("getSampleNumber",49,2c,d1,08))));
            				}
            				break;
            			}
            		}
...
HXLINE( 530)			{
HXLINE( 530)				 ::kha::audio2::ogg::vorbis::_VorbisDecodeState::FindPageResult _g1 = this->findPage(seekFunc,inputLength);
HXDLIN( 530)				switch((int)(_g1->_hx_getIndex())){
            					case (int)0: {
HXLINE( 531)						int e1 = _g1->_hx_getInt(0);
HXDLIN( 531)						bool l1 = _g1->_hx_getBool(1);
HXDLIN( 531)						{
HXLINE( 532)							end = e1;
HXLINE( 533)							last = l1;
            						}
...
HXDLIN( 547)		::Array< int > vec = ::Array_obj< int >::__new(6);
HXDLIN( 547)		{
HXLINE( 547)			int _g2 = 0;
HXDLIN( 547)			int _g3 = 6;
HXDLIN( 547)			while((_g2 < _g3)){
HXLINE( 547)				_g2 = (_g2 + 1);
HXDLIN( 547)				int i = (_g2 - 1);
HXDLIN( 547)				{
...
HXLINE( 553)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::CANT_FIND_LAST_PAGE_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/VorbisDecodeState.hx",02,79,2e,1d),553,HX_("kha.audio2.ogg.vorbis.VorbisDecodeState",3c,6b,03,19),HX_("getSampleNumber",49,2c,d1,08))));
            		}
...
HXDLIN( 588)					 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp3 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 588)					_hx_tmp3->inputPosition = (_hx_tmp3->inputPosition + 1);
HXDLIN( 588)					if ((this->input->readByte() == 103)) {
HXLINE( 588)						 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp4 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 588)						_hx_tmp4->inputPosition = (_hx_tmp4->inputPosition + 1);
HXDLIN( 588)						_hx_tmp2 = (this->input->readByte() != 103);
            					}
            					else {
HXLINE( 588)						_hx_tmp2 = true;
            					}
HXDLIN( 588)					if (!(_hx_tmp2)) {
HXLINE( 588)						 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp5 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 588)						_hx_tmp5->inputPosition = (_hx_tmp5->inputPosition + 1);
HXDLIN( 588)						_hx_tmp1 = (this->input->readByte() != 83);
            					}
            					else {
...
HXLINE( 592)					::Array< int > header = ::Array_obj< int >::__new(27);
...
HXDLIN( 598)						{
HXLINE( 598)							 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp26 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 598)							_hx_tmp26->inputPosition = (_hx_tmp26->inputPosition + 1);
HXDLIN( 598)							int val20 = this->input->readByte();
HXDLIN( 598)							header->__unsafe_set(24,val20);
            						}
HXDLIN( 598)						{
HXLINE( 598)							 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp27 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 598)							_hx_tmp27->inputPosition = (_hx_tmp27->inputPosition + 1);
HXDLIN( 598)							int val21 = this->input->readByte();
HXDLIN( 598)							header->__unsafe_set(25,val21);
            						}
HXDLIN( 598)						{
HXLINE( 598)							 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp28 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 598)							_hx_tmp28->inputPosition = (_hx_tmp28->inputPosition + 1);
...
HXDLIN( 618)							int _g2 = ( (int)(_hx_array_unsafe_get(header,26)) );
HXDLIN( 618)							while((_g1 < _g2)){
HXLINE( 618)								_g1 = (_g1 + 1);
HXDLIN( 618)								int i1 = (_g1 - 1);
HXLINE( 619)								 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp29 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 619)								_hx_tmp29->inputPosition = (_hx_tmp29->inputPosition + 1);
...
HXLINE( 623)						{
HXLINE( 623)							int _g3 = 0;
HXDLIN( 623)							int _g4 = len;
HXDLIN( 623)							while((_g3 < _g4)){
HXLINE( 623)								_g3 = (_g3 + 1);
HXDLIN( 623)								int i2 = (_g3 - 1);
...
HXDLIN( 624)								int byte1 = this->input->readByte();
HXDLIN( 624)								crc = ((crc << 8) ^ ( (int)(_hx_array_unsafe_get(::kha::audio2::ogg::tools::Crc32_obj::table,(byte1 ^ ::hx::UShr(crc,24)))) ));
            							}
            						}
            					} catch( ::Dynamic _hx_e) {
            						if (_hx_e.IsClass<  ::haxe::io::Eof >() ){
...
HXLINE( 617)							if (::Std_obj::isOfType(_g5->value,::hx::ClassOf< ::haxe::io::Eof >())) {
HXLINE( 627)								return ::kha::audio2::ogg::vorbis::_VorbisDecodeState::FindPageResult_obj::NotFound_dyn();
            							}
            							else {
HXLINE( 617)								HX_STACK_DO_THROW(_g5);
            							}
            						}
            						else {
            							HX_STACK_DO_THROW(_hx_e);
...
HXLINE( 578)				if (::Std_obj::isOfType(_g6->value,::hx::ClassOf< ::haxe::io::Eof >())) {
HXLINE( 647)					return ::kha::audio2::ogg::vorbis::_VorbisDecodeState::FindPageResult_obj::NotFound_dyn();
            				}
            				else {
HXDLIN( 578)					HX_STACK_DO_THROW(_g6);
            				}
            			}
            			else {
            				HX_STACK_DO_THROW(_hx_e);
...
HXLINE( 654)		::Array< bool > packetType = ::Array_obj< bool >::__new(255);
...
HXDLIN( 660)		::Array< int > vec = ::Array_obj< int >::__new(27);
HXDLIN( 660)		{
HXLINE( 660)			int _g = 0;
...
HXDLIN( 662)		::Array< int > vec1 = ::Array_obj< int >::__new(n);
HXDLIN( 662)		{
HXLINE( 662)			int _g2 = 0;
HXDLIN( 662)			int _g3 = n;
HXDLIN( 662)			while((_g2 < _g3)){
HXLINE( 662)				_g2 = (_g2 + 1);
HXDLIN( 662)				int i1 = (_g2 - 1);
HXDLIN( 662)				{
HXLINE( 662)					int val1 = this->input->readByte();
HXDLIN( 662)					vec1->__unsafe_set(i1,val1);
            				}
            			}
            		}
...
HXDLIN( 666)				int i2 = (_g4 - 1);
HXLINE( 667)				len = (len + ( (int)(_hx_array_unsafe_get(lacing,i2)) ));
            			}
            		}
...
HXDLIN( 693)				int i3 = (_g6 - 1);
HXLINE( 694)				if (packetStart) {
HXLINE( 695)					if ((( (int)(_hx_array_unsafe_get(lacing,i3)) ) == 0)) {
HXLINE( 697)						seekFunc((this->inputPosition = z->pageStart));
HXLINE( 698)						return null();
            					}
HXLINE( 700)					 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp6 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 700)					_hx_tmp6->inputPosition = (_hx_tmp6->inputPosition + 1);
HXDLIN( 700)					int n1 = this->input->readByte();
HXLINE( 703)					if (((n1 & 1) != 0)) {
HXLINE( 704)						seekFunc((this->inputPosition = z->pageStart));
HXLINE( 705)						return null();
            					}
HXLINE( 707)					n1 = (n1 >> 1);
HXLINE( 708)					int n2 = (modeCount - 1);
HXDLIN( 708)					::Array< int > log2_4 = ::Array_obj< int >::fromData( _hx_array_data_19036b3c_52,16);
HXDLIN( 708)					int b3;
HXDLIN( 708)					if ((n2 < 16384)) {
HXLINE( 708)						if ((n2 < 16)) {
HXLINE( 708)							b3 = log2_4->__get(n2);
            						}
            						else {
HXLINE( 708)							if ((n2 < 512)) {
HXLINE( 708)								b3 = (5 + log2_4->__get((n2 >> 5)));
            							}
            							else {
HXLINE( 708)								b3 = (10 + log2_4->__get((n2 >> 10)));
            							}
            						}
            					}
            					else {
HXLINE( 708)						if ((n2 < 16777216)) {
HXLINE( 708)							if ((n2 < 524288)) {
HXLINE( 708)								b3 = (15 + log2_4->__get((n2 >> 15)));
            							}
            							else {
HXLINE( 708)								b3 = (20 + log2_4->__get((n2 >> 20)));
            							}
            						}
            						else {
HXLINE( 708)							if ((n2 < 536870912)) {
HXLINE( 708)								b3 = (25 + log2_4->__get((n2 >> 25)));
            							}
            							else {
HXLINE( 708)								if ((n2 < (int)-2147483648)) {
HXLINE( 708)									b3 = (30 + log2_4->__get((n2 >> 30)));
            								}
            								else {
HXLINE( 708)									b3 = 0;
            								}
...
HXLINE( 709)					n1 = (n1 & ((1 << b3) - 1));
HXLINE( 710)					if ((n1 >= modeCount)) {
HXLINE( 711)						seekFunc((this->inputPosition = z->pageStart));
HXLINE( 712)						return null();
            					}
HXLINE( 714)					{
HXLINE( 714)						numPacket = (numPacket + 1);
HXDLIN( 714)						bool val2 = ( ( ::kha::audio2::ogg::vorbis::data::Mode)(_hx_array_unsafe_get(h->modes,n1)) )->blockflag;
HXDLIN( 714)						packetType->__unsafe_set((numPacket - 1),val2);
            					}
HXLINE( 715)					{
HXLINE( 715)						int len1 = (( (int)(_hx_array_unsafe_get(lacing,i3)) ) - 1);
HXDLIN( 715)						{
HXLINE( 715)							 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp7 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 715)							_hx_tmp7->inputPosition = (_hx_tmp7->inputPosition + len1);
HXDLIN( 715)							::Array< int > vec2 = ::Array_obj< int >::__new(len1);
HXDLIN( 715)							{
HXLINE( 715)								int _g8 = 0;
HXDLIN( 715)								int _g9 = len1;
HXDLIN( 715)								while((_g8 < _g9)){
HXLINE( 715)									_g8 = (_g8 + 1);
HXDLIN( 715)									int i4 = (_g8 - 1);
HXDLIN( 715)									{
HXLINE( 715)										int val3 = this->input->readByte();
HXDLIN( 715)										vec2->__unsafe_set(i4,val3);
            									}
            								}
            							}
            						}
...
HXLINE( 717)					int len2 = ( (int)(_hx_array_unsafe_get(lacing,i3)) );
HXDLIN( 717)					{
HXLINE( 717)						 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp8 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 717)						_hx_tmp8->inputPosition = (_hx_tmp8->inputPosition + len2);
HXDLIN( 717)						::Array< int > vec3 = ::Array_obj< int >::__new(len2);
HXDLIN( 717)						{
HXLINE( 717)							int _g10 = 0;
HXDLIN( 717)							int _g11 = len2;
HXDLIN( 717)							while((_g10 < _g11)){
HXLINE( 717)								_g10 = (_g10 + 1);
HXDLIN( 717)								int i5 = (_g10 - 1);
HXDLIN( 717)								{
HXLINE( 717)									int val4 = this->input->readByte();
HXDLIN( 717)									vec3->__unsafe_set(i5,val4);
            								}
            							}
            						}
            					}
            				}
HXLINE( 719)				packetStart = (( (int)(_hx_array_unsafe_get(lacing,i3)) ) < 255);
            			}
            		}
...
HXLINE( 736)		int i6 = (numPacket - 2);
HXLINE( 737)		while((i6 >= 1)){
HXLINE( 738)			i6 = (i6 - 1);
HXLINE( 741)			if (( (bool)(_hx_array_unsafe_get(packetType,i6)) )) {
HXLINE( 742)				if (( (bool)(_hx_array_unsafe_get(packetType,(i6 + 1))) )) {
...
HXLINE( 804)					_hx_tmp1 = aNeg;
            				}
            				else {
HXLINE( 804)					_hx_tmp1 = (code >= a);
            				}
...
HXLINE( 821)				 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 821)				_hx_tmp2->validBits = (_hx_tmp2->validBits - len);
HXLINE( 822)				return x;
            			}
...
HXLINE( 836)				int a1 = ( (int)(_hx_array_unsafe_get(codewords,i)) );
HXDLIN( 836)				if ((a1 == (this->acc & ((1 << cl) - 1)))) {
HXLINE( 837)					if ((this->validBits >= cl)) {
HXLINE( 838)						this->acc = ::hx::UShr(this->acc,cl);
HXLINE( 839)						 ::kha::audio2::ogg::vorbis::VorbisDecodeState _hx_tmp3 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 839)						_hx_tmp3->validBits = (_hx_tmp3->validBits - cl);
HXLINE( 840)						return i;
            					}
