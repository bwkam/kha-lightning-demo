...
HXLINE( 112)					{
HXLINE( 112)						int _g4 = j1;
HXDLIN( 112)						::Array< Float > _g5 = target;
HXDLIN( 112)						{
HXLINE( 112)							Float val = ( (Float)(_hx_array_unsafe_get(_g5,_g4)) );
HXDLIN( 112)							_g5->__unsafe_set(_g4,(val * ::kha::audio2::ogg::vorbis::VorbisTools_obj::INVERSE_DB_TABLE->__get(ly)));
            						}
            					}
            				}
            			}
...
HXLINE(  25)		m->_hx_set_chan(HX_CTX, ::Array_obj< ::Dynamic>::__new(channels));
HXLINE(  26)		{
HXLINE(  26)			int _g = 0;
...
HXLINE(  64)			int _g4 = 0;
HXDLIN(  64)			int _g5 = channels;
HXDLIN(  64)			while((_g4 < _g5)){
HXLINE(  64)				_g4 = (_g4 + 1);
HXDLIN(  64)				int j1 = (_g4 - 1);
...
HXLINE(  71)			int _g6 = 0;
HXDLIN(  71)			int _g7 = channels;
HXDLIN(  71)			while((_g6 < _g7)){
HXLINE(  71)				_g6 = (_g6 + 1);
HXDLIN(  71)				int j2 = (_g6 - 1);
HXLINE(  72)				( ( ::kha::audio2::ogg::vorbis::data::MappingChannel)(_hx_array_unsafe_get(m->chan,j2)) )->mux = 0;
            			}
            		}
HXLINE(  76)		m->_hx_set_submapFloor(HX_CTX, ::Array_obj< int >::__new(m->submaps));
HXLINE(  77)		m->_hx_set_submapResidue(HX_CTX, ::Array_obj< int >::__new(m->submaps));
HXLINE(  79)		{
HXLINE(  79)			int _g8 = 0;
HXDLIN(  79)			int _g9 = m->submaps;
HXDLIN(  79)			while((_g8 < _g9)){
HXLINE(  79)				_g8 = (_g8 + 1);
HXDLIN(  79)				int j3 = (_g8 - 1);
HXLINE(  80)				decodeState->readBits(8);
HXLINE(  81)				{
HXLINE(  81)					::Array< int > this2 = m->submapFloor;
HXDLIN(  81)					int val1 = decodeState->readBits(8);
HXDLIN(  81)					this2->__unsafe_set(j3,val1);
            				}
HXLINE(  82)				{
HXLINE(  82)					::Array< int > this3 = m->submapResidue;
HXDLIN(  82)					int val2 = decodeState->readBits(8);
HXDLIN(  82)					this3->__unsafe_set(j3,val2);
            				}
            			}
            		}
HXLINE(  85)		return m;
