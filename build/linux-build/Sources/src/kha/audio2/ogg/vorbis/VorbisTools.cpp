...
HXLINE( 208)			::kha::audio2::ogg::vorbis::VorbisTools_obj::integerDivideTable = ::Array_obj< ::Dynamic>::__new(32);
HXLINE( 209)			{
HXLINE( 209)				int _g = 0;
...
HXDLIN( 245)			::Array< Float > _g3 = output;
HXDLIN( 245)			{
HXLINE( 245)				Float val1 = ( (Float)(_hx_array_unsafe_get(_g3,_g2)) );
HXDLIN( 245)				_g3->__unsafe_set(_g2,(val1 * ::kha::audio2::ogg::vorbis::VorbisTools_obj::INVERSE_DB_TABLE->__get(y)));
            			}
            		}
HXLINE( 247)		{
HXLINE( 247)			int _g4 = (x + 1);
HXDLIN( 247)			int _g5 = x1;
HXDLIN( 247)			while((_g4 < _g5)){
HXLINE( 247)				_g4 = (_g4 + 1);
HXDLIN( 247)				int i1 = (_g4 - 1);
...
HXLINE( 255)				{
HXLINE( 255)					int _g6 = i1;
HXDLIN( 255)					::Array< Float > _g7 = output;
HXDLIN( 255)					{
HXLINE( 255)						Float val2 = ( (Float)(_hx_array_unsafe_get(_g7,_g6)) );
HXDLIN( 255)						_g7->__unsafe_set(_g6,(val2 * ::kha::audio2::ogg::vorbis::VorbisTools_obj::INVERSE_DB_TABLE->__get(y)));
            					}
            				}
            			}
            		}
...
HXLINE( 275)		::Array< Float > vec = ::Array_obj< Float >::__new(len);
...
HXLINE( 285)		::Array< Float > dest = ::Array_obj< Float >::__new(source->length);
HXLINE( 286)		{
HXLINE( 286)			int _g = 0;
