...
HXLINE( 215)		::Array< int > available = ::Array_obj< int >::__new(32);
HXLINE( 216)		{
...
HXDLIN( 293)						_hx_tmp1[(k - 1)] = (::hx::UShr(n,16) | (n << 16));
            					}
            				}
            			}
            		}
...
HXDLIN( 298)			int _g3 = this->sortedEntries;
HXDLIN( 298)			while((_g2 < _g3)){
HXLINE( 298)				_g2 = (_g2 + 1);
HXDLIN( 298)				int i1 = (_g2 - 1);
HXLINE( 299)				::Array< int > _hx_tmp2 = this->sortedCodewords;
HXDLIN( 299)				int n1 = ( (int)(_hx_array_unsafe_get(this->codewords,i1)) );
HXDLIN( 299)				n1 = (::hx::UShr((n1 & (int)-1431655766),1) | ((n1 & (int)1431655765) << 1));
HXDLIN( 299)				n1 = (::hx::UShr((n1 & -858993460),2) | ((n1 & 858993459) << 2));
HXDLIN( 299)				n1 = (::hx::UShr((n1 & -252645136),4) | ((n1 & 252645135) << 4));
HXDLIN( 299)				n1 = (::hx::UShr((n1 & -16711936),8) | ((n1 & 16711935) << 8));
HXDLIN( 299)				_hx_tmp2[i1] = (::hx::UShr(n1,16) | (n1 << 16));
            			}
            		}
...
HXLINE( 312)		{
HXLINE( 312)			int _g4 = 0;
HXDLIN( 312)			int _g5 = len1;
HXDLIN( 312)			while((_g4 < _g5)){
HXLINE( 312)				_g4 = (_g4 + 1);
HXDLIN( 312)				int i2 = (_g4 - 1);
...
HXDLIN( 315)					n2 = (::hx::UShr((n2 & (int)-1431655766),1) | ((n2 & (int)1431655765) << 1));
HXDLIN( 315)					n2 = (::hx::UShr((n2 & -858993460),2) | ((n2 & 858993459) << 2));
HXDLIN( 315)					n2 = (::hx::UShr((n2 & -252645136),4) | ((n2 & 252645135) << 4));
HXDLIN( 315)					n2 = (::hx::UShr((n2 & -16711936),8) | ((n2 & 16711935) << 8));
HXDLIN( 315)					int code = (::hx::UShr(n2,16) | (n2 << 16));
HXLINE( 316)					int x = 0;
HXLINE( 317)					int n3 = this->sortedEntries;
HXLINE( 318)					while((n3 > 1)){
HXLINE( 320)						int m = (x + (n3 >> 1));
...
HXLINE( 342)		this->_hx_set_fastHuffman(HX_CTX, ::Array_obj< int >::__new(1024));
...
HXDLIN( 353)				int i1 = (_g2 - 1);
HXLINE( 354)				if (::hx::IsLessEq( _hx_array_unsafe_get(this->codewordLengths,i1),10 )) {
HXLINE( 355)					int z;
...
HXLINE( 359)						z = (z + (1 << ( (int)(_hx_array_unsafe_get(this->codewordLengths,i1)) )));
            					}
            				}
            			}
            		}
...
HXDLIN( 400)				int _g5 = len;
HXDLIN( 400)				while((_g4 < _g5)){
HXLINE( 400)					_g4 = (_g4 + 1);
HXDLIN( 400)					int i2 = (_g4 - 1);
HXLINE( 401)					Float val3 = (( (Float)(_hx_array_unsafe_get(multiplicands,(z + i2))) ) + last1);
HXLINE( 402)					{
HXLINE( 402)						int _g6 = (offset + i2);
HXDLIN( 402)						::Array< Float > _g7 = output;
HXDLIN( 402)						{
HXLINE( 402)							Float val4 = (( (Float)(_hx_array_unsafe_get(_g7,_g6)) ) + val3);
HXDLIN( 402)							_g7->__unsafe_set(_g6,val4);
            						}
            					}
...
HXDLIN( 407)				int _g9 = len;
HXDLIN( 407)				while((_g8 < _g9)){
HXLINE( 407)					_g8 = (_g8 + 1);
HXDLIN( 407)					int i3 = (_g8 - 1);
HXLINE( 408)					{
HXLINE( 408)						int _g10 = (offset + i3);
HXDLIN( 408)						::Array< Float > _g11 = output;
HXDLIN( 408)						{
HXLINE( 408)							Float val5 = ( (Float)(_hx_array_unsafe_get(_g11,_g10)) );
HXDLIN( 408)							Float val6 = (val5 + (( (Float)(_hx_array_unsafe_get(multiplicands,(z + i3))) ) + last2));
HXDLIN( 408)							_g11->__unsafe_set(_g10,val6);
            						}
            					}
            				}
            			}
...
HXDLIN( 446)			int _g5 = len;
HXDLIN( 446)			while((_g4 < _g5)){
HXLINE( 446)				_g4 = (_g4 + 1);
HXDLIN( 446)				int i2 = (_g4 - 1);
HXLINE( 447)				Float val3 = (( (Float)(_hx_array_unsafe_get(multiplicands,(z + i2))) ) + last);
HXLINE( 448)				{
HXLINE( 448)					int _g6 = (offset + (i2 * step));
HXDLIN( 448)					::Array< Float > _g7 = output;
HXDLIN( 448)					{
HXLINE( 448)						Float val4 = (( (Float)(_hx_array_unsafe_get(_g7,_g6)) ) + val3);
HXDLIN( 448)						_g7->__unsafe_set(_g6,val4);
            					}
            				}
...
HXLINE( 488)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_STREAM_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Codebook.hx",77,0d,3d,a0),488,HX_("kha.audio2.ogg.vorbis.data.Codebook",a6,42,7b,ee),HX_("decodeDeinterleaveRepeat",65,00,32,3c))));
            		}
...
HXLINE( 503)				HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_STREAM_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Codebook.hx",77,0d,3d,a0),503,HX_("kha.audio2.ogg.vorbis.data.Codebook",a6,42,7b,ee),HX_("decodeDeinterleaveRepeat",65,00,32,3c))));
            			}
...
HXLINE( 532)						{
HXLINE( 532)							int _g6 = pInter;
HXDLIN( 532)							::Array< Float > _g7 = ( (::Array< Float >)(_hx_array_unsafe_get(residueBuffers,cInter)) );
HXDLIN( 532)							{
HXLINE( 532)								Float val4 = (( (Float)(_hx_array_unsafe_get(_g7,_g6)) ) + val3);
HXDLIN( 532)								_g7->__unsafe_set(_g6,val4);
            							}
            						}
...
HXLINE( 543)					int _g8 = 0;
HXDLIN( 543)					int _g9 = effective;
HXDLIN( 543)					while((_g8 < _g9)){
HXLINE( 543)						_g8 = (_g8 + 1);
HXDLIN( 543)						int i3 = (_g8 - 1);
HXLINE( 544)						Float val5 = (( (Float)(_hx_array_unsafe_get(multiplicands,(z + i3))) ) + last);
HXLINE( 545)						{
HXLINE( 545)							int _g10 = pInter;
HXDLIN( 545)							::Array< Float > _g11 = ( (::Array< Float >)(_hx_array_unsafe_get(residueBuffers,cInter)) );
HXDLIN( 545)							{
HXLINE( 545)								Float val6 = (( (Float)(_hx_array_unsafe_get(_g11,_g10)) ) + val5);
HXDLIN( 545)								_g11->__unsafe_set(_g10,val6);
            							}
            						}
...
HXLINE( 553)					int _g12 = 0;
HXDLIN( 553)					int _g13 = effective;
HXDLIN( 553)					while((_g12 < _g13)){
HXLINE( 553)						_g12 = (_g12 + 1);
HXDLIN( 553)						int i4 = (_g12 - 1);
HXLINE( 554)						Float val7 = (( (Float)(_hx_array_unsafe_get(multiplicands,(z + i4))) ) + last);
HXLINE( 555)						{
HXLINE( 555)							int _g14 = pInter;
HXDLIN( 555)							::Array< Float > _g15 = ( (::Array< Float >)(_hx_array_unsafe_get(residueBuffers,cInter)) );
HXDLIN( 555)							{
HXLINE( 555)								Float val8 = (( (Float)(_hx_array_unsafe_get(_g15,_g14)) ) + val7);
HXDLIN( 555)								_g15->__unsafe_set(_g14,val8);
            							}
            						}
...
HXLINE(  40)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_SETUP_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Codebook.hx",77,0d,3d,a0),40,HX_("kha.audio2.ogg.vorbis.data.Codebook",a6,42,7b,ee),HX_("read",56,4b,a7,4b))));
            		}
...
HXLINE(  52)		::Array< int > lengths = ::Array_obj< int >::__new(c->entries);
...
HXLINE(  76)			int _g2 = 0;
HXDLIN(  76)			int _g3 = c->entries;
HXDLIN(  76)			while((_g2 < _g3)){
HXLINE(  76)				_g2 = (_g2 + 1);
HXDLIN(  76)				int j = (_g2 - 1);
...
HXLINE( 108)			c->_hx_set_codewords(HX_CTX, ::Array_obj< int >::__new(c->entries));
            		}
            		else {
HXLINE( 110)			if ((c->sortedEntries != 0)) {
HXLINE( 111)				c->_hx_set_codewordLengths(HX_CTX, ::Array_obj< int >::__new(c->sortedEntries));
HXLINE( 112)				c->_hx_set_codewords(HX_CTX, ::Array_obj< int >::__new(c->entries));
...
HXLINE( 129)			c->_hx_set_sortedValues(HX_CTX, ::Array_obj< int >::__new(c->sortedEntries));
...
HXLINE( 147)			int x2 = decodeState->readBits(32);
HXDLIN( 147)			Float mantissa;
HXDLIN( 147)			int _hx_int = (x2 & 2097151);
...
HXDLIN( 147)			int sign = (x2 & (int)-2147483648);
HXDLIN( 147)			int exp = ::hx::UShr((x2 & (int)2145386496),21);
...
HXLINE( 148)			int x3 = decodeState->readBits(32);
HXDLIN( 148)			Float mantissa1;
HXDLIN( 148)			int int1 = (x3 & 2097151);
...
HXDLIN( 148)			int sign1 = (x3 & (int)-2147483648);
HXDLIN( 148)			int exp1 = ::hx::UShr((x3 & (int)2145386496),21);
...
HXLINE( 157)			::Array< int > mults = ::Array_obj< int >::__new(c->lookupValues);
HXLINE( 158)			{
HXLINE( 158)				int _g6 = 0;
HXDLIN( 158)				int _g7 = c->lookupValues;
HXDLIN( 158)				while((_g6 < _g7)){
HXLINE( 158)					_g6 = (_g6 + 1);
HXDLIN( 158)					int j2 = (_g6 - 1);
...
HXLINE( 166)			{
HXLINE( 167)				c->_hx_set_multiplicands(HX_CTX, ::Array_obj< Float >::__new(c->lookupValues));
HXLINE( 170)				{
HXLINE( 170)					int _g8 = 0;
HXDLIN( 170)					int _g9 = c->lookupValues;
HXDLIN( 170)					while((_g8 < _g9)){
HXLINE( 170)						_g8 = (_g8 + 1);
HXDLIN( 170)						int j3 = (_g8 - 1);
HXLINE( 171)						{
HXLINE( 171)							::Array< Float > this1 = c->multiplicands;
HXDLIN( 171)							Float val1 = (( (Float)(( (int)(_hx_array_unsafe_get(mults,j3)) )) ) * c->deltaValue);
HXDLIN( 171)							this1->__unsafe_set(j3,(val1 + c->minimumValue));
            						}
            					}
            				}
            			}
...
HXLINE( 176)				_hx_tmp6 = c->sequenceP;
            			}
            			else {
...
HXLINE( 177)				{
HXLINE( 177)					int _g10 = 1;
HXDLIN( 177)					int _g11 = c->lookupValues;
HXDLIN( 177)					while((_g10 < _g11)){
HXLINE( 177)						_g10 = (_g10 + 1);
HXDLIN( 177)						int j4 = (_g10 - 1);
HXLINE( 178)						{
HXLINE( 178)							::Array< Float > this2 = c->multiplicands;
HXDLIN( 178)							Float val2 = ( (Float)(_hx_array_unsafe_get(c->multiplicands,(j4 - 1))) );
HXDLIN( 178)							this2->__unsafe_set(j4,val2);
            						}
            					}
            				}
