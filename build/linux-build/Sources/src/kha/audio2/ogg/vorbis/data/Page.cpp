...
HXDLIN(  26)			decodeState2->inputPosition = (decodeState2->inputPosition + 1);
...
HXDLIN(  26)			decodeState3->inputPosition = (decodeState3->inputPosition + 1);
...
HXDLIN(  26)			decodeState4->inputPosition = (decodeState4->inputPosition + 1);
...
HXLINE(  26)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::MISSING_CAPTURE_PATTERN_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/VorbisDecodeState.hx",02,79,2e,1d),324,HX_("kha.audio2.ogg.vorbis.VorbisDecodeState",3c,6b,03,19),HX_("capturePattern",6a,1a,b8,20))));
            		}
...
HXLINE(  34)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_STREAM_STRUCTURE_VERSION_dyn(),(HX_("",00,00,00,00) + version),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Page.hx",1e,c1,32,2c),34,HX_("kha.audio2.ogg.vorbis.data.Page",1f,a5,b2,c9),HX_("startWithoutCapturePattern",10,03,9b,8e))));
            		}
