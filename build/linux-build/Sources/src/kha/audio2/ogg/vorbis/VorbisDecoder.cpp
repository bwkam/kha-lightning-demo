...
HXLINE(  53)		this->_hx_set_channelBuffers(HX_CTX, ::Array_obj< ::Dynamic>::__new(header->channel));
HXLINE(  54)		this->_hx_set_previousWindow(HX_CTX, ::Array_obj< ::Dynamic>::__new(header->channel));
HXLINE(  55)		this->_hx_set_finalY(HX_CTX, ::Array_obj< ::Dynamic>::__new(header->channel));
HXLINE(  57)		{
HXLINE(  57)			int _g = 0;
...
HXDLIN(  58)					::Array< Float > vec = ::Array_obj< Float >::__new(header->blocksize1);
HXDLIN(  58)					this1->__unsafe_set(i,vec);
            				}
HXLINE(  59)				{
HXLINE(  59)					::Array< ::Dynamic> this2 = this->previousWindow;
HXDLIN(  59)					::Array< Float > vec1 = ::Array_obj< Float >::__new(::Std_obj::_hx_int((( (Float)(header->blocksize1) ) / ( (Float)(2) ))));
HXDLIN(  59)					this2->__unsafe_set(i,vec1);
            				}
HXLINE(  60)				{
HXLINE(  60)					::Array< ::Dynamic> this3 = this->finalY;
HXDLIN(  60)					::Array< int > val = ::Array_obj< int >::__new();
HXDLIN(  60)					this3->__unsafe_set(i,val);
            				}
            			}
            		}
HXLINE(  63)		this->_hx_set_a(HX_CTX, ::Array_obj< ::Dynamic>::__new(2));
HXLINE(  64)		this->_hx_set_b(HX_CTX, ::Array_obj< ::Dynamic>::__new(2));
HXLINE(  65)		this->_hx_set_c(HX_CTX, ::Array_obj< ::Dynamic>::__new(2));
HXLINE(  66)		this->_hx_set_window(HX_CTX, ::Array_obj< ::Dynamic>::__new(2));
HXLINE(  67)		this->_hx_set_bitReverseData(HX_CTX, ::Array_obj< ::Dynamic>::__new(2));
...
int VorbisDecoder_obj::read( ::kha::arrays::ByteArrayPrivate output,int samples,int channels,int sampleRate,bool useFloat){
...
HXDLIN( 104)						int _g3 = sampleRepeat2;
HXDLIN( 104)						while((_g2 < _g3)){
HXLINE( 104)							_g2 = (_g2 + 1);
HXDLIN( 104)							int sr = (_g2 - 1);
HXLINE( 105)							{
HXLINE( 105)								int _g4 = 0;
HXDLIN( 105)								int _g5 = this->header->channel;
HXDLIN( 105)								while((_g4 < _g5)){
HXLINE( 105)									_g4 = (_g4 + 1);
HXDLIN( 105)									int i = (_g4 - 1);
HXLINE( 106)									{
HXLINE( 106)										int _g6 = 0;
HXDLIN( 106)										int _g7 = channelRepeat;
HXDLIN( 106)										while((_g6 < _g7)){
HXLINE( 106)											_g6 = (_g6 + 1);
HXDLIN( 106)											int cr = (_g6 - 1);
...
HXLINE( 116)												*((float *)&output->self.data[output->byteArrayOffset + (index * 4)]) = value;
...
HXLINE( 128)				goto _hx_goto_2;
            		...
            		_hx_goto_2:;
HXLINE( 132)		{
HXLINE( 132)			int _g8 = n;
HXDLIN( 132)			int _g9 = len;
HXDLIN( 132)			while((_g8 < _g9)){
HXLINE( 132)				_g8 = (_g8 + 1);
HXDLIN( 132)				int j1 = (_g8 - 1);
HXLINE( 133)				{
HXLINE( 133)					int _g10 = 0;
HXDLIN( 133)					int _g11 = sampleRepeat2;
HXDLIN( 133)					while((_g10 < _g11)){
HXLINE( 133)						_g10 = (_g10 + 1);
HXDLIN( 133)						int sr1 = (_g10 - 1);
HXLINE( 134)						{
HXLINE( 134)							int _g12 = 0;
HXDLIN( 134)							int _g13 = this->header->channel;
HXDLIN( 134)							while((_g12 < _g13)){
HXLINE( 134)								_g12 = (_g12 + 1);
HXDLIN( 134)								int i1 = (_g12 - 1);
HXLINE( 135)								{
HXLINE( 135)									int _g14 = 0;
HXDLIN( 135)									int _g15 = channelRepeat;
HXDLIN( 135)									while((_g14 < _g15)){
HXLINE( 135)										_g14 = (_g14 + 1);
HXDLIN( 135)										int cr1 = (_g14 - 1);
HXLINE( 136)										if (useFloat) {
HXLINE( 138)											*((float *)&output->self.data[output->byteArrayOffset + (index * 4)]) = 0;
...
HXDLIN( 247)					switch((int)(_g->_hx_getIndex())){
            						case (int)0: {
HXLINE( 250)							int _g1 = _g->_hx_getInt(0);
HXDLIN( 250)							bool _g2 = _g->_hx_getBool(1);
            						}
            						break;
            						case (int)1: {
...
HXLINE( 362)		decoder->_hx_set_channelBuffers(HX_CTX, ::Array_obj< ::Dynamic>::__new(this->header->channel));
HXLINE( 363)		decoder->_hx_set_previousWindow(HX_CTX, ::Array_obj< ::Dynamic>::__new(this->header->channel));
HXLINE( 364)		decoder->_hx_set_finalY(HX_CTX, ::Array_obj< ::Dynamic>::__new(this->header->channel));
HXLINE( 366)		{
HXLINE( 366)			int _g = 0;
...
HXDLIN( 435)			int _g5 = this->header->channel;
HXDLIN( 435)			while((_g4 < _g5)){
HXLINE( 435)				_g4 = (_g4 + 1);
HXDLIN( 435)				int i1 = (_g4 - 1);
...
HXLINE( 438)				{
HXLINE( 438)					int _g6 = 0;
HXDLIN( 438)					int _g7 = (len - right);
HXDLIN( 438)					while((_g6 < _g7)){
HXLINE( 438)						_g6 = (_g6 + 1);
HXDLIN( 438)						int j1 = (_g6 - 1);
HXLINE( 439)						{
...
HXDLIN( 487)			::Array< Float > buf2 = ::Array_obj< Float >::__new(n2);
HXDLIN( 487)			{
...
HXDLIN( 487)						{
HXLINE( 487)							Float val34 = ( (Float)(_hx_array_unsafe_get(_g3,_g2)) );
HXDLIN( 487)							Float val35 = (val34 + ( (Float)(_hx_array_unsafe_get(u,(eeOffset2 + -1))) ));
HXDLIN( 487)							_g3->__unsafe_set(_g2,val35);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)						{
HXLINE( 487)							Float val40 = ( (Float)(_hx_array_unsafe_get(_g5,_g4)) );
HXDLIN( 487)							Float val41 = (val40 + ( (Float)(_hx_array_unsafe_get(u,(eeOffset2 + -2))) ));
HXDLIN( 487)							_g5->__unsafe_set(_g4,val41);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)						{
HXLINE( 487)							Float val42 = ( (Float)(_hx_array_unsafe_get(_g7,_g6)) );
HXDLIN( 487)							Float val43 = (val42 + ( (Float)(_hx_array_unsafe_get(u,(eeOffset2 + -3))) ));
HXDLIN( 487)							_g7->__unsafe_set(_g6,val43);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)						{
HXLINE( 487)							Float val48 = ( (Float)(_hx_array_unsafe_get(_g9,_g8)) );
HXDLIN( 487)							Float val49 = (val48 + ( (Float)(_hx_array_unsafe_get(u,(eeOffset2 + -4))) ));
HXDLIN( 487)							_g9->__unsafe_set(_g8,val49);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)						{
HXLINE( 487)							Float val50 = ( (Float)(_hx_array_unsafe_get(_g11,_g10)) );
HXDLIN( 487)							Float val51 = (val50 + ( (Float)(_hx_array_unsafe_get(u,(eeOffset2 + -5))) ));
HXDLIN( 487)							_g11->__unsafe_set(_g10,val51);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)						{
HXLINE( 487)							Float val56 = ( (Float)(_hx_array_unsafe_get(_g13,_g12)) );
HXDLIN( 487)							Float val57 = (val56 + ( (Float)(_hx_array_unsafe_get(u,(eeOffset2 + -6))) ));
HXDLIN( 487)							_g13->__unsafe_set(_g12,val57);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)						{
HXLINE( 487)							Float val58 = ( (Float)(_hx_array_unsafe_get(_g15,_g14)) );
HXDLIN( 487)							Float val59 = (val58 + ( (Float)(_hx_array_unsafe_get(u,(eeOffset2 + -7))) ));
HXDLIN( 487)							_g15->__unsafe_set(_g14,val59);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g16 = eeOffset01;
HXDLIN( 487)						::Array< Float > _g17 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val64 = ( (Float)(_hx_array_unsafe_get(_g17,_g16)) );
HXDLIN( 487)							Float val65 = (val64 + ( (Float)(_hx_array_unsafe_get(u,eeOffset21)) ));
HXDLIN( 487)							_g17->__unsafe_set(_g16,val65);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g18 = (eeOffset01 + -1);
HXDLIN( 487)						::Array< Float > _g19 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val66 = ( (Float)(_hx_array_unsafe_get(_g19,_g18)) );
HXDLIN( 487)							Float val67 = (val66 + ( (Float)(_hx_array_unsafe_get(u,(eeOffset21 + -1))) ));
HXDLIN( 487)							_g19->__unsafe_set(_g18,val67);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)						::Array< Float > _g21 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val72 = ( (Float)(_hx_array_unsafe_get(_g21,_g20)) );
HXDLIN( 487)							Float val73 = (val72 + ( (Float)(_hx_array_unsafe_get(u,(eeOffset21 + -2))) ));
HXDLIN( 487)							_g21->__unsafe_set(_g20,val73);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g22 = (eeOffset01 + -3);
HXDLIN( 487)						::Array< Float > _g23 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val74 = ( (Float)(_hx_array_unsafe_get(_g23,_g22)) );
HXDLIN( 487)							Float val75 = (val74 + ( (Float)(_hx_array_unsafe_get(u,(eeOffset21 + -3))) ));
HXDLIN( 487)							_g23->__unsafe_set(_g22,val75);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g24 = (eeOffset01 + -4);
HXDLIN( 487)						::Array< Float > _g25 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val80 = ( (Float)(_hx_array_unsafe_get(_g25,_g24)) );
HXDLIN( 487)							Float val81 = (val80 + ( (Float)(_hx_array_unsafe_get(u,(eeOffset21 + -4))) ));
HXDLIN( 487)							_g25->__unsafe_set(_g24,val81);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g26 = (eeOffset01 + -5);
HXDLIN( 487)						::Array< Float > _g27 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val82 = ( (Float)(_hx_array_unsafe_get(_g27,_g26)) );
HXDLIN( 487)							Float val83 = (val82 + ( (Float)(_hx_array_unsafe_get(u,(eeOffset21 + -5))) ));
HXDLIN( 487)							_g27->__unsafe_set(_g26,val83);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g28 = (eeOffset01 + -6);
HXDLIN( 487)						::Array< Float > _g29 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val88 = ( (Float)(_hx_array_unsafe_get(_g29,_g28)) );
HXDLIN( 487)							Float val89 = (val88 + ( (Float)(_hx_array_unsafe_get(u,(eeOffset21 + -6))) ));
HXDLIN( 487)							_g29->__unsafe_set(_g28,val89);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g30 = (eeOffset01 + -7);
HXDLIN( 487)						::Array< Float > _g31 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val90 = ( (Float)(_hx_array_unsafe_get(_g31,_g30)) );
HXDLIN( 487)							Float val91 = (val90 + ( (Float)(_hx_array_unsafe_get(u,(eeOffset21 + -7))) ));
HXDLIN( 487)							_g31->__unsafe_set(_g30,val91);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g32 = eOffset01;
HXDLIN( 487)						::Array< Float > _g33 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val96 = ( (Float)(_hx_array_unsafe_get(_g33,_g32)) );
HXDLIN( 487)							Float val97 = (val96 + ( (Float)(_hx_array_unsafe_get(u,eOffset2)) ));
HXDLIN( 487)							_g33->__unsafe_set(_g32,val97);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g34 = (eOffset01 + -1);
HXDLIN( 487)						::Array< Float > _g35 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val98 = ( (Float)(_hx_array_unsafe_get(_g35,_g34)) );
HXDLIN( 487)							Float val99 = (val98 + ( (Float)(_hx_array_unsafe_get(u,(eOffset2 + -1))) ));
HXDLIN( 487)							_g35->__unsafe_set(_g34,val99);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g36 = (eOffset01 + -2);
HXDLIN( 487)						::Array< Float > _g37 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val104 = ( (Float)(_hx_array_unsafe_get(_g37,_g36)) );
HXDLIN( 487)							Float val105 = (val104 + ( (Float)(_hx_array_unsafe_get(u,(eOffset2 + -2))) ));
HXDLIN( 487)							_g37->__unsafe_set(_g36,val105);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g38 = (eOffset01 + -3);
HXDLIN( 487)						::Array< Float > _g39 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val106 = ( (Float)(_hx_array_unsafe_get(_g39,_g38)) );
HXDLIN( 487)							Float val107 = (val106 + ( (Float)(_hx_array_unsafe_get(u,(eOffset2 + -3))) ));
HXDLIN( 487)							_g39->__unsafe_set(_g38,val107);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g40 = (eOffset01 + -4);
HXDLIN( 487)						::Array< Float > _g41 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val112 = ( (Float)(_hx_array_unsafe_get(_g41,_g40)) );
HXDLIN( 487)							Float val113 = (val112 + ( (Float)(_hx_array_unsafe_get(u,(eOffset2 + -4))) ));
HXDLIN( 487)							_g41->__unsafe_set(_g40,val113);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g42 = (eOffset01 + -5);
HXDLIN( 487)						::Array< Float > _g43 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val114 = ( (Float)(_hx_array_unsafe_get(_g43,_g42)) );
HXDLIN( 487)							Float val115 = (val114 + ( (Float)(_hx_array_unsafe_get(u,(eOffset2 + -5))) ));
HXDLIN( 487)							_g43->__unsafe_set(_g42,val115);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g44 = (eOffset01 + -6);
HXDLIN( 487)						::Array< Float > _g45 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val120 = ( (Float)(_hx_array_unsafe_get(_g45,_g44)) );
HXDLIN( 487)							Float val121 = (val120 + ( (Float)(_hx_array_unsafe_get(u,(eOffset2 + -6))) ));
HXDLIN( 487)							_g45->__unsafe_set(_g44,val121);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g46 = (eOffset01 + -7);
HXDLIN( 487)						::Array< Float > _g47 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val122 = ( (Float)(_hx_array_unsafe_get(_g47,_g46)) );
HXDLIN( 487)							Float val123 = (val122 + ( (Float)(_hx_array_unsafe_get(u,(eOffset2 + -7))) ));
HXDLIN( 487)							_g47->__unsafe_set(_g46,val123);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g48 = eOffset02;
HXDLIN( 487)						::Array< Float > _g49 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val128 = ( (Float)(_hx_array_unsafe_get(_g49,_g48)) );
HXDLIN( 487)							Float val129 = (val128 + ( (Float)(_hx_array_unsafe_get(u,eOffset21)) ));
HXDLIN( 487)							_g49->__unsafe_set(_g48,val129);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g50 = (eOffset02 + -1);
HXDLIN( 487)						::Array< Float > _g51 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val130 = ( (Float)(_hx_array_unsafe_get(_g51,_g50)) );
HXDLIN( 487)							Float val131 = (val130 + ( (Float)(_hx_array_unsafe_get(u,(eOffset21 + -1))) ));
HXDLIN( 487)							_g51->__unsafe_set(_g50,val131);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g52 = (eOffset02 + -2);
HXDLIN( 487)						::Array< Float > _g53 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val136 = ( (Float)(_hx_array_unsafe_get(_g53,_g52)) );
HXDLIN( 487)							Float val137 = (val136 + ( (Float)(_hx_array_unsafe_get(u,(eOffset21 + -2))) ));
HXDLIN( 487)							_g53->__unsafe_set(_g52,val137);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g54 = (eOffset02 + -3);
HXDLIN( 487)						::Array< Float > _g55 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val138 = ( (Float)(_hx_array_unsafe_get(_g55,_g54)) );
HXDLIN( 487)							Float val139 = (val138 + ( (Float)(_hx_array_unsafe_get(u,(eOffset21 + -3))) ));
HXDLIN( 487)							_g55->__unsafe_set(_g54,val139);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g56 = (eOffset02 + -4);
HXDLIN( 487)						::Array< Float > _g57 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val144 = ( (Float)(_hx_array_unsafe_get(_g57,_g56)) );
HXDLIN( 487)							Float val145 = (val144 + ( (Float)(_hx_array_unsafe_get(u,(eOffset21 + -4))) ));
HXDLIN( 487)							_g57->__unsafe_set(_g56,val145);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g58 = (eOffset02 + -5);
HXDLIN( 487)						::Array< Float > _g59 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val146 = ( (Float)(_hx_array_unsafe_get(_g59,_g58)) );
HXDLIN( 487)							Float val147 = (val146 + ( (Float)(_hx_array_unsafe_get(u,(eOffset21 + -5))) ));
HXDLIN( 487)							_g59->__unsafe_set(_g58,val147);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g60 = (eOffset02 + -6);
HXDLIN( 487)						::Array< Float > _g61 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val152 = ( (Float)(_hx_array_unsafe_get(_g61,_g60)) );
HXDLIN( 487)							Float val153 = (val152 + ( (Float)(_hx_array_unsafe_get(u,(eOffset21 + -6))) ));
HXDLIN( 487)							_g61->__unsafe_set(_g60,val153);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g62 = (eOffset02 + -7);
HXDLIN( 487)						::Array< Float > _g63 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val154 = ( (Float)(_hx_array_unsafe_get(_g63,_g62)) );
HXDLIN( 487)							Float val155 = (val154 + ( (Float)(_hx_array_unsafe_get(u,(eOffset21 + -7))) ));
HXDLIN( 487)							_g63->__unsafe_set(_g62,val155);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g64 = eOffset03;
HXDLIN( 487)						::Array< Float > _g65 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val160 = ( (Float)(_hx_array_unsafe_get(_g65,_g64)) );
HXDLIN( 487)							Float val161 = (val160 + ( (Float)(_hx_array_unsafe_get(u,eOffset22)) ));
HXDLIN( 487)							_g65->__unsafe_set(_g64,val161);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g66 = (eOffset03 + -1);
HXDLIN( 487)						::Array< Float > _g67 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val162 = ( (Float)(_hx_array_unsafe_get(_g67,_g66)) );
HXDLIN( 487)							Float val163 = (val162 + ( (Float)(_hx_array_unsafe_get(u,(eOffset22 + -1))) ));
HXDLIN( 487)							_g67->__unsafe_set(_g66,val163);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g68 = (eOffset03 + -2);
HXDLIN( 487)						::Array< Float > _g69 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val168 = ( (Float)(_hx_array_unsafe_get(_g69,_g68)) );
HXDLIN( 487)							Float val169 = (val168 + ( (Float)(_hx_array_unsafe_get(u,(eOffset22 + -2))) ));
HXDLIN( 487)							_g69->__unsafe_set(_g68,val169);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g70 = (eOffset03 + -3);
HXDLIN( 487)						::Array< Float > _g71 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val170 = ( (Float)(_hx_array_unsafe_get(_g71,_g70)) );
HXDLIN( 487)							Float val171 = (val170 + ( (Float)(_hx_array_unsafe_get(u,(eOffset22 + -3))) ));
HXDLIN( 487)							_g71->__unsafe_set(_g70,val171);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g72 = (eOffset03 + -4);
HXDLIN( 487)						::Array< Float > _g73 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val176 = ( (Float)(_hx_array_unsafe_get(_g73,_g72)) );
HXDLIN( 487)							Float val177 = (val176 + ( (Float)(_hx_array_unsafe_get(u,(eOffset22 + -4))) ));
HXDLIN( 487)							_g73->__unsafe_set(_g72,val177);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g74 = (eOffset03 + -5);
HXDLIN( 487)						::Array< Float > _g75 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val178 = ( (Float)(_hx_array_unsafe_get(_g75,_g74)) );
HXDLIN( 487)							Float val179 = (val178 + ( (Float)(_hx_array_unsafe_get(u,(eOffset22 + -5))) ));
HXDLIN( 487)							_g75->__unsafe_set(_g74,val179);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g76 = (eOffset03 + -6);
HXDLIN( 487)						::Array< Float > _g77 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val184 = ( (Float)(_hx_array_unsafe_get(_g77,_g76)) );
HXDLIN( 487)							Float val185 = (val184 + ( (Float)(_hx_array_unsafe_get(u,(eOffset22 + -6))) ));
HXDLIN( 487)							_g77->__unsafe_set(_g76,val185);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g78 = (eOffset03 + -7);
HXDLIN( 487)						::Array< Float > _g79 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val186 = ( (Float)(_hx_array_unsafe_get(_g79,_g78)) );
HXDLIN( 487)							Float val187 = (val186 + ( (Float)(_hx_array_unsafe_get(u,(eOffset22 + -7))) ));
HXDLIN( 487)							_g79->__unsafe_set(_g78,val187);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g80 = eOffset04;
HXDLIN( 487)						::Array< Float > _g81 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val192 = ( (Float)(_hx_array_unsafe_get(_g81,_g80)) );
HXDLIN( 487)							Float val193 = (val192 + ( (Float)(_hx_array_unsafe_get(u,eOffset23)) ));
HXDLIN( 487)							_g81->__unsafe_set(_g80,val193);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g82 = (eOffset04 + -1);
HXDLIN( 487)						::Array< Float > _g83 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val194 = ( (Float)(_hx_array_unsafe_get(_g83,_g82)) );
HXDLIN( 487)							Float val195 = (val194 + ( (Float)(_hx_array_unsafe_get(u,(eOffset23 + -1))) ));
HXDLIN( 487)							_g83->__unsafe_set(_g82,val195);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g84 = (eOffset04 + -2);
HXDLIN( 487)						::Array< Float > _g85 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val200 = ( (Float)(_hx_array_unsafe_get(_g85,_g84)) );
HXDLIN( 487)							Float val201 = (val200 + ( (Float)(_hx_array_unsafe_get(u,(eOffset23 + -2))) ));
HXDLIN( 487)							_g85->__unsafe_set(_g84,val201);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g86 = (eOffset04 + -3);
HXDLIN( 487)						::Array< Float > _g87 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val202 = ( (Float)(_hx_array_unsafe_get(_g87,_g86)) );
HXDLIN( 487)							Float val203 = (val202 + ( (Float)(_hx_array_unsafe_get(u,(eOffset23 + -3))) ));
HXDLIN( 487)							_g87->__unsafe_set(_g86,val203);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g88 = (eOffset04 + -4);
HXDLIN( 487)						::Array< Float > _g89 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val208 = ( (Float)(_hx_array_unsafe_get(_g89,_g88)) );
HXDLIN( 487)							Float val209 = (val208 + ( (Float)(_hx_array_unsafe_get(u,(eOffset23 + -4))) ));
HXDLIN( 487)							_g89->__unsafe_set(_g88,val209);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g90 = (eOffset04 + -5);
HXDLIN( 487)						::Array< Float > _g91 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val210 = ( (Float)(_hx_array_unsafe_get(_g91,_g90)) );
HXDLIN( 487)							Float val211 = (val210 + ( (Float)(_hx_array_unsafe_get(u,(eOffset23 + -5))) ));
HXDLIN( 487)							_g91->__unsafe_set(_g90,val211);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)					{
HXLINE( 487)						int _g92 = (eOffset04 + -6);
HXDLIN( 487)						::Array< Float > _g93 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val216 = ( (Float)(_hx_array_unsafe_get(_g93,_g92)) );
HXDLIN( 487)							Float val217 = (val216 + ( (Float)(_hx_array_unsafe_get(u,(eOffset23 + -6))) ));
HXDLIN( 487)							_g93->__unsafe_set(_g92,val217);
            						}
            					}
HXDLIN( 487)					{
HXLINE( 487)						int _g94 = (eOffset04 + -7);
HXDLIN( 487)						::Array< Float > _g95 = u;
HXDLIN( 487)						{
HXLINE( 487)							Float val218 = ( (Float)(_hx_array_unsafe_get(_g95,_g94)) );
HXDLIN( 487)							Float val219 = (val218 + ( (Float)(_hx_array_unsafe_get(u,(eOffset23 + -7))) ));
HXDLIN( 487)							_g95->__unsafe_set(_g94,val219);
            						}
            					}
HXDLIN( 487)					{
...
HXDLIN( 487)			{
HXLINE( 487)				int _g96 = 2;
HXDLIN( 487)				int _g97 = ((ld1 - 3) >> 1);
HXDLIN( 487)				while((_g96 < _g97)){
HXLINE( 487)					_g96 = (_g96 + 1);
HXDLIN( 487)					int l = (_g96 - 1);
HXDLIN( 487)					int k0 = (n >> (l + 2));
HXDLIN( 487)					int k0_2 = (k0 >> 1);
HXDLIN( 487)					int lim = (1 << (l + 1));
HXDLIN( 487)					{
HXLINE( 487)						int _g98 = 0;
HXDLIN( 487)						int _g99 = lim;
HXDLIN( 487)						while((_g98 < _g99)){
HXLINE( 487)							_g98 = (_g98 + 1);
HXDLIN( 487)							int i6 = (_g98 - 1);
HXDLIN( 487)							{
...
HXDLIN( 487)									{
HXLINE( 487)										int _g100 = eOffset05;
HXDLIN( 487)										::Array< Float > _g101 = u;
HXDLIN( 487)										{
HXLINE( 487)											Float val224 = ( (Float)(_hx_array_unsafe_get(_g101,_g100)) );
HXDLIN( 487)											Float val225 = (val224 + ( (Float)(_hx_array_unsafe_get(u,eOffset24)) ));
HXDLIN( 487)											_g101->__unsafe_set(_g100,val225);
            										}
            									}
HXDLIN( 487)									{
HXLINE( 487)										int _g102 = (eOffset05 + -1);
HXDLIN( 487)										::Array< Float > _g103 = u;
HXDLIN( 487)										{
HXLINE( 487)											Float val226 = ( (Float)(_hx_array_unsafe_get(_g103,_g102)) );
HXDLIN( 487)											Float val227 = (val226 + ( (Float)(_hx_array_unsafe_get(u,(eOffset24 + -1))) ));
HXDLIN( 487)											_g103->__unsafe_set(_g102,val227);
            										}
            									}
HXDLIN( 487)									{
...
HXDLIN( 487)									{
HXLINE( 487)										int _g104 = (eOffset05 + -2);
HXDLIN( 487)										::Array< Float > _g105 = u;
HXDLIN( 487)										{
HXLINE( 487)											Float val232 = ( (Float)(_hx_array_unsafe_get(_g105,_g104)) );
HXDLIN( 487)											Float val233 = (val232 + ( (Float)(_hx_array_unsafe_get(u,(eOffset24 + -2))) ));
HXDLIN( 487)											_g105->__unsafe_set(_g104,val233);
            										}
            									}
HXDLIN( 487)									{
HXLINE( 487)										int _g106 = (eOffset05 + -3);
HXDLIN( 487)										::Array< Float > _g107 = u;
HXDLIN( 487)										{
HXLINE( 487)											Float val234 = ( (Float)(_hx_array_unsafe_get(_g107,_g106)) );
HXDLIN( 487)											Float val235 = (val234 + ( (Float)(_hx_array_unsafe_get(u,(eOffset24 + -3))) ));
HXDLIN( 487)											_g107->__unsafe_set(_g106,val235);
            										}
            									}
HXDLIN( 487)									{
...
HXDLIN( 487)									{
HXLINE( 487)										int _g108 = (eOffset05 + -4);
HXDLIN( 487)										::Array< Float > _g109 = u;
HXDLIN( 487)										{
HXLINE( 487)											Float val240 = ( (Float)(_hx_array_unsafe_get(_g109,_g108)) );
HXDLIN( 487)											Float val241 = (val240 + ( (Float)(_hx_array_unsafe_get(u,(eOffset24 + -4))) ));
HXDLIN( 487)											_g109->__unsafe_set(_g108,val241);
            										}
            									}
HXDLIN( 487)									{
HXLINE( 487)										int _g110 = (eOffset05 + -5);
HXDLIN( 487)										::Array< Float > _g111 = u;
HXDLIN( 487)										{
HXLINE( 487)											Float val242 = ( (Float)(_hx_array_unsafe_get(_g111,_g110)) );
HXDLIN( 487)											Float val243 = (val242 + ( (Float)(_hx_array_unsafe_get(u,(eOffset24 + -5))) ));
HXDLIN( 487)											_g111->__unsafe_set(_g110,val243);
            										}
            									}
HXDLIN( 487)									{
...
HXDLIN( 487)									{
HXLINE( 487)										int _g112 = (eOffset05 + -6);
HXDLIN( 487)										::Array< Float > _g113 = u;
HXDLIN( 487)										{
HXLINE( 487)											Float val248 = ( (Float)(_hx_array_unsafe_get(_g113,_g112)) );
HXDLIN( 487)											Float val249 = (val248 + ( (Float)(_hx_array_unsafe_get(u,(eOffset24 + -6))) ));
HXDLIN( 487)											_g113->__unsafe_set(_g112,val249);
            										}
            									}
HXDLIN( 487)									{
HXLINE( 487)										int _g114 = (eOffset05 + -7);
HXDLIN( 487)										::Array< Float > _g115 = u;
HXDLIN( 487)										{
HXLINE( 487)											Float val250 = ( (Float)(_hx_array_unsafe_get(_g115,_g114)) );
HXDLIN( 487)											Float val251 = (val250 + ( (Float)(_hx_array_unsafe_get(u,(eOffset24 + -7))) ));
HXDLIN( 487)											_g115->__unsafe_set(_g114,val251);
            										}
            									}
HXDLIN( 487)									{
...
HXDLIN( 487)			{
HXLINE( 487)				int _g116 = ((ld1 - 3) >> 1);
HXDLIN( 487)				int _g117 = (ld1 - 6);
HXDLIN( 487)				while((_g116 < _g117)){
HXLINE( 487)					_g116 = (_g116 + 1);
HXDLIN( 487)					int l1 = (_g116 - 1);
...
HXLINE( 562)		::Array< bool > zeroChannel = ::Array_obj< bool >::__new(256);
HXLINE( 563)		::Array< bool > reallyZeroChannel = ::Array_obj< bool >::__new(256);
HXLINE( 567)		int n;
...
HXLINE( 586)						::Array< bool > step2Flag = ::Array_obj< bool >::__new(256);
...
HXDLIN( 592)							int _g3 = g->partitions;
HXDLIN( 592)							while((_g2 < _g3)){
...
HXDLIN( 604)									int _g5 = cdim;
HXDLIN( 604)									while((_g4 < _g5)){
HXLINE( 604)										_g4 = (_g4 + 1);
HXDLIN( 604)										int k = (_g4 - 1);
...
HXLINE( 623)						{
HXLINE( 623)							int _g6 = 2;
HXDLIN( 623)							int _g7 = g->values;
HXDLIN( 623)							while((_g6 < _g7)){
HXLINE( 623)								_g6 = (_g6 + 1);
HXDLIN( 623)								int j1 = (_g6 - 1);
...
HXLINE( 657)						{
HXLINE( 657)							int _g8 = 0;
HXDLIN( 657)							int _g9 = g->values;
HXDLIN( 657)							while((_g8 < _g9)){
HXLINE( 657)								_g8 = (_g8 + 1);
HXDLIN( 657)								int j2 = (_g8 - 1);
...
HXLINE( 678)		{
HXLINE( 678)			int _g10 = 0;
HXDLIN( 678)			int _g11 = this->header->channel;
HXDLIN( 678)			while((_g10 < _g11)){
HXLINE( 678)				_g10 = (_g10 + 1);
HXDLIN( 678)				int i3 = (_g10 - 1);
HXLINE( 679)				{
...
HXLINE( 681)		{
HXLINE( 681)			int _g12 = 0;
HXDLIN( 681)			int _g13 = map->couplingSteps;
HXDLIN( 681)			while((_g12 < _g13)){
HXLINE( 681)				_g12 = (_g12 + 1);
HXDLIN( 681)				int i4 = (_g12 - 1);
...
HXLINE( 687)		{
HXLINE( 687)			int _g14 = 0;
HXDLIN( 687)			int _g15 = map->submaps;
HXDLIN( 687)			while((_g14 < _g15)){
HXLINE( 687)				_g14 = (_g14 + 1);
HXDLIN( 687)				int i5 = (_g14 - 1);
HXLINE( 688)				::Array< ::Dynamic> residueBuffers = ::Array_obj< ::Dynamic>::__new(this->header->channel);
HXLINE( 689)				::Array< bool > doNotDecode = ::Array_obj< bool >::__new(256);
HXLINE( 690)				int ch = 0;
HXLINE( 691)				{
HXLINE( 691)					int _g16 = 0;
HXDLIN( 691)					int _g17 = this->header->channel;
HXDLIN( 691)					while((_g16 < _g17)){
HXLINE( 691)						_g16 = (_g16 + 1);
HXDLIN( 691)						int j3 = (_g16 - 1);
...
HXLINE( 716)			::Array< ::Dynamic> this2 = this->channelBuffers;
HXDLIN( 716)			::Array< Float > m1 = ( (::Array< Float >)(_hx_array_unsafe_get(this2,( ( ::kha::audio2::ogg::vorbis::data::MappingChannel)(_hx_array_unsafe_get(map->chan,i6)) )->magnitude)) );
HXLINE( 717)			::Array< ::Dynamic> this3 = this->channelBuffers;
HXDLIN( 717)			::Array< Float > a = ( (::Array< Float >)(_hx_array_unsafe_get(this3,( ( ::kha::audio2::ogg::vorbis::data::MappingChannel)(_hx_array_unsafe_get(map->chan,i6)) )->angle)) );
HXLINE( 718)			{
HXLINE( 718)				int _g18 = 0;
HXDLIN( 718)				int _g19 = n21;
HXDLIN( 718)				while((_g18 < _g19)){
HXLINE( 718)					_g18 = (_g18 + 1);
HXDLIN( 718)					int j4 = (_g18 - 1);
HXLINE( 719)					Float a2;
HXDLIN( 719)					Float m2;
...
HXLINE( 738)					a->__unsafe_set(j4,a2);
            		...
            		_hx_goto_67:;
HXLINE( 744)		{
HXLINE( 744)			int _g20 = 0;
HXDLIN( 744)			int _g21 = this->header->channel;
HXDLIN( 744)			while((_g20 < _g21)){
HXLINE( 744)				_g20 = (_g20 + 1);
HXDLIN( 744)				int i7 = (_g20 - 1);
HXLINE( 745)				if (( (bool)(_hx_array_unsafe_get(reallyZeroChannel,i7)) )) {
HXLINE( 746)					int _g22 = 0;
HXDLIN( 746)					int _g23 = n21;
HXDLIN( 746)					while((_g22 < _g23)){
HXLINE( 746)						_g22 = (_g22 + 1);
HXDLIN( 746)						int j5 = (_g22 - 1);
...
HXLINE( 756)		{
HXLINE( 756)			int _g24 = 0;
HXDLIN( 756)			int _g25 = this->header->channel;
HXDLIN( 756)			while((_g24 < _g25)){
HXLINE( 756)				_g24 = (_g24 + 1);
HXDLIN( 756)				int i8 = (_g24 - 1);
