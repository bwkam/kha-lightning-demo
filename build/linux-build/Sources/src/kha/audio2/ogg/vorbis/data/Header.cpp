...
HXLINE(  46)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_FIRST_PAGE_dyn(),HX_("not firstPage",52,61,ee,e9),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Header.hx",60,5e,0c,4e),46,HX_("kha.audio2.ogg.vorbis.data.Header",5d,28,45,ae),HX_("read",56,4b,a7,4b))));
            		}
HXLINE(  48)		if (((page->flag & 4) != 0)) {
HXLINE(  49)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_FIRST_PAGE_dyn(),HX_("lastPage",c5,f3,9a,dd),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Header.hx",60,5e,0c,4e),49,HX_("kha.audio2.ogg.vorbis.data.Header",5d,28,45,ae),HX_("read",56,4b,a7,4b))));
            		}
HXLINE(  51)		if (((page->flag & 1) != 0)) {
HXLINE(  52)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_FIRST_PAGE_dyn(),HX_("continuedPacket",85,39,ee,94),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Header.hx",60,5e,0c,4e),52,HX_("kha.audio2.ogg.vorbis.data.Header",5d,28,45,ae),HX_("read",56,4b,a7,4b))));
            		}
...
HXLINE(  57)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_FIRST_PAGE_dyn(),HX_("decodeState head",5d,8c,63,29),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Header.hx",60,5e,0c,4e),57,HX_("kha.audio2.ogg.vorbis.data.Header",5d,28,45,ae),HX_("read",56,4b,a7,4b))));
            		}
HXLINE(  61)		{
...
HXDLIN(  61)						decodeState2->inputPosition = (decodeState2->inputPosition + 1);
...
HXLINE(  61)						decodeState->bytesInSeg--;
HXDLIN(  61)						 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState3 = decodeState;
HXDLIN(  61)						decodeState3->inputPosition = (decodeState3->inputPosition + 1);
...
HXLINE(  61)						decodeState->bytesInSeg--;
HXDLIN(  61)						 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState4 = decodeState;
HXDLIN(  61)						decodeState4->inputPosition = (decodeState4->inputPosition + 1);
...
HXLINE(  61)						decodeState->bytesInSeg--;
HXDLIN(  61)						 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState5 = decodeState;
HXDLIN(  61)						decodeState5->inputPosition = (decodeState5->inputPosition + 1);
...
HXLINE(  61)						decodeState->bytesInSeg--;
HXDLIN(  61)						 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState6 = decodeState;
HXDLIN(  61)						decodeState6->inputPosition = (decodeState6->inputPosition + 1);
...
HXLINE(  61)						decodeState->bytesInSeg--;
HXDLIN(  61)						 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState7 = decodeState;
HXDLIN(  61)						decodeState7->inputPosition = (decodeState7->inputPosition + 1);
...
HXLINE(  64)		 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState8 = decodeState;
HXDLIN(  64)		decodeState8->inputPosition = (decodeState8->inputPosition + 4);
HXDLIN(  64)		int version = decodeState->input->readInt32();
HXLINE(  65)		if ((version != 0)) {
HXLINE(  66)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_FIRST_PAGE_dyn(),(HX_("vorbis version : ",5b,e2,58,09) + version),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Header.hx",60,5e,0c,4e),66,HX_("kha.audio2.ogg.vorbis.data.Header",5d,28,45,ae),HX_("read",56,4b,a7,4b))));
            		}
HXLINE(  69)		 ::kha::audio2::ogg::vorbis::data::Header header1 =  ::kha::audio2::ogg::vorbis::data::Header_obj::__alloc( HX_CTX );
HXLINE(  71)		 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState9 = decodeState;
HXDLIN(  71)		decodeState9->inputPosition = (decodeState9->inputPosition + 1);
HXDLIN(  71)		header1->channel = decodeState->input->readByte();
HXLINE(  72)		if ((header1->channel == 0)) {
HXLINE(  73)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_FIRST_PAGE_dyn(),HX_("no channel",e4,4d,cc,09),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Header.hx",60,5e,0c,4e),73,HX_("kha.audio2.ogg.vorbis.data.Header",5d,28,45,ae),HX_("read",56,4b,a7,4b))));
            		}
            		else {
HXLINE(  74)			if ((header1->channel > 16)) {
HXLINE(  75)				HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::TOO_MANY_CHANNELS_dyn(),HX_("too many channels",65,2f,80,4b),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Header.hx",60,5e,0c,4e),75,HX_("kha.audio2.ogg.vorbis.data.Header",5d,28,45,ae),HX_("read",56,4b,a7,4b))));
            			}
            		}
HXLINE(  78)		 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState10 = decodeState;
HXDLIN(  78)		decodeState10->inputPosition = (decodeState10->inputPosition + 4);
HXDLIN(  78)		header1->sampleRate = decodeState->input->readInt32();
HXLINE(  79)		if ((header1->sampleRate == 0)) {
HXLINE(  80)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_FIRST_PAGE_dyn(),HX_("no sampling rate",9a,91,ba,fc),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Header.hx",60,5e,0c,4e),80,HX_("kha.audio2.ogg.vorbis.data.Header",5d,28,45,ae),HX_("read",56,4b,a7,4b))));
            		}
HXLINE(  83)		 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState11 = decodeState;
HXDLIN(  83)		decodeState11->inputPosition = (decodeState11->inputPosition + 4);
HXDLIN(  83)		header1->maximumBitRate = decodeState->input->readInt32();
HXLINE(  84)		 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState12 = decodeState;
HXDLIN(  84)		decodeState12->inputPosition = (decodeState12->inputPosition + 4);
HXDLIN(  84)		header1->nominalBitRate = decodeState->input->readInt32();
HXLINE(  85)		 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState13 = decodeState;
HXDLIN(  85)		decodeState13->inputPosition = (decodeState13->inputPosition + 4);
HXDLIN(  85)		header1->minimumBitRate = decodeState->input->readInt32();
HXLINE(  87)		 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState14 = decodeState;
HXDLIN(  87)		decodeState14->inputPosition = (decodeState14->inputPosition + 1);
...
HXLINE(  93)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_SETUP_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Header.hx",60,5e,0c,4e),93,HX_("kha.audio2.ogg.vorbis.data.Header",5d,28,45,ae),HX_("read",56,4b,a7,4b))));
            		}
...
HXLINE(  96)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_SETUP_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Header.hx",60,5e,0c,4e),96,HX_("kha.audio2.ogg.vorbis.data.Header",5d,28,45,ae),HX_("read",56,4b,a7,4b))));
            		}
HXLINE(  98)		if ((log0 > log1)) {
HXLINE(  99)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_SETUP_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Header.hx",60,5e,0c,4e),99,HX_("kha.audio2.ogg.vorbis.data.Header",5d,28,45,ae),HX_("read",56,4b,a7,4b))));
            		}
HXLINE( 103)		 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState15 = decodeState;
HXDLIN( 103)		decodeState15->inputPosition = (decodeState15->inputPosition + 1);
HXDLIN( 103)		int x13 = decodeState->input->readByte();
HXLINE( 104)		if (((x13 & 1) == 0)) {
HXLINE( 105)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_FIRST_PAGE_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Header.hx",60,5e,0c,4e),105,HX_("kha.audio2.ogg.vorbis.data.Header",5d,28,45,ae),HX_("read",56,4b,a7,4b))));
            		}
...
HXLINE( 115)			 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState16 = decodeState;
HXDLIN( 115)			decodeState16->inputPosition = (decodeState16->inputPosition + len);
...
HXDLIN( 135)						::String _hx_tmp2 = str.substring(0,splitter);
HXDLIN( 135)						header2->add(_hx_tmp2,str.substring((splitter + 1),null()));
            					}
            				}
            			}
HXLINE( 139)			int x14 = packetInput->readByte();
HXLINE( 140)			if (((x14 & 1) == 0)) {
HXLINE( 141)				HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_SETUP_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Header.hx",60,5e,0c,4e),141,HX_("kha.audio2.ogg.vorbis.data.Header",5d,28,45,ae),HX_("read",56,4b,a7,4b))));
            			}
            		}
...
HXDLIN( 148)			 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState17 = decodeState;
HXDLIN( 148)			decodeState17->inputPosition = (decodeState17->inputPosition + 1);
HXDLIN( 148)			x15 = decodeState->input->readByte();
            		}
HXDLIN( 148)		decodeState->validBits = 0;
HXDLIN( 148)		if ((x15 != 5)) {
HXLINE( 149)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_SETUP_dyn(),HX_("setup packet",cb,fa,2a,07),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Header.hx",60,5e,0c,4e),149,HX_("kha.audio2.ogg.vorbis.data.Header",5d,28,45,ae),HX_("read",56,4b,a7,4b))));
            		}
HXLINE( 152)		{
HXLINE( 152)			 ::haxe::io::Bytes header3 = ::haxe::io::Bytes_obj::alloc(6);
HXDLIN( 152)			{
HXLINE( 152)				{
HXLINE( 152)					int x17;
HXDLIN( 152)					bool x18;
...
HXDLIN( 152)						 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState18 = decodeState;
HXDLIN( 152)						decodeState18->inputPosition = (decodeState18->inputPosition + 1);
HXDLIN( 152)						x17 = decodeState->input->readByte();
            					}
HXDLIN( 152)					decodeState->validBits = 0;
HXDLIN( 152)					header3->b[0] = ( (unsigned char)(x17) );
            				}
HXDLIN( 152)				{
HXLINE( 152)					int x19;
HXDLIN( 152)					bool x20;
...
HXLINE( 152)						decodeState->bytesInSeg--;
HXDLIN( 152)						 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState19 = decodeState;
HXDLIN( 152)						decodeState19->inputPosition = (decodeState19->inputPosition + 1);
HXDLIN( 152)						x19 = decodeState->input->readByte();
            					}
HXDLIN( 152)					decodeState->validBits = 0;
HXDLIN( 152)					header3->b[1] = ( (unsigned char)(x19) );
            				}
HXDLIN( 152)				{
HXLINE( 152)					int x21;
HXDLIN( 152)					bool x22;
...
HXLINE( 152)						decodeState->bytesInSeg--;
HXDLIN( 152)						 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState20 = decodeState;
HXDLIN( 152)						decodeState20->inputPosition = (decodeState20->inputPosition + 1);
HXDLIN( 152)						x21 = decodeState->input->readByte();
            					}
HXDLIN( 152)					decodeState->validBits = 0;
HXDLIN( 152)					header3->b[2] = ( (unsigned char)(x21) );
            				}
HXDLIN( 152)				{
HXLINE( 152)					int x23;
HXDLIN( 152)					bool x24;
...
HXLINE( 152)						decodeState->bytesInSeg--;
HXDLIN( 152)						 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState21 = decodeState;
HXDLIN( 152)						decodeState21->inputPosition = (decodeState21->inputPosition + 1);
HXDLIN( 152)						x23 = decodeState->input->readByte();
            					}
HXDLIN( 152)					decodeState->validBits = 0;
HXDLIN( 152)					header3->b[3] = ( (unsigned char)(x23) );
            				}
HXDLIN( 152)				{
HXLINE( 152)					int x25;
HXDLIN( 152)					bool x26;
...
HXLINE( 152)						decodeState->bytesInSeg--;
HXDLIN( 152)						 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState22 = decodeState;
HXDLIN( 152)						decodeState22->inputPosition = (decodeState22->inputPosition + 1);
HXDLIN( 152)						x25 = decodeState->input->readByte();
            					}
HXDLIN( 152)					decodeState->validBits = 0;
HXDLIN( 152)					header3->b[4] = ( (unsigned char)(x25) );
            				}
HXDLIN( 152)				{
HXLINE( 152)					int x27;
HXDLIN( 152)					bool x28;
...
HXLINE( 152)						decodeState->bytesInSeg--;
HXDLIN( 152)						 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState23 = decodeState;
HXDLIN( 152)						decodeState23->inputPosition = (decodeState23->inputPosition + 1);
HXDLIN( 152)						x27 = decodeState->input->readByte();
            					}
HXDLIN( 152)					decodeState->validBits = 0;
HXDLIN( 152)					header3->b[5] = ( (unsigned char)(x27) );
            				}
            			}
...
HXLINE( 156)		header1->_hx_set_codebooks(HX_CTX, ::Array_obj< ::Dynamic>::__new(codebookCount));
HXLINE( 157)		{
...
HXDLIN( 158)					this1->__unsafe_set(i1,val);
            				}
            			}
            		}
...
HXDLIN( 163)				int i2 = (_g4 - 1);
HXLINE( 164)				if ((decodeState->readBits(16) != 0)) {
HXLINE( 165)					HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_SETUP_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Header.hx",60,5e,0c,4e),165,HX_("kha.audio2.ogg.vorbis.data.Header",5d,28,45,ae),HX_("read",56,4b,a7,4b))));
            				}
            			}
            		}
HXLINE( 170)		int floorCount = (decodeState->readBits(6) + 1);
HXLINE( 171)		header1->_hx_set_floorConfig(HX_CTX, ::Array_obj< ::Dynamic>::__new(floorCount));
HXLINE( 172)		{
HXLINE( 172)			int _g6 = 0;
HXDLIN( 172)			int _g7 = floorCount;
HXDLIN( 172)			while((_g6 < _g7)){
HXLINE( 172)				_g6 = (_g6 + 1);
HXDLIN( 172)				int i3 = (_g6 - 1);
HXLINE( 173)				{
...
HXLINE( 189)				{
HXLINE( 189)					int _g12 = 0;
HXDLIN( 189)					int _g13 = map->submaps;
HXDLIN( 189)					while((_g12 < _g13)){
HXLINE( 189)						_g12 = (_g12 + 1);
HXDLIN( 189)						int j = (_g12 - 1);
HXLINE( 190)						int _hx_tmp3 = ( (int)(_hx_array_unsafe_get(map->submapFloor,j)) );
HXDLIN( 190)						if ((_hx_tmp3 >= header1->floorConfig->length)) {
HXLINE( 191)							HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_SETUP_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Header.hx",60,5e,0c,4e),191,HX_("kha.audio2.ogg.vorbis.data.Header",5d,28,45,ae),HX_("read",56,4b,a7,4b))));
            						}
HXLINE( 193)						int _hx_tmp4 = ( (int)(_hx_array_unsafe_get(map->submapResidue,j)) );
HXDLIN( 193)						if ((_hx_tmp4 >= header1->residueConfig->length)) {
HXLINE( 194)							HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_SETUP_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Header.hx",60,5e,0c,4e),194,HX_("kha.audio2.ogg.vorbis.data.Header",5d,28,45,ae),HX_("read",56,4b,a7,4b))));
            						}
            					}
            				}
            			}
...
HXLINE( 200)		header1->_hx_set_modes(HX_CTX, ::Array_obj< ::Dynamic>::__new(modeCount));
HXLINE( 201)		{
HXLINE( 201)			int _g14 = 0;
HXDLIN( 201)			int _g15 = modeCount;
HXDLIN( 201)			while((_g14 < _g15)){
HXLINE( 201)				_g14 = (_g14 + 1);
HXDLIN( 201)				int i6 = (_g14 - 1);
...
HXLINE( 205)					HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_SETUP_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Header.hx",60,5e,0c,4e),205,HX_("kha.audio2.ogg.vorbis.data.Header",5d,28,45,ae),HX_("read",56,4b,a7,4b))));
            				}
            			}
            		}
HXLINE( 209)		while(true){
HXLINE( 209)			bool _hx_tmp5;
HXDLIN( 209)			if ((decodeState->bytesInSeg == 0)) {
HXLINE( 209)				if (!(decodeState->lastSeg)) {
HXLINE( 209)					_hx_tmp5 = (decodeState->next() != 0);
            				}
            				else {
...
HXDLIN( 209)			{
HXLINE( 209)				 ::kha::audio2::ogg::vorbis::VorbisDecodeState decodeState24 = decodeState;
HXDLIN( 209)				decodeState24->inputPosition = (decodeState24->inputPosition + 1);
