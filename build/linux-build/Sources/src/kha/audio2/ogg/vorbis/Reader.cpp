...
int Reader_obj::read( ::kha::arrays::ByteArrayPrivate output, ::Dynamic samples, ::Dynamic channels, ::Dynamic sampleRate,::hx::Null< bool >  __o_useFloat){
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Reader_obj,seekBytes,(void))
 ...
 ::kha::audio2::ogg::vorbis::Reader Reader_obj::openFromFile(::String fileName){
            		HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_0, ::sys::io::FileInput,_g, ::sys::io::FileSeek,pos) HXARGC(1)
            		void _hx_run(int p){
            			HX_STACKFRAME(&_hx_pos_513353bacac92b5d_98_openFromFile)
HXLINE(  98)			_g->seek(p,pos);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE(  98)		 ::sys::io::FileInput _g = file;
...
HXLINE( 109)		 ::kha::arrays::ByteArrayPrivate buffer = ::kha::arrays::_Float32Array::Float32Array_Impl__obj::_new((bufferSize * header->channel));
...
HXLINE( 113)					output->writeFloat(*(float *)&buffer->self.data[buffer->byteArrayOffset + (i * 4)]);
            				}
            			}
HXLINE( 115)			if ((n == 0)) {
