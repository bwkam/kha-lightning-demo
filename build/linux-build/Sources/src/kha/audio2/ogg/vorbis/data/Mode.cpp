...
HXLINE(  22)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_SETUP_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Mode.hx",8a,ac,3d,8e),22,HX_("kha.audio2.ogg.vorbis.data.Mode",33,9e,c1,c7),HX_("read",56,4b,a7,4b))));
            		}
HXLINE(  24)		if ((m->transformtype != 0)) {
HXLINE(  25)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_SETUP_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Mode.hx",8a,ac,3d,8e),25,HX_("kha.audio2.ogg.vorbis.data.Mode",33,9e,c1,c7),HX_("read",56,4b,a7,4b))));
            		}
HXLINE(  27)		return m;
            	}
