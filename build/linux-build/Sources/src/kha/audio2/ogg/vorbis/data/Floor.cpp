...
HXLINE(  28)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_SETUP_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Floor.hx",43,00,4d,2f),28,HX_("kha.audio2.ogg.vorbis.data.Floor",fc,7c,e7,f7),HX_("read",56,4b,a7,4b))));
            		}
...
HXLINE(  41)			HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::FEATURE_NOT_SUPPORTED_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Floor.hx",43,00,4d,2f),41,HX_("kha.audio2.ogg.vorbis.data.Floor",fc,7c,e7,f7),HX_("read",56,4b,a7,4b))));
            		}
            		else {
HXLINE(  43)			::Array< ::Dynamic> p = ::Array_obj< ::Dynamic>::__new();
HXLINE(  44)			 ::kha::audio2::ogg::vorbis::data::Floor1 g1 = (floor->_hx_set_floor1(HX_CTX,  ::kha::audio2::ogg::vorbis::data::Floor1_obj::__alloc( HX_CTX )));
HXLINE(  45)			int maxClass = -1;
HXLINE(  46)			g1->partitions = decodeState->readBits(5);
HXLINE(  47)			g1->_hx_set_partitionClassList(HX_CTX, ::Array_obj< int >::__new(g1->partitions));
HXLINE(  48)			{
HXLINE(  48)				int _g2 = 0;
HXDLIN(  48)				int _g3 = g1->partitions;
HXDLIN(  48)				while((_g2 < _g3)){
HXLINE(  48)					_g2 = (_g2 + 1);
HXDLIN(  48)					int j1 = (_g2 - 1);
HXLINE(  49)					{
HXLINE(  49)						::Array< int > this2 = g1->partitionClassList;
HXDLIN(  49)						int val1 = decodeState->readBits(4);
HXDLIN(  49)						this2->__unsafe_set(j1,val1);
            					}
HXLINE(  50)					if (::hx::IsGreater( _hx_array_unsafe_get(g1->partitionClassList,j1),maxClass )) {
HXLINE(  51)						maxClass = ( (int)(_hx_array_unsafe_get(g1->partitionClassList,j1)) );
            					}
            				}
            			}
HXLINE(  54)			g1->_hx_set_classDimensions(HX_CTX, ::Array_obj< int >::__new((maxClass + 1)));
HXLINE(  55)			g1->_hx_set_classMasterbooks(HX_CTX, ::Array_obj< int >::__new((maxClass + 1)));
HXLINE(  56)			g1->_hx_set_classSubclasses(HX_CTX, ::Array_obj< int >::__new((maxClass + 1)));
HXLINE(  57)			g1->_hx_set_subclassBooks(HX_CTX, ::Array_obj< ::Dynamic>::__new((maxClass + 1)));
HXLINE(  58)			{
HXLINE(  58)				int _g4 = 0;
HXDLIN(  58)				int _g5 = (maxClass + 1);
HXDLIN(  58)				while((_g4 < _g5)){
HXLINE(  58)					_g4 = (_g4 + 1);
HXDLIN(  58)					int j2 = (_g4 - 1);
HXLINE(  59)					{
HXLINE(  59)						::Array< int > this3 = g1->classDimensions;
HXDLIN(  59)						int val2 = (decodeState->readBits(3) + 1);
HXDLIN(  59)						this3->__unsafe_set(j2,val2);
            					}
HXLINE(  60)					{
HXLINE(  60)						::Array< int > this4 = g1->classSubclasses;
HXDLIN(  60)						int val3 = decodeState->readBits(2);
HXDLIN(  60)						this4->__unsafe_set(j2,val3);
            					}
HXLINE(  61)					if (::hx::IsNotEq( _hx_array_unsafe_get(g1->classSubclasses,j2),0 )) {
HXLINE(  62)						{
HXLINE(  62)							::Array< int > this5 = g1->classMasterbooks;
HXDLIN(  62)							int val4 = decodeState->readBits(8);
HXDLIN(  62)							this5->__unsafe_set(j2,val4);
            						}
HXLINE(  63)						int _hx_tmp = ( (int)(_hx_array_unsafe_get(g1->classMasterbooks,j2)) );
HXDLIN(  63)						if ((_hx_tmp >= codebooks->length)) {
HXLINE(  64)							HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_SETUP_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Floor.hx",43,00,4d,2f),64,HX_("kha.audio2.ogg.vorbis.data.Floor",fc,7c,e7,f7),HX_("read",56,4b,a7,4b))));
            						}
            					}
HXLINE(  68)					int kl = (1 << ( (int)(_hx_array_unsafe_get(g1->classSubclasses,j2)) ));
HXLINE(  69)					{
HXLINE(  69)						::Array< ::Dynamic> this6 = g1->subclassBooks;
HXDLIN(  69)						::Array< int > this7 = ::Array_obj< int >::__new(kl);
HXDLIN(  69)						this6->__unsafe_set(j2,this7);
            					}
HXLINE(  70)					{
HXLINE(  70)						int _g6 = 0;
HXDLIN(  70)						int _g7 = kl;
HXDLIN(  70)						while((_g6 < _g7)){
HXLINE(  70)							_g6 = (_g6 + 1);
HXDLIN(  70)							int k = (_g6 - 1);
HXLINE(  71)							{
HXLINE(  71)								::Array< int > this8 = ( (::Array< int >)(_hx_array_unsafe_get(g1->subclassBooks,j2)) );
HXDLIN(  71)								int val5 = (decodeState->readBits(8) - 1);
HXDLIN(  71)								this8->__unsafe_set(k,val5);
            							}
HXLINE(  72)							int _hx_tmp1 = ( (int)(_hx_array_unsafe_get(( (::Array< int >)(_hx_array_unsafe_get(g1->subclassBooks,j2)) ),k)) );
HXDLIN(  72)							if ((_hx_tmp1 >= codebooks->length)) {
HXLINE(  73)								HX_STACK_DO_THROW( ::kha::audio2::ogg::vorbis::data::ReaderError_obj::__alloc( HX_CTX ,::kha::audio2::ogg::vorbis::data::ReaderErrorType_obj::INVALID_SETUP_dyn(),null(),::hx::SourceInfo(HX_("kha/audio2/ogg/vorbis/data/Floor.hx",43,00,4d,2f),73,HX_("kha.audio2.ogg.vorbis.data.Floor",fc,7c,e7,f7),HX_("read",56,4b,a7,4b))));
            							}
            						}
            					}
            				}
            			}
HXLINE(  78)			g1->floor1Multiplier = (decodeState->readBits(2) + 1);
HXLINE(  79)			g1->rangebits = decodeState->readBits(4);
HXLINE(  80)			g1->_hx_set_xlist(HX_CTX, ::Array_obj< int >::__new(250));
HXLINE(  81)			g1->xlist->__unsafe_set(0,0);
HXLINE(  82)			g1->xlist->__unsafe_set(1,(1 << g1->rangebits));
HXLINE(  83)			g1->values = 2;
HXLINE(  84)			{
HXLINE(  84)				int _g8 = 0;
HXDLIN(  84)				int _g9 = g1->partitions;
HXDLIN(  84)				while((_g8 < _g9)){
HXLINE(  84)					_g8 = (_g8 + 1);
HXDLIN(  84)					int j3 = (_g8 - 1);
HXLINE(  85)					int c = ( (int)(_hx_array_unsafe_get(g1->partitionClassList,j3)) );
HXLINE(  86)					{
HXLINE(  86)						int _g10 = 0;
HXDLIN(  86)						int _g11 = ( (int)(_hx_array_unsafe_get(g1->classDimensions,c)) );
HXDLIN(  86)						while((_g10 < _g11)){
HXLINE(  86)							_g10 = (_g10 + 1);
HXDLIN(  86)							int k1 = (_g10 - 1);
HXLINE(  87)							{
HXLINE(  87)								::Array< int > this9 = g1->xlist;
HXDLIN(  87)								int index = g1->values;
HXDLIN(  87)								int val6 = decodeState->readBits(g1->rangebits);
HXDLIN(  87)								this9->__unsafe_set(index,val6);
            							}
HXLINE(  88)							g1->values++;
            						}
            					}
...
HXLINE(  93)			{
HXLINE(  93)				int _g12 = 0;
HXDLIN(  93)				int _g13 = g1->values;
HXDLIN(  93)				while((_g12 < _g13)){
HXLINE(  93)					_g12 = (_g12 + 1);
HXDLIN(  93)					int j4 = (_g12 - 1);
HXLINE(  94)					p->push( ::kha::audio2::ogg::vorbis::data::IntPoint_obj::__alloc( HX_CTX ));
HXLINE(  95)					int _hx_tmp2 = ( (int)(_hx_array_unsafe_get(g1->xlist,j4)) );
HXDLIN(  95)					p->__get(j4).StaticCast<  ::kha::audio2::ogg::vorbis::data::IntPoint >()->x = _hx_tmp2;
...
HXLINE( 101)			g1->_hx_set_sortedOrder(HX_CTX, ::Array_obj< int >::__new(g1->values));
HXLINE( 102)			{
HXLINE( 102)				int _g14 = 0;
HXDLIN( 102)				int _g15 = g1->values;
HXDLIN( 102)				while((_g14 < _g15)){
HXLINE( 102)					_g14 = (_g14 + 1);
HXDLIN( 102)					int j5 = (_g14 - 1);
HXLINE( 103)					g1->sortedOrder->__unsafe_set(j5,p->__get(j5).StaticCast<  ::kha::audio2::ogg::vorbis::data::IntPoint >()->y);
            				}
            			}
HXLINE( 106)			g1->_hx_set_neighbors(HX_CTX, ::Array_obj< ::Dynamic>::__new(g1->values));
HXLINE( 108)			{
HXLINE( 108)				int _g16 = 2;
HXDLIN( 108)				int _g17 = g1->values;
HXDLIN( 108)				while((_g16 < _g17)){
HXLINE( 108)					_g16 = (_g16 + 1);
HXDLIN( 108)					int j6 = (_g16 - 1);
HXLINE( 109)					::Array< int > x = g1->xlist;
HXDLIN( 109)					int low = -1;
HXDLIN( 109)					int high = 65536;
HXDLIN( 109)					int plow = 0;
HXDLIN( 109)					int phigh = 0;
HXDLIN( 109)					int _g18 = 0;
HXDLIN( 109)					int _g19 = j6;
HXDLIN( 109)					while((_g18 < _g19)){
HXLINE( 109)						_g18 = (_g18 + 1);
HXDLIN( 109)						int i = (_g18 - 1);
HXDLIN( 109)						bool _hx_tmp3;
HXDLIN( 109)						if ((( (int)(_hx_array_unsafe_get(x,i)) ) > low)) {
HXLINE( 109)							int _hx_tmp4 = ( (int)(_hx_array_unsafe_get(x,i)) );
HXDLIN( 109)							_hx_tmp3 = (_hx_tmp4 < ( (int)(_hx_array_unsafe_get(x,j6)) ));
            						}
            						else {
...
HXLINE( 109)							int _hx_tmp6 = ( (int)(_hx_array_unsafe_get(x,i)) );
HXDLIN( 109)							_hx_tmp5 = (_hx_tmp6 > ( (int)(_hx_array_unsafe_get(x,j6)) ));
            						}
            						else {
...
HXDLIN( 110)						::Array< int > this11 = ::Array_obj< int >::__new(g1->values);
HXDLIN( 110)						this10->__unsafe_set(j6,this11);
            					}
HXLINE( 111)					( (::Array< int >)(_hx_array_unsafe_get(g1->neighbors,j6)) )->__unsafe_set(0,ne_low);
HXLINE( 112)					( (::Array< int >)(_hx_array_unsafe_get(g1->neighbors,j6)) )->__unsafe_set(1,ne_high);
            				}
            			}
            		}
