...
HX_DEFINE_STACK_FRAME(_hx_pos_f5e0555984af9b17_7_new,"kha.audio2.StreamChannel","new",0x8b4239ad,"kha.audio2.StreamChannel.new","kha/audio2/StreamChannel.hx",7,0x97220c83)
HX_LOCAL_STACK_FRAME(_hx_pos_f5e0555984af9b17_20_initVorbis,"kha.audio2.StreamChannel","initVorbis",0x1b4e68d6,"kha.audio2.StreamChannel.initVorbis","kha/audio2/StreamChannel.hx",20,0x97220c83)
HX_LOCAL_STACK_FRAME(_hx_pos_f5e0555984af9b17_36_nextVorbisSamples,"kha.audio2.StreamChannel","nextVorbisSamples",0xf2e4ef10,"kha.audio2.StreamChannel.nextVorbisSamples","kha/audio2/StreamChannel.hx",36,0x97220c83)
HX_LOCAL_STACK_FRAME(_hx_pos_f5e0555984af9b17_38_nextSamples,"kha.audio2.StreamChannel","nextSamples",0xf9af3aa3,"kha.audio2.StreamChannel.nextSamples","kha/audio2/StreamChannel.hx",38,0x97220c83)
HX_LOCAL_STACK_FRAME(_hx_pos_f5e0555984af9b17_50_play,"kha.audio2.StreamChannel","play",0x5007e807,"kha.audio2.StreamChannel.play","kha/audio2/StreamChannel.hx",50,0x97220c83)
HX_LOCAL_STACK_FRAME(_hx_pos_f5e0555984af9b17_54_pause,"kha.audio2.StreamChannel","pause",0xafaced83,"kha.audio2.StreamChannel.pause","kha/audio2/StreamChannel.hx",54,0x97220c83)
HX_LOCAL_STACK_FRAME(_hx_pos_f5e0555984af9b17_58_stop,"kha.audio2.StreamChannel","stop",0x5209aa15,"kha.audio2.StreamChannel.stop","kha/audio2/StreamChannel.hx",58,0x97220c83)
HX_LOCAL_STACK_FRAME(_hx_pos_f5e0555984af9b17_68_get_length,"kha.audio2.StreamChannel","get_length",0x435c0f02,"kha.audio2.StreamChannel.get_length","kha/audio2/StreamChannel.hx",68,0x97220c83)
HX_LOCAL_STACK_FRAME(_hx_pos_f5e0555984af9b17_80_get_position,"kha.audio2.StreamChannel","get_position",0x88f6d9c5,"kha.audio2.StreamChannel.get_position","kha/audio2/StreamChannel.hx",80,0x97220c83)
HX_LOCAL_STACK_FRAME(_hx_pos_f5e0555984af9b17_90_set_position,"kha.audio2.StreamChannel","set_position",0x9deffd39,"kha.audio2.StreamChannel.set_position","kha/audio2/StreamChannel.hx",90,0x97220c83)
HX_LOCAL_STACK_FRAME(_hx_pos_f5e0555984af9b17_96_get_volume,"kha.audio2.StreamChannel","get_volume",0x03a7a3f6,"kha.audio2.StreamChannel.get_volume","kha/audio2/StreamChannel.hx",96,0x97220c83)
HX_LOCAL_STACK_FRAME(_hx_pos_f5e0555984af9b17_100_set_volume,"kha.audio2.StreamChannel","set_volume",0x0725426a,"kha.audio2.StreamChannel.set_volume","kha/audio2/StreamChannel.hx",100,0x97220c83)
HX_LOCAL_STACK_FRAME(_hx_pos_f5e0555984af9b17_106_get_finished,"kha.audio2.StreamChannel","get_finished",0x530acc8e,"kha.audio2.StreamChannel.get_finished","kha/audio2/StreamChannel.hx",106,0x97220c83)
namespace kha{
namespace audio2{

void StreamChannel_obj::__construct( ::haxe::io::Bytes data,bool loop){
            	HX_STACKFRAME(&_hx_pos_f5e0555984af9b17_7_new)
HXLINE(  11)		this->paused = false;
HXLINE(   8)		this->atend = false;
HXLINE(  14)		this->myVolume = ( (Float)(1) );
HXLINE(  15)		this->loop = loop;
HXLINE(  16)		this->initVorbis(data);
            	}
...
void StreamChannel_obj::initVorbis( ::haxe::io::Bytes data){
            	HX_STACKFRAME(&_hx_pos_f5e0555984af9b17_20_initVorbis)
...
void StreamChannel_obj::nextVorbisSamples( ::kha::arrays::ByteArrayPrivate samples,int length){
            	HX_STACKFRAME(&_hx_pos_f5e0555984af9b17_36_nextVorbisSamples)
...
void StreamChannel_obj::nextSamples( ::kha::arrays::ByteArrayPrivate samples,int length,int sampleRate){
            	HX_STACKFRAME(&_hx_pos_f5e0555984af9b17_38_nextSamples)
HXLINE(  39)		if (this->paused) {
HXLINE(  40)			{
HXLINE(  40)				int _g = 0;
HXDLIN(  40)				int _g1 = length;
HXDLIN(  40)				while((_g < _g1)){
HXLINE(  40)					_g = (_g + 1);
HXDLIN(  40)					int i = (_g - 1);
HXLINE(  41)					*((float *)&samples->self.data[samples->byteArrayOffset + (i * 4)]) = 0;
            				}
            			}
HXLINE(  43)			return;
            		}
HXLINE(  46)		this->nextVorbisSamples(samples,length);
            	}
...
void StreamChannel_obj::play(){
            	HX_STACKFRAME(&_hx_pos_f5e0555984af9b17_50_play)
HXDLIN(  50)		this->paused = false;
            	}
...
void StreamChannel_obj::pause(){
            	HX_STACKFRAME(&_hx_pos_f5e0555984af9b17_54_pause)
HXDLIN(  54)		this->paused = true;
            	}
...
void StreamChannel_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_f5e0555984af9b17_58_stop)
HXDLIN(  58)		this->atend = true;
            	}
...
int StreamChannel_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_f5e0555984af9b17_68_get_length)
...
Float StreamChannel_obj::get_position(){
            	HX_STACKFRAME(&_hx_pos_f5e0555984af9b17_80_get_position)
...
Float StreamChannel_obj::set_position(Float value){
            	HX_STACKFRAME(&_hx_pos_f5e0555984af9b17_90_set_position)
...
Float StreamChannel_obj::get_volume(){
            	HX_STACKFRAME(&_hx_pos_f5e0555984af9b17_96_get_volume)
HXDLIN(  96)		return this->myVolume;
            	}
...
Float StreamChannel_obj::set_volume(Float value){
            	HX_STACKFRAME(&_hx_pos_f5e0555984af9b17_100_set_volume)
HXDLIN( 100)		return (this->myVolume = value);
            	}
...
bool StreamChannel_obj::get_finished(){
            	HX_STACKFRAME(&_hx_pos_f5e0555984af9b17_106_get_finished)
HXDLIN( 106)		return this->atend;
            	}
