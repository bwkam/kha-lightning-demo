...
HX_LOCAL_STACK_FRAME(_hx_pos_4c284ccaa8c50f8e_38__readSample,"kha.audio2.Audio","_readSample",0xa617ccbf,"kha.audio2.Audio._readSample","kha/audio2/Audio.hx",38,0xd33fa1b0)
HX_LOCAL_STACK_FRAME(_hx_pos_4c284ccaa8c50f8e_56_stream,"kha.audio2.Audio","stream",0x707f0900,"kha.audio2.Audio.stream","kha/audio2/Audio.hx",56,0xd33fa1b0)
...
HX_LOCAL_STACK_FRAME(_hx_pos_4c284ccaa8c50f8e_49_boot,"kha.audio2.Audio","boot",0x446f58b2,"kha.audio2.Audio.boot","kha/audio2/Audio.hx",49,0xd33fa1b0)
namespace kha{
namespace audio2{
...
HXLINE(  21)		::kha::audio2::Audio_obj::buffer->samplesPerSecond = sampleRate;
HXLINE(  22)		if (::hx::IsNotNull( ::kha::audio2::Audio_obj::audioCallback )) {
HXLINE(  23)			::kha::audio2::Audio_obj::intBox->value = samples;
HXLINE(  24)			::kha::audio2::Audio_obj::audioCallback(::kha::audio2::Audio_obj::intBox,::kha::audio2::Audio_obj::buffer);
            		}
            		else {
HXLINE(  27)			int _g = 0;
HXDLIN(  27)			int _g1 = samples;
HXDLIN(  27)			while((_g < _g1)){
HXLINE(  27)				_g = (_g + 1);
HXDLIN(  27)				int i = (_g - 1);
HXLINE(  28)				{
HXLINE(  28)					 ::kha::arrays::ByteArrayPrivate this1 = ::kha::audio2::Audio_obj::buffer->data;
HXDLIN(  28)					int k = ::kha::audio2::Audio_obj::buffer->writeLocation;
HXDLIN(  28)					*((float *)&this1->self.data[this1->byteArrayOffset + (k * 4)]) = 0;
            				}
HXLINE(  29)				 ::kha::audio2::Buffer fh = ::kha::audio2::Audio_obj::buffer;
HXDLIN(  29)				fh->writeLocation = (fh->writeLocation + 1);
HXLINE(  30)				if ((::kha::audio2::Audio_obj::buffer->writeLocation >= ::kha::audio2::Audio_obj::buffer->size)) {
HXLINE(  31)					::kha::audio2::Audio_obj::buffer->writeLocation = 0;
            				}
            			}
            		}
            	}
...
Float Audio_obj::_readSample(){
            	HX_STACKFRAME(&_hx_pos_4c284ccaa8c50f8e_38__readSample)
HXLINE(  39)		if (::hx::IsNull( ::kha::audio2::Audio_obj::buffer )) {
HXLINE(  40)			return ( (Float)(0) );
            		}
HXLINE(  41)		 ::kha::arrays::ByteArrayPrivate this1 = ::kha::audio2::Audio_obj::buffer->data;
HXDLIN(  41)		int k = ::kha::audio2::Audio_obj::buffer->readLocation;
HXDLIN(  41)		float value = *(float *)&this1->self.data[this1->byteArrayOffset + (k * 4)];
HXLINE(  42)		++::kha::audio2::Audio_obj::buffer->readLocation;
HXLINE(  43)		if ((::kha::audio2::Audio_obj::buffer->readLocation >= ::kha::audio2::Audio_obj::buffer->size)) {
HXLINE(  44)			::kha::audio2::Audio_obj::buffer->readLocation = 0;
            		}
HXLINE(  46)		return ( (Float)(value) );
            	}
...
::Dynamic Audio_obj::stream( ::kha::Sound sound,::hx::Null< bool >  __o_loop){
            	...
            	HX_STACKFRAME(&_hx_pos_4c284ccaa8c50f8e_56_stream)
...
{
            	HX_STACKFRAME(&_hx_pos_4c284ccaa8c50f8e_49_boot)
HXDLIN(  49)		disableGcInteractions = false;
            	}
}
