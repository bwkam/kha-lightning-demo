...
HX_DEFINE_STACK_FRAME(_hx_pos_9b936b371410e5a9_26_new,"kha.FrameTask","new",0x98e6de1a,"kha.FrameTask.new","kha/Scheduler.hx",26,0xd275db8e)
namespace kha{

void FrameTask_obj::__construct( ::Dynamic task,int priority,int id){
            	HX_GC_STACKFRAME(&_hx_pos_9b936b371410e5a9_26_new)
HXLINE(  27)		this->_hx_set_task(HX_CTX, task);
HXLINE(  28)		this->priority = priority;
HXLINE(  29)		this->id = id;
HXLINE(  30)		this->active = true;
HXLINE(  31)		this->paused = false;
            	}
