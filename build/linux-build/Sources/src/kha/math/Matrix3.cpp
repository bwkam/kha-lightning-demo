...
HX_DEFINE_STACK_FRAME(_hx_pos_0e9bf1ebd9a77955_29_new,"kha.math.Matrix3","new",0x2b4e1488,"kha.math.Matrix3.new","kha/math/Matrix3.hx",29,0x5a9e6848)
HX_LOCAL_STACK_FRAME(_hx_pos_0e9bf1ebd9a77955_42_fromFastMatrix3,"kha.math.Matrix3","fromFastMatrix3",0x32dbca74,"kha.math.Matrix3.fromFastMatrix3","kha/math/Matrix3.hx",42,0x5a9e6848)
...
void Matrix3_obj::__construct(Float _00,Float _10,Float _20,Float _01,Float _11,Float _21,Float _02,Float _12,Float _22){
            	HX_STACKFRAME(&_hx_pos_0e9bf1ebd9a77955_29_new)
HXLINE(  30)		this->_00 = ( (float)(_00) );
HXLINE(  31)		this->_10 = ( (float)(_10) );
HXLINE(  32)		this->_20 = ( (float)(_20) );
HXLINE(  33)		this->_01 = ( (float)(_01) );
HXLINE(  34)		this->_11 = ( (float)(_11) );
HXLINE(  35)		this->_21 = ( (float)(_21) );
HXLINE(  36)		this->_02 = ( (float)(_02) );
HXLINE(  37)		this->_12 = ( (float)(_12) );
HXLINE(  38)		this->_22 = ( (float)(_22) );
            	}
...
int Matrix3_obj::height;
 ...
 ::kha::math::Matrix3 Matrix3_obj::fromFastMatrix3( ::kha::math::FastMatrix3 m){
            	HX_GC_STACKFRAME(&_hx_pos_0e9bf1ebd9a77955_42_fromFastMatrix3)
HXDLIN(  42)		return  ::kha::math::Matrix3_obj::__alloc( HX_CTX ,( (Float)(m->_00) ),( (Float)(m->_10) ),( (Float)(m->_20) ),( (Float)(m->_01) ),( (Float)(m->_11) ),( (Float)(m->_21) ),( (Float)(m->_02) ),( (Float)(m->_12) ),( (Float)(m->_22) ));
            	}
...
static ::hx::StorageInfo Matrix3_obj_sMemberStorageInfo[] = {
	{::hx::fsUnknown /* float */ ,(int)offsetof(Matrix3_obj,_00),HX_("_00",1f,40,48,00)},
	{::hx::fsUnknown /* float */ ,(int)offsetof(Matrix3_obj,_10),HX_("_10",fe,40,48,00)},
	{::hx::fsUnknown /* float */ ,(int)offsetof(Matrix3_obj,_20),HX_("_20",dd,41,48,00)},
	{::hx::fsUnknown /* float */ ,(int)offsetof(Matrix3_obj,_01),HX_("_01",20,40,48,00)},
	{::hx::fsUnknown /* float */ ,(int)offsetof(Matrix3_obj,_11),HX_("_11",ff,40,48,00)},
	{::hx::fsUnknown /* float */ ,(int)offsetof(Matrix3_obj,_21),HX_("_21",de,41,48,00)},
	{::hx::fsUnknown /* float */ ,(int)offsetof(Matrix3_obj,_02),HX_("_02",21,40,48,00)},
	{::hx::fsUnknown /* float */ ,(int)offsetof(Matrix3_obj,_12),HX_("_12",00,41,48,00)},
	{::hx::fsUnknown /* float */ ,(int)offsetof(Matrix3_obj,_22),HX_("_22",df,41,48,00)},
	{ ::hx::fsUnknown, 0, null()}
};
