...
HX_LOCAL_STACK_FRAME(_hx_pos_bb554ca6c8658d76_69_toString,"kha.math.FastVector4","toString",0x6fe18921,"kha.math.FastVector4.toString","kha/math/FastVector4.hx",69,0x3588e225)
...
HXLINE(  37)		Float mul = (( (Float)(length) ) / ( (Float)(currentLength) ));
HXLINE(  38)		 ::kha::math::FastVector4 _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  38)		_hx_tmp->x = (_hx_tmp->x * ( (float)(mul) ));
HXLINE(  39)		 ::kha::math::FastVector4 _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  39)		_hx_tmp1->y = (_hx_tmp1->y * ( (float)(mul) ));
HXLINE(  40)		 ::kha::math::FastVector4 _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  40)		_hx_tmp2->z = (_hx_tmp2->z * ( (float)(mul) ));
HXLINE(  41)		 ::kha::math::FastVector4 _hx_tmp3 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  41)		_hx_tmp3->w = (_hx_tmp3->w * ( (float)(mul) ));
HXLINE(  42)		return length;
            	}
...
::String FastVector4_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_bb554ca6c8658d76_69_toString)
HXDLIN(  69)		::String _hx_tmp = ((HX_("FastVector4(",d3,9b,e5,0d) + ::Std_obj::string(this->x)) + HX_(", ",74,26,00,00));
HXDLIN(  69)		::String _hx_tmp1 = ((_hx_tmp + ::Std_obj::string(this->y)) + HX_(", ",74,26,00,00));
HXDLIN(  69)		::String _hx_tmp2 = ((_hx_tmp1 + ::Std_obj::string(this->z)) + HX_(", ",74,26,00,00));
HXDLIN(  69)		return ((_hx_tmp2 + ::Std_obj::string(this->w)) + HX_(")",29,00,00,00));
            	}
