...
HX_LOCAL_STACK_FRAME(_hx_pos_c7289b019f63a9f2_73_toString,"kha.math.FastVector2","toString",0xef4c9963,"kha.math.FastVector2.toString","kha/math/FastVector2.hx",73,0x343674e7)
...
HXLINE(  30)			return ( (float)(0) );
            		}
HXLINE(  31)		Float mul = (( (Float)(length) ) / ( (Float)(currentLength) ));
HXLINE(  32)		 ::kha::math::FastVector2 _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  32)		_hx_tmp->x = (_hx_tmp->x * ( (float)(mul) ));
HXLINE(  33)		 ::kha::math::FastVector2 _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  33)		_hx_tmp1->y = (_hx_tmp1->y * ( (float)(mul) ));
HXLINE(  34)		return length;
            	}
...
::String FastVector2_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_c7289b019f63a9f2_73_toString)
HXDLIN(  73)		::String _hx_tmp = ((HX_("FastVector2(",15,9a,e5,0d) + ::Std_obj::string(this->x)) + HX_(", ",74,26,00,00));
HXDLIN(  73)		return ((_hx_tmp + ::Std_obj::string(this->y)) + HX_(")",29,00,00,00));
            	}
