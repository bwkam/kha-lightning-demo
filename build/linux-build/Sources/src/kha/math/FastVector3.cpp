...
HX_LOCAL_STACK_FRAME(_hx_pos_a713b736ef3c662c_76_toString,"kha.math.FastVector3","toString",0xaf971142,"kha.math.FastVector3.toString","kha/math/FastVector3.hx",76,0x34dfab86)
...
HXLINE(  34)		Float mul = (( (Float)(length) ) / ( (Float)(currentLength) ));
HXLINE(  35)		 ::kha::math::FastVector3 _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  35)		_hx_tmp->x = (_hx_tmp->x * ( (float)(mul) ));
HXLINE(  36)		 ::kha::math::FastVector3 _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  36)		_hx_tmp1->y = (_hx_tmp1->y * ( (float)(mul) ));
HXLINE(  37)		 ::kha::math::FastVector3 _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  37)		_hx_tmp2->z = (_hx_tmp2->z * ( (float)(mul) ));
...
::String FastVector3_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a713b736ef3c662c_76_toString)
HXDLIN(  76)		::String _hx_tmp = ((HX_("FastVector3(",f4,9a,e5,0d) + ::Std_obj::string(this->x)) + HX_(", ",74,26,00,00));
HXDLIN(  76)		::String _hx_tmp1 = ((_hx_tmp + ::Std_obj::string(this->y)) + HX_(", ",74,26,00,00));
HXDLIN(  76)		return ((_hx_tmp1 + ::Std_obj::string(this->z)) + HX_(")",29,00,00,00));
            	}
