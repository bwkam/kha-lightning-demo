...
HXLINE(  27)		Float mul = (length / currentLength);
HXLINE(  28)		 ::kha::math::Vector2 _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  28)		_hx_tmp->x = (_hx_tmp->x * mul);
HXLINE(  29)		 ::kha::math::Vector2 _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  29)		_hx_tmp1->y = (_hx_tmp1->y * mul);
