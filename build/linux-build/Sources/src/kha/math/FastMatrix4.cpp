...
HX_DEFINE_STACK_FRAME(_hx_pos_13a5dc49b32a5012_25_new,"kha.math.FastMatrix4","new",0x1cb0bdcd,"kha.math.FastMatrix4.new","kha/math/FastMatrix4.hx",25,0xae96fea3)
HX_LOCAL_STACK_FRAME(_hx_pos_13a5dc49b32a5012_45_fromMatrix4,"kha.math.FastMatrix4","fromMatrix4",0x530348f6,"kha.math.FastMatrix4.fromMatrix4","kha/math/FastMatrix4.hx",45,0xae96fea3)
HX_LOCAL_STACK_FRAME(_hx_pos_13a5dc49b32a5012_119_orthogonalProjection,"kha.math.FastMatrix4","orthogonalProjection",0x76379f5b,"kha.math.FastMatrix4.orthogonalProjection","kha/math/FastMatrix4.hx",119,0xae96fea3)
HX_LOCAL_STACK_FRAME(_hx_pos_13a5dc49b32a5012_126_perspectiveProjection,"kha.math.FastMatrix4","perspectiveProjection",0x7ac871d8,"kha.math.FastMatrix4.perspectiveProjection","kha/math/FastMatrix4.hx",126,0xae96fea3)
HX_LOCAL_STACK_FRAME(_hx_pos_13a5dc49b32a5012_132_lookAt,"kha.math.FastMatrix4","lookAt",0x5676e9e5,"kha.math.FastMatrix4.lookAt","kha/math/FastMatrix4.hx",132,0xae96fea3)
...
void FastMatrix4_obj::__construct(float _00,float _10,float _20,float _30,float _01,float _11,float _21,float _31,float _02,float _12,float _22,float _32,float _03,float _13,float _23,float _33){
            	HX_STACKFRAME(&_hx_pos_13a5dc49b32a5012_25_new)
HXLINE(  26)		this->_00 = _00;
HXLINE(  27)		this->_10 = _10;
HXLINE(  28)		this->_20 = _20;
HXLINE(  29)		this->_30 = _30;
HXLINE(  30)		this->_01 = _01;
HXLINE(  31)		this->_11 = _11;
HXLINE(  32)		this->_21 = _21;
HXLINE(  33)		this->_31 = _31;
HXLINE(  34)		this->_02 = _02;
HXLINE(  35)		this->_12 = _12;
HXLINE(  36)		this->_22 = _22;
HXLINE(  37)		this->_32 = _32;
HXLINE(  38)		this->_03 = _03;
HXLINE(  39)		this->_13 = _13;
HXLINE(  40)		this->_23 = _23;
HXLINE(  41)		this->_33 = _33;
            	}
...
int FastMatrix4_obj::height;
 ...
 ::kha::math::FastMatrix4 FastMatrix4_obj::fromMatrix4( ::kha::math::Matrix4 m){
            	HX_GC_STACKFRAME(&_hx_pos_13a5dc49b32a5012_45_fromMatrix4)
HXDLIN(  45)		return  ::kha::math::FastMatrix4_obj::__alloc( HX_CTX ,( (float)(m->_00) ),( (float)(m->_10) ),( (float)(m->_20) ),( (float)(m->_30) ),( (float)(m->_01) ),( (float)(m->_11) ),( (float)(m->_21) ),( (float)(m->_31) ),( (float)(m->_02) ),( (float)(m->_12) ),( (float)(m->_22) ),( (float)(m->_32) ),( (float)(m->_03) ),( (float)(m->_13) ),( (float)(m->_23) ),( (float)(m->_33) ));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FastMatrix4_obj,fromMatrix4,return )
 ...
 ::kha::math::FastMatrix4 FastMatrix4_obj::orthogonalProjection(float left,float right,float bottom,float top,float zn,float zf){
            	HX_GC_STACKFRAME(&_hx_pos_13a5dc49b32a5012_119_orthogonalProjection)
HXLINE( 120)		float tx = ( (float)((( (Float)(-((right + left))) ) / ( (Float)((right - left)) ))) );
HXLINE( 121)		float ty = ( (float)((( (Float)(-((top + bottom))) ) / ( (Float)((top - bottom)) ))) );
HXLINE( 122)		float tz = ( (float)((( (Float)(-((zf + zn))) ) / ( (Float)((zf - zn)) ))) );
HXLINE( 123)		return  ::kha::math::FastMatrix4_obj::__alloc( HX_CTX ,( (float)((( (Float)(2) ) / ( (Float)((right - left)) ))) ),( (float)(0) ),( (float)(0) ),tx,( (float)(0) ),( (float)((((Float)2.0) / ( (Float)((top - bottom)) ))) ),( (float)(0) ),ty,( (float)(0) ),( (float)(0) ),( (float)((( (Float)(-2) ) / ( (Float)((zf - zn)) ))) ),tz,( (float)(0) ),( (float)(0) ),( (float)(0) ),( (float)(1) ));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC6(FastMatrix4_obj,orthogonalProjection,return )
 ...
 ::kha::math::FastMatrix4 FastMatrix4_obj::perspectiveProjection(float fovY,float aspect,float zn,float zf){
            	HX_GC_STACKFRAME(&_hx_pos_13a5dc49b32a5012_126_perspectiveProjection)
HXLINE( 127)		Float uh = (((Float)1.0) / ::Math_obj::tan((( (Float)(fovY) ) / ( (Float)(2) ))));
HXLINE( 128)		Float uw = (uh / ( (Float)(aspect) ));
HXLINE( 129)		return  ::kha::math::FastMatrix4_obj::__alloc( HX_CTX ,( (float)(uw) ),( (float)(0) ),( (float)(0) ),( (float)(0) ),( (float)(0) ),( (float)(uh) ),( (float)(0) ),( (float)(0) ),( (float)(0) ),( (float)(0) ),( (float)((( (Float)((zf + zn)) ) / ( (Float)((zn - zf)) ))) ),( (float)((( (Float)(((( (float)(2) ) * zf) * zn)) ) / ( (Float)((zn - zf)) ))) ),( (float)(0) ),( (float)(0) ),( (float)(-1) ),( (float)(0) ));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(FastMatrix4_obj,perspectiveProjection,return )
 ...
 ::kha::math::FastMatrix4 FastMatrix4_obj::lookAt( ::kha::math::FastVector3 eye, ::kha::math::FastVector3 at, ::kha::math::FastVector3 up){
            	HX_GC_STACKFRAME(&_hx_pos_13a5dc49b32a5012_132_lookAt)
HXLINE( 133)		float _this_x = (at->x - eye->x);
HXDLIN( 133)		float _this_y = (at->y - eye->y);
HXDLIN( 133)		float _this_z = (at->z - eye->z);
HXDLIN( 133)		float zaxis_x = _this_x;
HXDLIN( 133)		float zaxis_y = _this_y;
HXDLIN( 133)		float zaxis_z = _this_z;
HXDLIN( 133)		float currentLength = ( (float)(::Math_obj::sqrt(( (Float)((((zaxis_x * zaxis_x) + (zaxis_y * zaxis_y)) + (zaxis_z * zaxis_z))) ))) );
HXDLIN( 133)		if ((currentLength != 0)) {
HXLINE( 133)			Float mul = (( (Float)(1) ) / ( (Float)(currentLength) ));
HXDLIN( 133)			zaxis_x = (zaxis_x * ( (float)(mul) ));
HXDLIN( 133)			zaxis_y = (zaxis_y * ( (float)(mul) ));
HXDLIN( 133)			zaxis_z = (zaxis_z * ( (float)(mul) ));
            		}
HXLINE( 134)		float _x = ((zaxis_y * up->z) - (zaxis_z * up->y));
HXDLIN( 134)		float _y = ((zaxis_z * up->x) - (zaxis_x * up->z));
HXDLIN( 134)		float _z = ((zaxis_x * up->y) - (zaxis_y * up->x));
HXDLIN( 134)		float _this_x1 = _x;
HXDLIN( 134)		float _this_y1 = _y;
HXDLIN( 134)		float _this_z1 = _z;
HXDLIN( 134)		float xaxis_x = _this_x1;
HXDLIN( 134)		float xaxis_y = _this_y1;
HXDLIN( 134)		float xaxis_z = _this_z1;
HXDLIN( 134)		float currentLength1 = ( (float)(::Math_obj::sqrt(( (Float)((((xaxis_x * xaxis_x) + (xaxis_y * xaxis_y)) + (xaxis_z * xaxis_z))) ))) );
HXDLIN( 134)		if ((currentLength1 != 0)) {
HXLINE( 134)			Float mul1 = (( (Float)(1) ) / ( (Float)(currentLength1) ));
HXDLIN( 134)			xaxis_x = (xaxis_x * ( (float)(mul1) ));
HXDLIN( 134)			xaxis_y = (xaxis_y * ( (float)(mul1) ));
HXDLIN( 134)			xaxis_z = (xaxis_z * ( (float)(mul1) ));
            		}
HXLINE( 135)		float _x1 = ((xaxis_y * zaxis_z) - (xaxis_z * zaxis_y));
HXDLIN( 135)		float _y1 = ((xaxis_z * zaxis_x) - (xaxis_x * zaxis_z));
HXDLIN( 135)		float _z1 = ((xaxis_x * zaxis_y) - (xaxis_y * zaxis_x));
HXDLIN( 135)		float yaxis_x = _x1;
HXDLIN( 135)		float yaxis_y = _y1;
HXDLIN( 135)		float yaxis_z = _z1;
HXLINE( 137)		return  ::kha::math::FastMatrix4_obj::__alloc( HX_CTX ,xaxis_x,xaxis_y,xaxis_z,-((((xaxis_x * eye->x) + (xaxis_y * eye->y)) + (xaxis_z * eye->z))),yaxis_x,yaxis_y,yaxis_z,-((((yaxis_x * eye->x) + (yaxis_y * eye->y)) + (yaxis_z * eye->z))),-(zaxis_x),-(zaxis_y),-(zaxis_z),(((zaxis_x * eye->x) + (zaxis_y * eye->y)) + (zaxis_z * eye->z)),( (float)(0) ),( (float)(0) ),( (float)(0) ),( (float)(1) ));
            	}
