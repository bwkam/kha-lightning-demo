...
HX_DEFINE_STACK_FRAME(_hx_pos_213cce7b618b8029_30_new,"kha.math.FastMatrix3","new",0x894a294c,"kha.math.FastMatrix3.new","kha/math/FastMatrix3.hx",30,0xadedc804)
HX_LOCAL_STACK_FRAME(_hx_pos_213cce7b618b8029_43_fromMatrix3,"kha.math.FastMatrix3","fromMatrix3",0x0d42cb74,"kha.math.FastMatrix3.fromMatrix3","kha/math/FastMatrix3.hx",43,0xadedc804)
...
void FastMatrix3_obj::__construct(float _00,float _10,float _20,float _01,float _11,float _21,float _02,float _12,float _22){
            	HX_STACKFRAME(&_hx_pos_213cce7b618b8029_30_new)
HXLINE(  31)		this->_00 = _00;
HXLINE(  32)		this->_10 = _10;
HXLINE(  33)		this->_20 = _20;
HXLINE(  34)		this->_01 = _01;
HXLINE(  35)		this->_11 = _11;
HXLINE(  36)		this->_21 = _21;
HXLINE(  37)		this->_02 = _02;
HXLINE(  38)		this->_12 = _12;
HXLINE(  39)		this->_22 = _22;
            	}
...
int FastMatrix3_obj::height;
 ...
 ::kha::math::FastMatrix3 FastMatrix3_obj::fromMatrix3( ::kha::math::Matrix3 m){
            	HX_GC_STACKFRAME(&_hx_pos_213cce7b618b8029_43_fromMatrix3)
HXDLIN(  43)		return  ::kha::math::FastMatrix3_obj::__alloc( HX_CTX ,m->_00,m->_10,m->_20,m->_01,m->_11,m->_21,m->_02,m->_12,m->_22);
            	}
