...
HX_DEFINE_STACK_FRAME(_hx_pos_a4f4220e088ed7a0_25_new,"kha.math.Matrix4","new",0xbeb4a909,"kha.math.Matrix4.new","kha/math/Matrix4.hx",25,0x5b479ee7)
HX_LOCAL_STACK_FRAME(_hx_pos_a4f4220e088ed7a0_45_fromFastMatrix4,"kha.math.Matrix4","fromFastMatrix4",0xb5cf9c76,"kha.math.Matrix4.fromFastMatrix4","kha/math/Matrix4.hx",45,0x5b479ee7)
HX_LOCAL_STACK_FRAME(_hx_pos_a4f4220e088ed7a0_118_orthogonalProjection,"kha.math.Matrix4","orthogonalProjection",0x6c87509f,"kha.math.Matrix4.orthogonalProjection","kha/math/Matrix4.hx",118,0x5b479ee7)
HX_LOCAL_STACK_FRAME(_hx_pos_a4f4220e088ed7a0_125_perspectiveProjection,"kha.math.Matrix4","perspectiveProjection",0x0a33dc14,"kha.math.Matrix4.perspectiveProjection","kha/math/Matrix4.hx",125,0x5b479ee7)
HX_LOCAL_STACK_FRAME(_hx_pos_a4f4220e088ed7a0_131_lookAt,"kha.math.Matrix4","lookAt",0x1520ac29,"kha.math.Matrix4.lookAt","kha/math/Matrix4.hx",131,0x5b479ee7)
...
void Matrix4_obj::__construct(Float _00,Float _10,Float _20,Float _30,Float _01,Float _11,Float _21,Float _31,Float _02,Float _12,Float _22,Float _32,Float _03,Float _13,Float _23,Float _33){
            	HX_STACKFRAME(&_hx_pos_a4f4220e088ed7a0_25_new)
...
int Matrix4_obj::height;
 ...
 ::kha::math::Matrix4 Matrix4_obj::fromFastMatrix4( ::kha::math::FastMatrix4 m){
            	HX_GC_STACKFRAME(&_hx_pos_a4f4220e088ed7a0_45_fromFastMatrix4)
HXDLIN(  45)		return  ::kha::math::Matrix4_obj::__alloc( HX_CTX ,( (Float)(m->_00) ),( (Float)(m->_10) ),( (Float)(m->_20) ),( (Float)(m->_30) ),( (Float)(m->_01) ),( (Float)(m->_11) ),( (Float)(m->_21) ),( (Float)(m->_31) ),( (Float)(m->_02) ),( (Float)(m->_12) ),( (Float)(m->_22) ),( (Float)(m->_32) ),( (Float)(m->_03) ),( (Float)(m->_13) ),( (Float)(m->_23) ),( (Float)(m->_33) ));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Matrix4_obj,fromFastMatrix4,return )
 ...
 ::kha::math::Matrix4 Matrix4_obj::orthogonalProjection(Float left,Float right,Float bottom,Float top,Float zn,Float zf){
            	HX_GC_STACKFRAME(&_hx_pos_a4f4220e088ed7a0_118_orthogonalProjection)
HXLINE( 119)		Float tx = (-((right + left)) / (right - left));
HXLINE( 120)		Float ty = (-((top + bottom)) / (top - bottom));
HXLINE( 121)		Float tz = (-((zf + zn)) / (zf - zn));
HXLINE( 122)		return  ::kha::math::Matrix4_obj::__alloc( HX_CTX ,(( (Float)(2) ) / (right - left)),( (Float)(0) ),( (Float)(0) ),tx,( (Float)(0) ),(( (Float)(2) ) / (top - bottom)),( (Float)(0) ),ty,( (Float)(0) ),( (Float)(0) ),(( (Float)(-2) ) / (zf - zn)),tz,( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),( (Float)(1) ));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC6(Matrix4_obj,orthogonalProjection,return )
 ...
 ::kha::math::Matrix4 Matrix4_obj::perspectiveProjection(Float fovY,Float aspect,Float zn,Float zf){
            	HX_GC_STACKFRAME(&_hx_pos_a4f4220e088ed7a0_125_perspectiveProjection)
HXLINE( 126)		Float uh = (((Float)1.0) / ::Math_obj::tan((fovY / ( (Float)(2) ))));
HXLINE( 127)		Float uw = (uh / aspect);
HXLINE( 128)		return  ::kha::math::Matrix4_obj::__alloc( HX_CTX ,uw,( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),uh,( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),((zf + zn) / (zn - zf)),(((( (Float)(2) ) * zf) * zn) / (zn - zf)),( (Float)(0) ),( (Float)(0) ),( (Float)(-1) ),( (Float)(0) ));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(Matrix4_obj,perspectiveProjection,return )
 ...
 ::kha::math::Matrix4 Matrix4_obj::lookAt( ::kha::math::Vector3 eye, ::kha::math::Vector3 at, ::kha::math::Vector3 up){
            	HX_GC_STACKFRAME(&_hx_pos_a4f4220e088ed7a0_131_lookAt)
HXLINE( 132)		Float _this_x = (at->x - eye->x);
HXDLIN( 132)		Float _this_y = (at->y - eye->y);
HXDLIN( 132)		Float _this_z = (at->z - eye->z);
HXDLIN( 132)		Float zaxis_x = _this_x;
HXDLIN( 132)		Float zaxis_y = _this_y;
HXDLIN( 132)		Float zaxis_z = _this_z;
HXDLIN( 132)		Float currentLength = ::Math_obj::sqrt((((zaxis_x * zaxis_x) + (zaxis_y * zaxis_y)) + (zaxis_z * zaxis_z)));
HXDLIN( 132)		if ((currentLength != 0)) {
HXLINE( 132)			Float mul = (( (Float)(1) ) / currentLength);
HXDLIN( 132)			zaxis_x = (zaxis_x * mul);
HXDLIN( 132)			zaxis_y = (zaxis_y * mul);
HXDLIN( 132)			zaxis_z = (zaxis_z * mul);
            		}
HXLINE( 133)		Float _x = ((zaxis_y * up->z) - (zaxis_z * up->y));
HXDLIN( 133)		Float _y = ((zaxis_z * up->x) - (zaxis_x * up->z));
HXDLIN( 133)		Float _z = ((zaxis_x * up->y) - (zaxis_y * up->x));
HXDLIN( 133)		Float _this_x1 = _x;
HXDLIN( 133)		Float _this_y1 = _y;
HXDLIN( 133)		Float _this_z1 = _z;
HXDLIN( 133)		Float xaxis_x = _this_x1;
HXDLIN( 133)		Float xaxis_y = _this_y1;
HXDLIN( 133)		Float xaxis_z = _this_z1;
HXDLIN( 133)		Float currentLength1 = ::Math_obj::sqrt((((xaxis_x * xaxis_x) + (xaxis_y * xaxis_y)) + (xaxis_z * xaxis_z)));
HXDLIN( 133)		if ((currentLength1 != 0)) {
HXLINE( 133)			Float mul1 = (( (Float)(1) ) / currentLength1);
HXDLIN( 133)			xaxis_x = (xaxis_x * mul1);
HXDLIN( 133)			xaxis_y = (xaxis_y * mul1);
HXDLIN( 133)			xaxis_z = (xaxis_z * mul1);
            		}
HXLINE( 134)		Float _x1 = ((xaxis_y * zaxis_z) - (xaxis_z * zaxis_y));
HXDLIN( 134)		Float _y1 = ((xaxis_z * zaxis_x) - (xaxis_x * zaxis_z));
HXDLIN( 134)		Float _z1 = ((xaxis_x * zaxis_y) - (xaxis_y * zaxis_x));
HXDLIN( 134)		Float yaxis_x = _x1;
HXDLIN( 134)		Float yaxis_y = _y1;
HXDLIN( 134)		Float yaxis_z = _z1;
HXLINE( 136)		return  ::kha::math::Matrix4_obj::__alloc( HX_CTX ,xaxis_x,xaxis_y,xaxis_z,-((((xaxis_x * eye->x) + (xaxis_y * eye->y)) + (xaxis_z * eye->z))),yaxis_x,yaxis_y,yaxis_z,-((((yaxis_x * eye->x) + (yaxis_y * eye->y)) + (yaxis_z * eye->z))),-(zaxis_x),-(zaxis_y),-(zaxis_z),(((zaxis_x * eye->x) + (zaxis_y * eye->y)) + (zaxis_z * eye->z)),( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),( (Float)(1) ));
            	}
