...
HXLINE(  30)		Float mul = (length / currentLength);
HXLINE(  31)		 ::kha::math::Vector3 _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  31)		_hx_tmp->x = (_hx_tmp->x * mul);
HXLINE(  32)		 ::kha::math::Vector3 _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  32)		_hx_tmp1->y = (_hx_tmp1->y * mul);
HXLINE(  33)		 ::kha::math::Vector3 _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  33)		_hx_tmp2->z = (_hx_tmp2->z * mul);
