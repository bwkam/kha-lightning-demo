...
HX_DEFINE_STACK_FRAME(_hx_pos_953552e0cd74b8c7_19_new,"kha.WindowOptions","new",0xee7f9656,"kha.WindowOptions.new","kha/WindowOptions.hx",19,0x953dd7db)
namespace kha{
...
HXLINE(  28)		this->mode = 0;
HXLINE(  27)		this->windowFeatures = ((1 | 4) | 2);
HXLINE(  26)		this->visible = true;
HXLINE(  25)		this->display = -1;
HXLINE(  24)		this->height = 600;
HXLINE(  23)		this->width = 800;
HXLINE(  22)		this->y = -1;
HXLINE(  21)		this->x = -1;
HXLINE(  20)		this->_hx_set_title(HX_CTX, null());
HXLINE(  32)		this->_hx_set_title(HX_CTX, title);
HXLINE(  33)		this->x = ( (int)(x) );
HXLINE(  34)		this->y = ( (int)(y) );
HXLINE(  35)		this->width = ( (int)(width) );
HXLINE(  36)		this->height = ( (int)(height) );
HXLINE(  37)		this->display = ( (int)(display) );
HXLINE(  38)		this->visible = ( (bool)(visible) );
...
HXDLIN(  39)		this->windowFeatures = _hx_tmp;
HXLINE(  40)		this->mode = ( (int)(mode) );
            	}
