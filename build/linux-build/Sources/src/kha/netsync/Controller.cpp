...
HX_DEFINE_STACK_FRAME(_hx_pos_d583c86a58345f5b_12_new,"kha.netsync.Controller","new",0x9522ad2e,"kha.netsync.Controller.new","kha/netsync/Controller.hx",12,0x2b3d2fc0)
HX_LOCAL_STACK_FRAME(_hx_pos_d583c86a58345f5b_18__id,"kha.netsync.Controller","_id",0x95174ec8,"kha.netsync.Controller._id","kha/netsync/Controller.hx",18,0x2b3d2fc0)
...
void Controller_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_d583c86a58345f5b_12_new)
HXLINE(  13)		this->_hx___id = ::kha::netsync::ControllerBuilder_obj::nextId++;
HXLINE(  14)		this->_hx_set__inputBuffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(1));
            	}
...
int Controller_obj::_id(){
            	HX_STACKFRAME(&_hx_pos_d583c86a58345f5b_18__id)
HXDLIN(  18)		return this->_hx___id;
            	}
