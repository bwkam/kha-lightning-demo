...
HX_DEFINE_STACK_FRAME(_hx_pos_e4808080a977b708_17_new,"kha.netsync.Network","new",0x4a8d9b00,"kha.netsync.Network.new","kha/netsync/Network.hx",17,0xa1ce43f2)
...
HX_LOCAL_STACK_FRAME(_hx_pos_e4808080a977b708_45_listen,"kha.netsync.Network","listen",0xfe3c61a7,"kha.netsync.Network.listen","kha/netsync/Network.hx",45,0xa1ce43f2)
HX_LOCAL_STACK_FRAME(_hx_pos_e4808080a977b708_48_update,"kha.netsync.Network","update",0x95481f69,"kha.netsync.Network.update","kha/netsync/Network.hx",48,0xa1ce43f2)
HX_LOCAL_STACK_FRAME(_hx_pos_e4808080a977b708_75_getBytesFromSocket,"kha.netsync.Network","getBytesFromSocket",0x2b5d3a72,"kha.netsync.Network.getBytesFromSocket","kha/netsync/Network.hx",75,0xa1ce43f2)
namespace kha{
namespace netsync{

void Network_obj::__construct(::String url,int port, ::Dynamic errorCallback, ::Dynamic closeCallback){
            	HX_GC_STACKFRAME(&_hx_pos_e4808080a977b708_17_new)
HXLINE(  18)		this->_hx_set_url(HX_CTX, url);
HXLINE(  19)		this->port = (port + 1);
HXLINE(  20)		this->bufferPos = 0;
HXLINE(  21)		this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(256));
HXLINE(  22)		this->_hx_set_tempBuffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(256));
HXLINE(  23)		this->init(url,port);
HXLINE(  24)		::kha::Scheduler_obj::addFrameTask(this->update_dyn(),0);
            	}
...
void Network_obj::listen( ::Dynamic listener){
            	HX_GC_STACKFRAME(&_hx_pos_e4808080a977b708_45_listen)
HXDLIN(  45)		this->_hx_set_listener(HX_CTX, listener);
            	}
...
void Network_obj::update(){
            	HX_STACKFRAME(&_hx_pos_e4808080a977b708_48_update)
HXLINE(  49)		int received = this->getBytesFromSocket(this->tempBuffer);
HXLINE(  50)		this->buffer->blit(this->bufferPos,this->tempBuffer,0,received);
HXLINE(  51)		 ::kha::netsync::Network _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  51)		_hx_tmp->bufferPos = (_hx_tmp->bufferPos + received);
HXLINE(  55)		bool _hx_tmp1;
HXDLIN(  55)		if (::hx::IsNotNull( this->listener )) {
HXLINE(  55)			_hx_tmp1 = (this->bufferPos > 0);
            		}
            		else {
HXLINE(  55)			_hx_tmp1 = false;
            		}
HXDLIN(  55)		if (_hx_tmp1) {
HXLINE(  56)			 ::haxe::io::Bytes result = ::haxe::io::Bytes_obj::alloc(this->bufferPos);
HXLINE(  57)			result->blit(0,this->buffer,0,this->bufferPos);
HXLINE(  58)			this->listener(result);
HXLINE(  59)			this->bufferPos = 0;
            		}
            	}
...
int Network_obj::getBytesFromSocket( ::haxe::io::Bytes inBuffer){
            	HX_STACKFRAME(&_hx_pos_e4808080a977b708_75_getBytesFromSocket)
