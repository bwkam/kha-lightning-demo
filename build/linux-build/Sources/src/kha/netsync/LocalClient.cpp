...
HX_LOCAL_STACK_FRAME(_hx_pos_14aa482ef3b8dece_14_receive,"kha.netsync.LocalClient","receive",0x4b13f9eb,"kha.netsync.LocalClient.receive","kha/netsync/LocalClient.hx",14,0xbf2a288a)
HX_LOCAL_STACK_FRAME(_hx_pos_14aa482ef3b8dece_16_onClose,"kha.netsync.LocalClient","onClose",0xff5c4e21,"kha.netsync.LocalClient.onClose","kha/netsync/LocalClient.hx",16,0xbf2a288a)
HX_LOCAL_STACK_FRAME(_hx_pos_14aa482ef3b8dece_21_get_controllers,"kha.netsync.LocalClient","get_controllers",0xa48787f6,"kha.netsync.LocalClient.get_controllers","kha/netsync/LocalClient.hx",21,0xbf2a288a)
HX_LOCAL_STACK_FRAME(_hx_pos_14aa482ef3b8dece_27_get_id,"kha.netsync.LocalClient","get_id",0x440d341c,"kha.netsync.LocalClient.get_id","kha/netsync/LocalClient.hx",27,0xbf2a288a)
namespace kha{
namespace netsync{
...
void LocalClient_obj::receive( ::Dynamic receiver){
            	HX_STACKFRAME(&_hx_pos_14aa482ef3b8dece_14_receive)
            	}
...
void LocalClient_obj::onClose( ::Dynamic close){
            	HX_STACKFRAME(&_hx_pos_14aa482ef3b8dece_16_onClose)
            	}
...
::Array< ::Dynamic> LocalClient_obj::get_controllers(){
            	HX_STACKFRAME(&_hx_pos_14aa482ef3b8dece_21_get_controllers)
...
int LocalClient_obj::get_id(){
            	HX_STACKFRAME(&_hx_pos_14aa482ef3b8dece_27_get_id)
HXDLIN(  27)		return this->myId;
            	}
