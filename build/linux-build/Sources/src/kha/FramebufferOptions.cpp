...
HXLINE(  14)		this->frequency = ( (int)(frequency) );
HXLINE(  15)		this->verticalSync = ( (bool)(verticalSync) );
HXLINE(  16)		this->colorBufferBits = ( (int)(colorBufferBits) );
HXLINE(  17)		this->depthBufferBits = ( (int)(depthBufferBits) );
HXLINE(  18)		this->stencilBufferBits = ( (int)(stencilBufferBits) );
HXLINE(  19)		this->samplesPerPixel = ( (int)(samplesPerPixel) );
            	}
