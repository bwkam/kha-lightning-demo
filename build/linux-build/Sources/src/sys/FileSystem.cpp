...
HX_LOCAL_STACK_FRAME(_hx_pos_255b85fbfe02a3a1_38_stat,"sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","/home/ryn/.vscode-oss/extensions/kodetech.kha-23.5.0-universal/Kha/Tools/linux_x64/std/cpp/_std/sys/FileSystem.hx",38,0xe583e0e9)
HX_LOCAL_STACK_FRAME(_hx_pos_255b85fbfe02a3a1_75_isDirectory,"sys.FileSystem","isDirectory",0x6c577a21,"sys.FileSystem.isDirectory","/home/ryn/.vscode-oss/extensions/kodetech.kha-23.5.0-universal/Kha/Tools/linux_x64/std/cpp/_std/sys/FileSystem.hx",75,0xe583e0e9)
HX_LOCAL_STACK_FRAME(_hx_pos_255b85fbfe02a3a1_101_readDirectory,"sys.FileSystem","readDirectory",0x0619f8b5,"sys.FileSystem.readDirectory","/home/ryn/.vscode-oss/extensions/kodetech.kha-23.5.0-universal/Kha/Tools/linux_x64/std/cpp/_std/sys/FileSystem.hx",101,0xe583e0e9)
namespace sys{
...
bool FileSystem_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic FileSystem_obj::stat(::String path){
            	HX_STACKFRAME(&_hx_pos_255b85fbfe02a3a1_38_stat)
HXLINE(  39)		::String s;
HXDLIN(  39)		bool s1;
...
bool FileSystem_obj::isDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_255b85fbfe02a3a1_75_isDirectory)
...
::Array< ::String > FileSystem_obj::readDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_255b85fbfe02a3a1_101_readDirectory)
