...
HX_DEFINE_STACK_FRAME(_hx_pos_1f7fb461460ae883_278_new,"sys.thread._EventLoop.RegularEvent","new",0x9d3b475c,"sys.thread._EventLoop.RegularEvent.new","/home/ryn/.vscode-oss/extensions/kodetech.kha-23.5.0-universal/Kha/Tools/linux_x64/std/sys/thread/EventLoop.hx",278,0x982e1e8c)
namespace sys{
namespace thread{
namespace _EventLoop{

void RegularEvent_obj::__construct( ::Dynamic run,Float nextRunTime,Float interval){
            	HX_GC_STACKFRAME(&_hx_pos_1f7fb461460ae883_278_new)
