...
HX_LOCAL_STACK_FRAME(_hx_pos_9edb3215827fc2b9_51_read,"sys.io.File","read",0x203d07e1,"sys.io.File.read","/home/ryn/.vscode-oss/extensions/kodetech.kha-23.5.0-universal/Kha/Tools/linux_x64/std/cpp/_std/sys/io/File.hx",51,0x0bf03d83)
namespace sys{
namespace io{
...
bool File_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::sys::io::FileInput File_obj::read(::String path,::hx::Null< bool >  __o_binary){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_9edb3215827fc2b9_51_read)
